...
#if(((_OSD_TYPE == _REALTEK_2014_OSD)||(_OSD_TYPE == _BEACON_2014_OSD)) && (_RGB_3D_GAMMA == _ON))
...
#endif // End of #if(((_OSD_TYPE == _REALTEK_2014_OSD)||(_OSD_TYPE == _BEACON_2014_OSD)) && (_RGB_3D_GAMMA == _ON))
