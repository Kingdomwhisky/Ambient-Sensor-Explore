...
#if(((_OSD_TYPE == _REALTEK_2014_OSD)||(_OSD_TYPE == _BEACON_2014_OSD)) && (_RGB_GAMMA_FUNCTION == _ON))
...
#endif // End of #if(((_OSD_TYPE == _REALTEK_2014_OSD)||(_OSD_TYPE == _BEACON_2014_OSD)) && (_RGB_GAMMA_FUNCTION == _ON))
