...
#if(((_OSD_TYPE == _REALTEK_2014_OSD)||(_OSD_TYPE == _BEACON_2014_OSD)) && (_BACKLIGHT_DIMMING_SUPPORT == _ON))
...
#endif // End of #if(((_OSD_TYPE == _REALTEK_2014_OSD)||(_OSD_TYPE == _BEACON_2014_OSD)) && (_BACKLIGHT_DIMMING_SUPPORT == _ON))
