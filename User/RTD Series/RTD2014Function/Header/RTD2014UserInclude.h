...
extern void UserAdjustBacklightDuty(WORD usBacklight);
...
extern void UserAdjustBackgroundLightPWM(void);
#endif
extern WORD UserGetDicomBacklightDuty(BYTE GammaTable);
extern BYTE IsGammaOptionDICOM(BYTE GammaTable);
extern BYTE IsGammaOptionDICOMALC(BYTE GammaTable);
extern BYTE IsGammaOptionMCUCalibration(BYTE GammaTable);
extern BYTE IsGammaOptionPCCalibration(BYTE GammaTable);
extern BYTE IsGammaOptionHybridGamma(BYTE GammaTable);
extern BYTE IsGammaOptionNative(BYTE GammaTable);
extern BYTE IsMonoChromeorColorPanel(void);
...
extern void UpdateBacklightSensorValue(void);
extern void UserBacklightSensorHandler();
extern void UserAdjustRestoreBacklightSensorValue(void);
extern WORD UserAdjustQAGetCurrPanelLux(BYTE ucIndex);
extern WORD UserAdjustQAGetStandardLux(BYTE ucColorType,WORD usTargetLux);
extern WORD UserAdjustQAGetTargetSensor(WORD usTargetLux);
extern void UserAdjustQAUpdateTargetSensor(WORD usTargetLux);
extern void UserTemperatureSensorHandler();
#endif

#if(_ENABLE_AMBIENTLIGHT_SENSOR)
extern void UserAmbiSensorADCStart(void);
extern bit AmbiSensor_ReadLux(void);
extern void UserAmbiSensorHander(void);
extern BYTE UserGetDICOMALCAmbiSensor(void);
extern WORD UserAdjustQAGetCurrAmbLux(void);
#endif

#if(_ENABLE_DISTANCE_SENSOR)
extern void UserDistanceSensorHandler(void);
#endif
#if(_ENABLE_GRAVITY_SENSOR)
extern void UserGravitySensorHandler(void);
#endif
...
extern void UserAdjustFPGAColorAdaptiveHandler(BYTE ucForceOn);
extern void UserAdjustFPGALocalEnhancementHandler(BYTE ucForceOn);
extern void UserAdjustFPGALocalEnhancementCus1Move(WORD usHLWinHPosition,WORD usHLWinVPosition);
extern void UserAdjustFPGALocalEnhancementCus2Move(SWORD usHLWinHPosition,SWORD usHLWinVPosition);
#endif
extern void UserAdjustDdcciSetARMMcuCommand(BYTE ucMCUCMDIdx);
...
extern void UserAdjustHLWinTypeCus1Move(WORD usHLWinHPosition,WORD usHLWinVPosition);
extern void UserAdjustHLWinTypeCus2Move(SWORD usHLWinHPosition,SWORD usHLWinVPosition);
extern void UserAdjustHighLightWindowUserHander(void);
#endif
