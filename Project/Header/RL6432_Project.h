...
#elif(_OSD_TYPE == _BEACON_2014_OSD)
#define _OSD_INCLUDE                                            "BEA2014Include.h"
#define _USER_FUNCTION_INCLUDE                                  "RTD2014UserInclude.h"
#define _USER_TIMER_INCLUDE                                     "BEA2014TimerInclude.h"
#define _FACTORY_INCLUDE                                        "RTDFactoryInclude.h"
#define _USER_HWIIC_INCLUDE                                     "RTD2014HWIICInclude.h"
#endif
...
#define _DDCCI_TXBUF_LENGTH                                     128
#define _DDCCI_TIMEOUT_LIMIT                                    500 // 0~65535ms

#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(RTK)cmds(01 02 03 07 0C E3 F3)vcp(02 03 04 05 06 08 0B 0C 0E 10 12 14(01 02 04 05 06 08 0B) 16 18 1A 1E 1F 20 30 3E 52 60(01 03 04 0F 10 11 12) 87 AC AE B2 B6 C0 C6 C8 CA CC(01 02 03 04 06 0A 0D) D6(01 04 05) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(RTK)cmds(01 02 03 07 0C E3 F3)vcp(02 03 04 05 06 08 0B 0C 10 12 14(01 02 04 05 06 08 0B) 16 18 1A 52 60(01 03 04 0F 10 11 12) 87 AC AE B2 B6 C0 C6 C8 CA CC(01 02 03 04 06 0A 0D) D6(01 04 05) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(RTK)cmds(01 02 03 07 0C E3 F3)vcp(02 03 04 05 06 08 0B 0C 10 12 14(01 02 04 05 06 08 0B) 16 18 1A 52 60(01 03 04 0F 10 11 12) 87 AC AE B2 B6 C0 C6 C8 CA CC(01 02 03 04 06 0A 0D) D6(01 04 05) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DP                                 "(prot(monitor)type(LCD)model(RTK)cmds(01 02 03 07 0C E3 F3)vcp(02 03 04 05 06 08 0B 0C 10 12 14(01 02 04 05 06 08 0B) 16 18 1A 52 60(01 03 04 0F 10 11 12) 87 AC AE B2 B6 C0 C6 C8 CA CC(01 02 03 04 06 0A 0D) D6(01 04 05) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
//-------------------------------------------------
#define _OCC_SUPPORT                                            _ON// _OFF
#define _OGC_SUPPORT                                            _ON// _OFF
...
//-------------------------------------------------
#define _UNIFORMITY_SUPPORT                                     _ON// _OFF


#define _UNIFORMITY_FLASH_BANK0                                 29
#define _UNIFORMITY_1ST_TABLE_LEVEL                             _UNIFORMITY_1LEVEL
#define _UNIFORMITY_2ND_TABLE_LEVEL                             _UNIFORMITY_1LEVEL
#define _UNIFORMITY_3RD_TABLE_LEVEL                             _UNIFORMITY_1LEVEL
#define _UNIFORMITY_4TH_TABLE_LEVEL                             _UNIFORMITY_1LEVEL
#define _UNIFORMITY_5TH_TABLE_LEVEL                             _UNIFORMITY_1LEVEL
#define _UNIFORMITY_6TH_TABLE_LEVEL                             _UNIFORMITY_1LEVEL

// for Beacon gamma
#define _BEACON_GAMMA_PARTITION0_FLASH_BANK                     22 // OGC
#define _BEACON_GAMMA_PARTITION1_FLASH_BANK                     23
#define _BEACON_GAMMA_CALIBRATION_FLASH_BANK                    24 // Color sensor Calibration & MCU  Calibration
...
#define _BEACON_URAT_FLASH_BANK                                 18 // OGC
...
//-------------------------------------------------
#if((_OCC_SUPPORT == _ON) || (_OCC_SUPPORT == _ON) || (_OGC_DICOM_SUPPORT == _ON) || (_UNIFORMITY_SUPPORT == _ON))
...
#define _INPUTCLOCK_RANG_DVI                                    4040 // Unit in 0.1 MHz
#define _INPUTCLOCK_RANG_HDMI                                   4040 // Unit in 0.1 MHz
#define _INPUTCLOCK_RANG_DP                                     4040 // Unit in 0.1 MHz
#define _INPUTCLOCK_RANG_USBC                                   4040 // Unit in 0.1 MHz
...
// DVI & HDMI Option
//--------------------------------------------------
#if 1//(_PCB_TYPE != _RL6432_CANON_A_156PIN_1DUALDVI_LVDS)
...
#define _HDMI_HDR10_SUPPORT                                     _ON//_OFF
...
#define _SIGNATURE_INTERNAL_ISP_START_BANK                      10
#define _SIGNATURE_INTERNAL_BIN_BANK_SIZE                       10
#define _SIGNATURE_INTERNAL_PROTECT_DATA_BANK                   30
