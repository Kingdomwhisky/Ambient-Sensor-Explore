...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6463_Series_VGATopInclude.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define SET_HS_DELAY_LATCH_EDGE()                   {\
                                                        ScalerSetBit(P0_12_M1_VGIP_DELAY_CTRL, ~_BIT3, 0x00);\
                                                    }
...
#define SAVE_HS_DELAY_SETTING(pucBackup)            {\
                                                        ...
                                                        (pucBackup)[3] = ScalerGetByte(P1_CA_SSCG_0);\
...
#define LOAD_HS_DELAY_SETTING(pucBackup)            {\
                                                        ...
                                                        ScalerSetByte(P1_CA_SSCG_0, (pucBackup)[3]);\
...
// HS delay Time
//--------------------------------------------------
#define _PHASE_DELAY_TIME_VALUE_SHORT_PATH          (347) // 347 = 64 * 5.42 (Unit: ns)
#define _PHASE_DELAY_TIME_VALUE_LONG_PATH           (557) // 557 = 64 * 8.71 (Unit: ns)
