...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6463_Series_ColorDCCAdjust.c
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
// Table Length
//--------------------------------------------------
#define _DCC_TABLE_SIZE_CTRL                    3
#define _DCC_TABLE_SIZE_CRV                     23
#define _DCC_ADJOPTION_TABLE_OFFSET             1
#define _DCC_CONTORL_TABLE_OFFSET               6
#define _DCC_CURVE_TABLE_OFFSET                 12
...
void ScalerColorDCCAdjust(BYTE code *pucDccTable, BYTE ucBankAddress)
{
    ...
    if(pucDccTable != NULL)
    {
        ...
        ScalerSetByte(P7_C9_DCC_ADDRESS_PORT, _P7_CA_PT_06_PORT_PAGE0_SOFT_CLAMP);
