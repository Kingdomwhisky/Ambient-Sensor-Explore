...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6463_Series_ColorDCCHistoSetting.c
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
void ScalerColorDCCHistoSetting(void)
{
    ...
    ScalerSetByte(P7_CA_DCC_DATA_PORT, (BYTE)_DCC_HISTO_YMAX_LB);
    ScalerSetByte(P7_CA_DCC_DATA_PORT, (BYTE)_DCC_HISTO_YMIN_HB);
