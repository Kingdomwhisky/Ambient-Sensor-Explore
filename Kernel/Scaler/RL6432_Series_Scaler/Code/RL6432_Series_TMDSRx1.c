...
void ScalerTMDSRx1SetPhy_EXINT0(void) using 1
{
    ...
    if(ScalerGetBit_EXINT(P7A_17_BANDGAP_03, _BIT1) == _BIT1)  // MHL Mode
    {
        if(ScalerGetBit_EXINT(P7A_1B_CMU_01, _BIT0) == _BIT0) // DCDR
        {
            ...
            DELAY_5US_EXINT();
            ScalerSetBit_EXINT(P7A_1B_CMU_01, ~_BIT6, _BIT6);
            DELAY_5US_EXINT();
            ScalerSetBit_EXINT(P7A_1B_CMU_01, ~_BIT5, 0x00);
            DELAY_5US_EXINT();
            ScalerSetBit_EXINT(P7A_1B_CMU_01, ~_BIT4, _BIT4);
            DELAY_5US_EXINT();
            ScalerSetBit_EXINT(P7A_1B_CMU_01, ~_BIT2, _BIT2);
            DELAY_5US_EXINT();
            ScalerSetBit_EXINT(P7A_1B_CMU_01, ~_BIT0, _BIT0);
        }
        else
        {
            ...
            ScalerSetBit_EXINT(P7A_1B_CMU_01, ~_BIT7, _BIT7);
            DELAY_5US_EXINT();
            ScalerSetBit_EXINT(P7A_1B_CMU_01, ~_BIT6, 0x00);
            DELAY_5US_EXINT();
            ScalerSetBit_EXINT(P7A_1B_CMU_01, ~_BIT5, 0x00);
            DELAY_5US_EXINT();
            ScalerSetBit_EXINT(P7A_1B_CMU_01, ~_BIT4, _BIT4);
    ...
    else
    {
        ...
        ScalerSetBit_EXINT(P7A_1B_CMU_01, ~_BIT6, _BIT6);
        DELAY_5US_EXINT();
        ScalerSetBit_EXINT(P7A_1B_CMU_01, ~_BIT5, _BIT5);
        DELAY_5US_EXINT();
        ScalerSetBit_EXINT(P7A_1B_CMU_01, ~_BIT4, _BIT4);
        DELAY_5US_EXINT();
        ScalerSetBit_EXINT(P7A_1B_CMU_01, ~_BIT2, _BIT2);
        DELAY_5US_EXINT();
        ScalerSetBit_EXINT(P7A_1B_CMU_01, ~_BIT1, _BIT1);
        DELAY_5US_EXINT();
        ScalerSetBit_EXINT(P7A_1B_CMU_01, ~_BIT0, _BIT0);
    }
#else
