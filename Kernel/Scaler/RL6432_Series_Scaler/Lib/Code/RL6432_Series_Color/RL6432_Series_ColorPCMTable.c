...
code BYTE *tPCM_INPUTGAMMA[] =
{
    ...
    tPCM_INPUT_GAMMA_18,  // UserDefine2
    tPCM_INPUT_GAMMA_19,  // UserDefine3
    tPCM_INPUT_GAMMA_20,  // UserDefine4
    tPCM_INPUT_GAMMA_21,  // UserDefine5
    tPCM_INPUT_GAMMA_28,  // UserDefine6
    tPCM_INPUTGAMMA_DISPLAYP3, // _PCM_DISPLAY_P3
    tPCM_INPUT_GAMMA_BYPASS,   // _PCM_HDR_2084
};
