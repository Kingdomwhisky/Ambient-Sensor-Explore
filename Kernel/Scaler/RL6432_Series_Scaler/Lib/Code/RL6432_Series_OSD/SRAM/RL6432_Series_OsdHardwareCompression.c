...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432_Series_OsdHardwareCompression.c
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
DebugMessageUart("P3A_0B_FRAME_CTRL_1", P3A_0B_FRAME_CTRL_0B);
...
DebugMessageUart("P3A_0B_FRAME_CTRL_2", P3A_0B_FRAME_CTRL_0B);
