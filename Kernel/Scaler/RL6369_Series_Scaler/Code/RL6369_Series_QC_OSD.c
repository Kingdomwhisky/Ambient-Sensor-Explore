...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6369_Series_QC_OSD.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6369_SERIES_QC_OSD__
...
#define _QC_OSD_POSITION_OFFSET_H                                  0x28
...
enum OSDQCFrameDef
{
    _OSD_FRAME_1,       _OSD_FRAME_2, _OSD_FRAME_2_1, _OSD_FRAME_2_2,
...
BYTE code tQC_OSD_CRC_TABLE_1[] = {
    0xBA, 0xAE, 0x16, 0xA5, 0xC7, 0x9F  // M1
};

BYTE code tQC_OSD_CRC_TABLE_2[] = {
    0xFD, 0xC5, 0xA2, 0xCC, 0x8C, 0xA4  // M1
};

BYTE code tQC_OSD_CRC_TABLE_2_1[] = {
    0x24, 0xCF, 0xF8, 0x97, 0xA5, 0x98  // M1
};

BYTE code tQC_OSD_CRC_TABLE_2_2[] = {
    0x35, 0x2E, 0x82, 0xD5, 0x2B, 0x94  // M1
};

BYTE code tQC_OSD_CRC_TABLE_3[] = {
    0xAF, 0x73, 0x08, 0x67, 0xBC, 0x26  // M1
};

BYTE code tQC_OSD_CRC_TABLE_4[] = {
    0x2F, 0x22, 0x8C, 0xB4, 0xBA, 0x17  // M1
};

BYTE code tQC_OSD_CRC_TABLE_5[] = {
    0x6B, 0xCB, 0x2E, 0xFA, 0xFA, 0x37  // M1
};

BYTE code tQC_OSD_CRC_TABLE_6[] = {
    0xD2, 0x63, 0x9E, 0x38, 0xDB, 0x19  // M1
};

BYTE code tQC_OSD_CRC_TABLE_7[] = {
    0x53, 0xAE, 0x2E, 0x52, 0x46, 0x8C  // M1
};

BYTE code tQC_OSD_CRC_TABLE_8[] = {
    0x2F, 0xBE, 0x0F, 0x32, 0xF0, 0x8D  // M1
};

BYTE code tQC_OSD_CRC_TABLE_9[] = {
    0x6F, 0xF0, 0x10, 0xB5, 0x40, 0x42  // M1
};

BYTE code tQC_OSD_CRC_TABLE_10[] = {
    0xCD, 0x15, 0xD1, 0x54, 0xE0, 0xEF  // M1
};

BYTE code tQC_OSD_CRC_TABLE_11[] = {
    0x98, 0xB8, 0xA4, 0xDD, 0x7D, 0x91  // M1
};

BYTE code tQC_OSD_CRC_TABLE_12[] = {
    0xCA, 0x38, 0x39, 0xCC, 0x46, 0xB8  // M1
};

BYTE code tQC_OSD_CRC_TABLE_13[] = {
    0x3B, 0xFB, 0x74, 0x39, 0xF5, 0x55  // M1
};

BYTE code tQC_OSD_CRC_TABLE_14[] = {
    0x2C, 0xBC, 0xE5, 0xC0, 0xB8, 0xE9  // M1
};

BYTE code tQC_OSD_CRC_TABLE_15[] = {
    0xD8, 0x00, 0x65, 0x3C, 0x58, 0x9E  // M1
};

BYTE code tQC_OSD_CRC_TABLE_16[] = {
    0x75, 0x05, 0xD9, 0x8E, 0xE3, 0x78  // M1
};

BYTE code tQC_OSD_CRC_TABLE_17[] = {
    0xCA, 0xB5, 0xF0, 0x34, 0xA6, 0x84, // M1
};

BYTE code tQC_OSD_CRC_TABLE_18[] = {
    0x90, 0xFB, 0xBA, 0x04, 0xBE, 0x3F, // M1
};

BYTE code tQC_OSD_CRC_TABLE_19[] = {
    0xAD, 0x59, 0x1A, 0xD3, 0xB3, 0xD1, // M1
};
...
// Output Value : None
//--------------------------------------------------
void ScalerQCOSDPrintCRC(BYTE ucFrame, BYTE ucPath, BYTE *ucCRC, BYTE ucNum)
{
    BYTE i = 0;
...
//--------------------------------------------------
bit ScalerQCOSDCRCCompare(BYTE ucDomain, BYTE ucPosition, BYTE ucSourceSel, BYTE *ucCRC, BYTE ucFrameNum)
{
    BYTE i = 0, j = 0, k = 0;
    ...
    for(k = 0; k < ucFrameNum; k++)
    {
        ...
        if((ucSourceSel & ucOrder[j]) != 0)
        {
            for(i = 6*j; i < 6*(j + 1); i++)
            {
                ...
                {
                    ScalerQCOSDPrintCRC(k, j, ucReadCRC + 6*j, 6);
                    bFlag = _TEST_FAIL;
                    break;
                }
            }
...
bit ScalerQCOsdTestProc(void)
{
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_1, 1) << 0));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_2, 1) << 1));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_2_1, 1) << 1));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_2_2, 1) << 1));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_3, 1) << 2));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_4, 1) << 3));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_5, 1) << 4));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_6, 1) << 5));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_7, 1) << 6));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_8, 1) << 7));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_9, 1) << 8));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_10, 1) << 9));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_11, 1) << 10));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_12, 1) << 11));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_13, 1) << 12));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_14, 1) << 13));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_15, 1) << 14));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_16, 1) << 15));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_17, 1) << 0));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_18, 1) << 1));
    ...
    usData = (usData | ((WORD)ScalerQCOSDCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_19, 1) << 2));
