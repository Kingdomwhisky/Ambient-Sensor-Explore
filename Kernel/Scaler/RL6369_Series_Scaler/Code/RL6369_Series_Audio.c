...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6369_Series_Audio.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
void ScalerAudioADCInitial(void)
{
    ...
    // Enable ADC Op Offset Cancellation
    ScalerSetBit(P6_B2_REG_ADC_CTRL, ~_BIT3, _BIT3);

    // Enable ADC Dither
    ScalerSetBit(P6_C9_REG_ANA_RESERVE0, ~(_BIT2 | _BIT1 | _BIT0), _BIT0);
