...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6449_Series_QC_Color_IMDomain.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6449_SERIES_QC_COLOR_IMDOMAIN__
...
bit ScalerQCVGAPGTest(void)
{
    ...
    ucFlag = (ucFlag | ((BYTE)ScalerQCCRCCompare(_I_DOMAIN_CRC, _I_CRC_AFTER_VGIP, _M1 | _M2, tVGAPG_CRC_TABLE0, 1) << 0));

    ScalerQCVGATopRandomGenOn(_MASS);
    ucFlag = (ucFlag | ((BYTE)ScalerQCCRCCompare(_I_DOMAIN_CRC, _I_CRC_AFTER_VGIP, _M1 | _M2, tVGAPG_CRC_TABLE1, 1) << 1));
...
bit ScalerQCIPGTest(void)
{
    ...
    ucFlag = ((BYTE)ScalerQCCRCCompare(_I_DOMAIN_CRC, _I_CRC_AFTER_VGIP, _M1 | _M2, tIPG_CRC_TABLE, 1) << 0);
