...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6449_Series_DPTxInclude.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//****************************************************************************
#define GET_DP_TX_HDCP_M0_0()                           (ScalerGetByte(PBB_43_M0_BYTE_0) ^ 0x9D)
#define GET_DP_TX_HDCP_M0_1()                           (~(ScalerGetByte(PBB_42_M0_BYTE_1) ^ ScalerGetByte(PBB_43_M0_BYTE_0)))
#define GET_DP_TX_HDCP_M0_2()                           (ScalerGetByte(PBB_41_M0_BYTE_2) ^ ScalerGetByte(PBB_42_M0_BYTE_1))
#define GET_DP_TX_HDCP_M0_3()                           (ScalerGetByte(PBB_40_M0_BYTE_3) ^ ScalerGetByte(PBB_41_M0_BYTE_2))
#define GET_DP_TX_HDCP_M0_4()                           (ScalerGetByte(PBB_3F_M0_BYTE_4) ^ ScalerGetByte(PBB_40_M0_BYTE_3))
#define GET_DP_TX_HDCP_M0_5()                           (~(ScalerGetByte(PBB_3E_M0_BYTE_5) ^ ScalerGetByte(PBB_3F_M0_BYTE_4)))
#define GET_DP_TX_HDCP_M0_6()                           (~(ScalerGetByte(PBB_3D_M0_BYTE_6) ^ ScalerGetByte(PBB_3E_M0_BYTE_5)))
#define GET_DP_TX_HDCP_M0_7()                           (~(ScalerGetByte(PBB_3C_M0_BYTE_7) ^ ScalerGetByte(PBB_3D_M0_BYTE_6)))
