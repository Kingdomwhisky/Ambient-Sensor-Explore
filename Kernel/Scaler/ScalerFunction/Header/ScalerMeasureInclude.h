...
//--------------------------------------------------
#define GET_INPUT_TIMING_ACTIVE_REGION()             (g_ulActiveRegionCount)
#define SET_INPUT_TIMING_ACTIVE_REGION(x)            (g_ulActiveRegionCount = (x))
#endif
...
extern StructAutoActiveData g_stSingleActiveRegion;
extern StructMeasureSyncData g_stSingleMeasureSyncHV;
extern StructTimingInfo g_stSingleInputTimingData;
#endif
...
#if((_MEASURE_ADJUSTED_IHF_SUPPORT == _ON) || (_MEASURE_ADJUSTED_IVF_SUPPORT == _ON))
extern DWORD g_ulActiveRegionCount;
#endif
...
#if((_MEASURE_ADJUSTED_IHF_SUPPORT == _ON) || (_MEASURE_ADJUSTED_IVF_SUPPORT == _ON))
extern DWORD ScalerMeasureGetdActiveRegionPixels(WORD usHWidth, WORD usVHeight, WORD usHTotal);
extern DWORD ScalerMeasureGetAdjustedActiveRegionCount(WORD usNewHWidth, WORD usNewVHeight);
#endif
