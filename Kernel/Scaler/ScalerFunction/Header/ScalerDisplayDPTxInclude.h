...
#define GET_DISPLAY_DP_TX1_STREAM_OUTPUT()                          (g_stDisplayDPTx1InputInfo.b1StremOutput)
#define SET_DISPLAY_DP_TX1_STREAM_OUTPUT(x)                         (g_stDisplayDPTx1InputInfo.b1StremOutput = (x))
#endif
#endif // End of #if(_DISPLAY_DP_TX_PORT_1 == _ON)
...
#if(_PANEL_DPTX_HPD_DETECT == _ON)
#define GET_DISPLAY_DP_TX2_STREAM_OUTPUT()                          (g_stDisplayDPTx2InputInfo.b1StremOutput)
#define SET_DISPLAY_DP_TX2_STREAM_OUTPUT(x)                         (g_stDisplayDPTx2InputInfo.b1StremOutput = (x))
#endif
#endif // End of #if(_DISPLAY_DP_TX_PORT_2 == _ON)
