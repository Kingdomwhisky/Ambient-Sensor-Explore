...
//----------------------------------------------------------------------------------------------------
// ID Code      : ScalerTMDSRx1HDCP2_SeptPhy.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __SCALER_TMDS_RX1_HDCP2__
...
StructHdcp2HDCPAuthInfo g_stTmdsRx1Hdcp2AuthInfo;
BYTE g_ucTmdsRx1Hdcp2Ctrl;

BYTE g_pucTmdsRx1Hdcp2dKey0[16];
BYTE g_pucTmdsRx1Hdcp2dKey1[16];

BYTE g_pucTmdsRx1Hdcp2Km[16];

BYTE g_pucTmdsRx1Hdcp2Rtx[8];
BYTE g_pucTmdsRx1Hdcp2TxCaps[3];
BYTE g_pucTmdsRx1Hdcp2Rn[8];
BYTE g_pucTmdsRx1Hdcp2Rrx[8];
#endif
#endif
...
#if(_TMDS_HDCP_2_2_SUPPORT == _ON)
#if((_D1_INPUT_PORT_TYPE == _D1_HDMI_PORT) || (_D1_INPUT_PORT_TYPE == _D1_MHL_PORT))
void ScalerTMDSRx1Hdcp2AesOnlineCtrl_EXINT0(BYTE *pucInputArray, BYTE *pucCipherArray);
void ScalerTMDSRx1Hdcp2DownLoadWriteSRAMValue_EXINT0(BYTE ucSubAddr, BYTE ucLength, BYTE *pucReadArray);
void ScalerTMDSRx1Hdcp2Enable_EXINT0(void);
void ScalerTMDSRx1Hdcp2Handler(void);
void ScalerTMDSRx1Hdcp2Initial(void);
BYTE ScalerTMDSRx1Hdcp2RxRsaCalculate_EXINT0(void);
void ScalerTMDSRx1Hdcp2IntHandler_EXINT0(void);
void ScalerTMDSRx1Hdcp2ReAuthEvent(void);
void ScalerTMDSRx1Hdcp2ResetProc(void);
void ScalerTMDSRx1Hdcp2ResetProc_EXINT0(void);
void ScalerTMDSRx1Hdcp2SetRdMsgIDCode_EXINT0(BYTE ucValue);
void ScalerTMDSRx1Hdcp2SetRdMsgValue_EXINT0(WORD usAddress, BYTE *pucReadArray, WORD usLength);

#if(_HDCP_2_2_ERRATA_TEST_SUPPORT == _ON)
void ScalerTMDSRx1Hdcp2AesOnlineCtrl(BYTE *pucInputArray, BYTE *pucCipherArray);
void ScalerTMDSRx1Hdcp2SetRdMsgIDCode(BYTE ucValue);
void ScalerTMDSRx1Hdcp2SetRdMsgValue(WORD usAddress, BYTE *pucReadArray, WORD usLength);
bit ScalerTMDSRx1Hdcp2CaptureKpubKm(void);
void ScalerTMDSRx1Hdcp2CalculateKmKh(void);
#endif
...
// Output Value : None
//--------------------------------------------------
void ScalerTMDSRx1Hdcp2AesOnlineCtrl_EXINT0(BYTE *pucInputArray, BYTE *pucCipherArray) using 1
{
    // Set AES Cipher Key
    SET_HDCP_2_2_RX1_ONLINE_AES(pucCipherArray, pucInputArray);
...
// Output Value : None
//--------------------------------------------------
void ScalerTMDSRx1Hdcp2DownLoadWriteSRAMValue_EXINT0(BYTE ucSubAddr, BYTE ucLength, BYTE *pucReadArray) using 1
{
...
// Output Value : None
//--------------------------------------------------
void ScalerTMDSRx1Hdcp2Enable_EXINT0(void) using 1
{
...
//--------------------------------------------------
// Description  : HDCP 2.2 Handler Process for TMDS Rx1
// Input Value  : None
// Output Value : None
//--------------------------------------------------
void ScalerTMDSRx1Hdcp2Handler(void)
{
#if(_HDCP_2_2_ERRATA_TEST_SUPPORT == _ON)
    SET_TMDS_RX1_HDCP2_AKE_INIT_RECEIVED();
#endif

    // Receiver Has Received AKE_INIT
    if(GET_TMDS_RX1_HDCP2_AKE_INIT_RECEIVED() == _TRUE)
    {
        CLR_TMDS_RX1_HDCP2_AKE_INIT_RECEIVED();

        DebugMessageHDCP2("[D1]AKE_INIT", 0);

#if(_HDCP_2_2_ERRATA_TEST_SUPPORT == _ON)

        g_pucTmdsRx1Hdcp2Rtx[0] = 0x18;
        g_pucTmdsRx1Hdcp2Rtx[1] = 0xfa;
        g_pucTmdsRx1Hdcp2Rtx[2] = 0xe4;
        g_pucTmdsRx1Hdcp2Rtx[3] = 0x20;
        g_pucTmdsRx1Hdcp2Rtx[4] = 0x6a;
        g_pucTmdsRx1Hdcp2Rtx[5] = 0xfb;
        g_pucTmdsRx1Hdcp2Rtx[6] = 0x51;
        g_pucTmdsRx1Hdcp2Rtx[7] = 0x49;

        g_pucTmdsRx1Hdcp2Rrx[0] = 0x3b;
        g_pucTmdsRx1Hdcp2Rrx[1] = 0xa0;
        g_pucTmdsRx1Hdcp2Rrx[2] = 0xbe;
        g_pucTmdsRx1Hdcp2Rrx[3] = 0xde;
        g_pucTmdsRx1Hdcp2Rrx[4] = 0x0c;
        g_pucTmdsRx1Hdcp2Rrx[5] = 0x46;
        g_pucTmdsRx1Hdcp2Rrx[6] = 0xa9;
        g_pucTmdsRx1Hdcp2Rrx[7] = 0x91;

        g_pucTmdsRx1Hdcp2TxCaps[0] = 0x02;
        g_pucTmdsRx1Hdcp2TxCaps[1] = 0x00;
        g_pucTmdsRx1Hdcp2TxCaps[2] = 0x00;

        g_pucTmdsRx1Caps[0] = 0x02;
        g_pucTmdsRx1Caps[1] = 0x00;
        g_pucTmdsRx1Caps[2] = 0x01;

        // Load Certrx to Read SRAM
        ScalerTMDSRx1Hdcp2SetRdMsgValue(0x01, g_stRxHdcp2DownLoadKeyType.pucHdcp2Certrx, 522);

#endif
    }

#if(_HDCP_2_2_ERRATA_TEST_SUPPORT == _ON)
    SET_TMDS_RX1_HDCP2_AKE_NO_STORED_KM_RECEIVED();
#endif

    // Receiver Has received AKE_NO_STORED_KM
    if(GET_TMDS_RX1_HDCP2_AKE_NO_STORED_KM_RECEIVED() == _TRUE)
    {
#if(_HDCP_2_2_ERRATA_TEST_SUPPORT == _ON)
        if(ScalerTMDSRx1Hdcp2CaptureKpubKm() == _TRUE)
        {
            // Decrypt Km by FW to Get 128 bit Km
            if(ScalerHdcp2RxRsaOaepCalculate(g_pucTmdsRx1Hdcp2Km) == _TRUE)
            {
                ScalerHdcp2DkeyCalculate(_HDCP_2_2_DKEY_0, g_pucTmdsRx1Hdcp2Rtx, g_pucTmdsRx1Hdcp2Rrx, g_pucTmdsRx1Hdcp2Km, g_pucTmdsRx1Hdcp2Rn);

                memcpy(g_pucTmdsRx1Hdcp2dKey0, (volatile BYTE xdata *)P63_81_HDCP_AES_OUT_15, 16);

                ScalerHdcp2DkeyCalculate(_HDCP_2_2_DKEY_1, g_pucTmdsRx1Hdcp2Rtx, g_pucTmdsRx1Hdcp2Rrx, g_pucTmdsRx1Hdcp2Km, g_pucTmdsRx1Hdcp2Rn);

                memcpy(g_pucTmdsRx1Hdcp2dKey1, (volatile BYTE xdata *)P63_81_HDCP_AES_OUT_15, 16);

                for(pData[0] = 0; pData[0] < 16; pData[0]++)
                {
                    DebugMessageHDCP2("[D1]Dkey0", g_pucTmdsRx1Hdcp2dKey0[pData[0]]);
                }

                for(pData[0] = 0; pData[0] < 16; pData[0]++)
                {
                    DebugMessageHDCP2("[D1]Dkey1", g_pucTmdsRx1Hdcp2dKey1[pData[0]]);
                }

                if(ScalerHdcp2HPrimeCalculate(g_pucTmdsRx1Hdcp2dKey0, g_pucTmdsRx1Hdcp2dKey1, g_pucTmdsRx1Hdcp2Rtx, g_pucTmdsRx1Hdcp2TxCaps, g_pucTmdsRx1Caps) == _TRUE)
                {
                    ScalerTMDSRx1Hdcp2CalculateKmKh();
                }
            }
        }
#endif
        CLR_TMDS_RX1_HDCP2_AKE_NO_STORED_KM_RECEIVED();
        CLR_TMDS_RX1_HDCP2_AUTHENTICATION_ACTIVE();

        DebugMessageHDCP2("[D1]AKE_NO_STORED_KM", 0);
    }

    if(GET_TMDS_RX1_HDCP2_AKE_STORED_KM_RECEIVED() == _TRUE)
    {
        CLR_TMDS_RX1_HDCP2_AKE_STORED_KM_RECEIVED();

        DebugMessageHDCP2("[D1]AKE_STORED_KM", 0);
    }

#if(_HDCP_2_2_ERRATA_TEST_SUPPORT == _ON)
    SET_TMDS_RX1_HDCP2_LC_INIT_RECEIVED();
#endif

    if(GET_TMDS_RX1_HDCP2_LC_INIT_RECEIVED() == _TRUE)
    {
#if(_HDCP_2_2_ERRATA_TEST_SUPPORT == _ON)
        ...
        g_pucTmdsRx1Hdcp2Rn[0] = 0x32;
        g_pucTmdsRx1Hdcp2Rn[1] = 0x75;
        g_pucTmdsRx1Hdcp2Rn[2] = 0x3e;
        g_pucTmdsRx1Hdcp2Rn[3] = 0xa8;
        g_pucTmdsRx1Hdcp2Rn[4] = 0x78;
        g_pucTmdsRx1Hdcp2Rn[5] = 0xa6;
        g_pucTmdsRx1Hdcp2Rn[6] = 0x38;
        g_pucTmdsRx1Hdcp2Rn[7] = 0x1c;

        if(ScalerHdcp2LPrimeCalculate(g_pucTmdsRx1Hdcp2dKey0, g_pucTmdsRx1Hdcp2dKey1, g_pucTmdsRx1Hdcp2Rrx, g_pucTmdsRx1Hdcp2Rn) == _TRUE)
        {
            // Load H prime to Read SRAM, AKE Send H PRIME Message ID = 10
            ScalerTMDSRx1Hdcp2SetRdMsgIDCode(_HDCP_2_2_LC_SEND_L_PRIME);

            memcpy(pucSHA256, (volatile BYTE xdata *)P63_35_HDCP_SHA_0, 32);

            ScalerTMDSRx1Hdcp2SetRdMsgValue(0x01, pucSHA256, 32);

            for(pData[0] = 0; pData[0] < 32; pData[0]++)
            {
                DebugMessageHDCP2("[D1]L_Prime", pucSHA256[pData[0]]);
            }
        ...
        CLR_TMDS_RX1_HDCP2_LC_INIT_RECEIVED();

        DebugMessageHDCP2("[D1]LC_INIT", 0);
    }

#if(_HDCP_2_2_ERRATA_TEST_SUPPORT == _ON)
    SET_TMDS_RX1_HDCP2_SKE_SEND_EKS_RECEIVED();
#endif

    if(GET_TMDS_RX1_HDCP2_SKE_SEND_EKS_RECEIVED() == _TRUE)
    {
#if(_HDCP_2_2_ERRATA_TEST_SUPPORT == _ON)
        BYTE pucEDkeyKs[16];
        ...
        // Calculate Dkey 2
        ScalerHdcp2DkeyCalculate(_HDCP_2_2_DKEY_2, g_pucTmdsRx1Hdcp2Rtx, g_pucTmdsRx1Hdcp2Rrx, g_pucTmdsRx1Hdcp2Km, g_pucTmdsRx1Hdcp2Rn);
        ...
        {
            pucKs[pData[0]] = pucEDkeyKs[pData[0]] ^ (ScalerGetByte((P63_81_HDCP_AES_OUT_15 + pData[0])) ^ g_pucTmdsRx1Hdcp2Rrx[pData[0] - 8]);
        }


        for(pData[0] = 0; pData[0] < 16; pData[0]++)
        {
            DebugMessageHDCP2("[D1]Ks", pucKs[pData[0]]);
        }

        SET_TMDS_RX1_HDCP2_AUTHENTICATION_DONE();
        ...
        SET_TMDS_RX1_HDCP2_AUTH_STATE(_HDCP_2_2_STATE_AUTHENTICATED);
        ...
        ScalerTMDSRx1Hdcp2AesOnlineCtrl(pucRiv, pucInputCipher);
#endif

        CLR_TMDS_RX1_HDCP2_SKE_SEND_EKS_RECEIVED();
    ...
    if(GET_TMDS_RX1_HDCP2_AUTHENTICATION_DONE() == _TRUE)
    {
        ...
        if(ScalerGetDataPortBit(P71_C9_HDMI_AP, _P71_CA_PT_63_PORT_PAGE71_HDMI_PEAC1, (_BIT7 | _BIT6)) == (_BIT7 | _BIT6))
        {
            ...
            CLR_TMDS_RX1_HDCP2_AUTHENTICATION_DONE();

            DebugMessageHDCP2("[D1]REAUTH_REQ", 0);

            // Set HDCP 2.2 Authentication State = UnAuthenticated
            SET_TMDS_RX1_HDCP2_AUTH_STATE(_HDCP_2_2_STATE_UNAUTHENTICATED);
...
//--------------------------------------------------
BYTE ScalerTMDSRx1Hdcp2RxRsaCalculate_EXINT0(void) using 1
{
    ...
    {
        pucHdcp2KpubKm[ucIndex] = ScalerGetByte_EXINT(P2D_22_HDCP_MSGWDP);
    }
...
// Output Value : None
//--------------------------------------------------
void ScalerTMDSRx1Hdcp2IntHandler_EXINT0(void) using 1
{
    ...
    g_pucHdcp2BackUp[3] = ScalerGetByte_EXINT(P71_C3_HDCP_AP);
    ...
    if((ScalerGetBit_EXINT(P2D_35_HDCP_I2C_CTRL_7, _BIT0) == _BIT0) && (ScalerGetBit_EXINT(P2D_36_HDCP_I2C_CTRL_8, _BIT0) == _BIT0))
    {
        ...
        ScalerSetBit_EXINT(P2D_36_HDCP_I2C_CTRL_8, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT0);
        ...
        {
            ScalerTMDSRx1Hdcp2Enable_EXINT0();
        }
        ...
        switch(ScalerGetByte_EXINT(P2D_22_HDCP_MSGWDP))
        {
            case _HDCP_2_2_AKE_INIT:
                ...
                // HDCP2 Reset Proc
                ScalerTMDSRx1Hdcp2ResetProc_EXINT0();

                // Save Transmitter Rtx to FW
                ScalerTMDSRx1Hdcp2DownLoadWriteSRAMValue_EXINT0(0x01, 8, g_pucTmdsRx1Hdcp2Rtx);

                // Save TxCaps to FW
                ScalerTMDSRx1Hdcp2DownLoadWriteSRAMValue_EXINT0(0x09, 3, g_pucTmdsRx1Hdcp2TxCaps);

                // Generate the psudo-random key of Rrx
                ScalerHdcp2RxGenRrx_EXINT0(g_pucTmdsRx1Hdcp2Rrx);

                // Load Certrx to Read SRAM
                ScalerTMDSRx1Hdcp2SetRdMsgValue_EXINT0(0x01, g_stRxHdcp2DownLoadKeyType.pucHdcp2Certrx, 522);

                // Load Rrx to Read SRAM
                ScalerTMDSRx1Hdcp2SetRdMsgValue_EXINT0(0x020B, g_pucTmdsRx1Hdcp2Rrx, 8);

                // Load RxCaps HDCP 2.2 Support to Read SRAM
                ScalerTMDSRx1Hdcp2SetRdMsgValue_EXINT0(0x0213, g_pucTmdsRx1Caps, 3);

                // Load Message ID = 3
                ScalerTMDSRx1Hdcp2SetRdMsgIDCode_EXINT0(_HDCP_2_2_AKE_SEND_CERT);
            ...
            case _HDCP_2_2_AKE_NO_STORED_KM:
                ...
                SET_TMDS_RX1_HDCP2_AKE_NO_STORED_KM_RECEIVED();
                SET_TMDS_RX1_HDCP2_AUTHENTICATION_ACTIVE();

                // Decrypt Ekpub[km]
                if(ScalerTMDSRx1Hdcp2RxRsaCalculate_EXINT0() == _TRUE)
                {
                    // Decrypt Km by FW to Get 128 bit Km
                    if(ScalerHdcp2RxRsaOaepCalculate_EXINT0(g_pucTmdsRx1Hdcp2Km) == _TRUE)
                    {
                        ScalerHdcp2DkeyCalculate_EXINT0(_HDCP_2_2_DKEY_0, g_pucTmdsRx1Hdcp2Rtx, g_pucTmdsRx1Hdcp2Rrx, g_pucTmdsRx1Hdcp2Km, g_pucTmdsRx1Hdcp2Rn);

                        memcpy(g_pucTmdsRx1Hdcp2dKey0, (volatile BYTE xdata *)P63_81_HDCP_AES_OUT_15, 16);

                        ScalerHdcp2DkeyCalculate_EXINT0(_HDCP_2_2_DKEY_1, g_pucTmdsRx1Hdcp2Rtx, g_pucTmdsRx1Hdcp2Rrx, g_pucTmdsRx1Hdcp2Km, g_pucTmdsRx1Hdcp2Rn);

                        memcpy(g_pucTmdsRx1Hdcp2dKey1, (volatile BYTE xdata *)P63_81_HDCP_AES_OUT_15, 16);

                        if(ScalerHdcp2HPrimeCalculate_EXINT0(g_pucTmdsRx1Hdcp2dKey0, g_pucTmdsRx1Hdcp2dKey1, g_pucTmdsRx1Hdcp2Rtx, g_pucTmdsRx1Hdcp2TxCaps, g_pucTmdsRx1Caps) == _TRUE)
                        {
                            memset(g_pucHdcp2Sha256, 0, sizeof(g_pucHdcp2Sha256));

                            // Load H prime to Read SRAM, AKE Send H PRIME Message ID = 0x07
                            ScalerTMDSRx1Hdcp2SetRdMsgIDCode_EXINT0(_HDCP_2_2_AKE_SEND_H_PRIME);

                            memcpy(g_pucHdcp2Sha256, (volatile BYTE xdata *)P63_35_HDCP_SHA_0, 32);

                            // Load Km to Read SRAM
                            ScalerTMDSRx1Hdcp2SetRdMsgValue_EXINT0(0x01, g_pucHdcp2Sha256, 32);
                            ...
                            ScalerSetBit_EXINT(P2D_36_HDCP_I2C_CTRL_8, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT1);
                ...
                SET_TMDS_RX1_HDCP2_AUTH_STATE(_HDCP_2_2_STATE_COMPUTE_KM);
            ...
            case _HDCP_2_2_AKE_STORED_KM:
                ...
                ScalerTMDSRx1Hdcp2DownLoadWriteSRAMValue_EXINT0(0x01, 16, g_pucTmdsRx1Hdcp2Km);

                // Save m From Transmitter to FW
                ScalerTMDSRx1Hdcp2DownLoadWriteSRAMValue_EXINT0(0x11, 16, g_pucHdcp2M);
                ...
                {
                    g_pucTmdsRx1Hdcp2Km[pData_EXINT[0]] = g_pucTmdsRx1Hdcp2Km[pData_EXINT[0]] ^ ScalerGetByte_EXINT(P63_81_HDCP_AES_OUT_15 + pData_EXINT[0]);
                }
                ...
                {
                    g_pucTmdsRx1Hdcp2dKey0[pData_EXINT[0]] = ScalerGetByte_EXINT(P63_81_HDCP_AES_OUT_15 + pData_EXINT[0]);
                }
                ...
                for(pData_EXINT[0] = 0; pData_EXINT[0] < 16; pData_EXINT[0]++)
                {
                    g_pucTmdsRx1Hdcp2dKey1[pData_EXINT[0]] = ScalerGetByte_EXINT(P63_81_HDCP_AES_OUT_15 + pData_EXINT[0]);
                }
                ...
                SET_TMDS_RX1_HDCP2_AKE_STORED_KM_RECEIVED();
            ...
            case _HDCP_2_2_LC_INIT:
                ...
                ScalerTMDSRx1Hdcp2DownLoadWriteSRAMValue_EXINT0(0x01, 8, g_pucTmdsRx1Hdcp2Rn);

                if(ScalerHdcp2LPrimeCalculate_EXINT0(g_pucTmdsRx1Hdcp2dKey0, g_pucTmdsRx1Hdcp2dKey1, g_pucTmdsRx1Hdcp2Rrx, g_pucTmdsRx1Hdcp2Rn) == _TRUE)
                {
                    // Load H prime to Read SRAM, AKE Send H PRIME Message ID = 10
                    ScalerTMDSRx1Hdcp2SetRdMsgIDCode_EXINT0(_HDCP_2_2_LC_SEND_L_PRIME);
                ...
                SET_TMDS_RX1_HDCP2_AUTH_STATE(_HDCP_2_2_STATE_COMPUTE_L_PRIME);
            ...
            case _HDCP_2_2_SKE_SEND_EKS:
                ...
                // Calculate Dkey 2
                ScalerHdcp2DkeyCalculate_EXINT0(_HDCP_2_2_DKEY_2, g_pucTmdsRx1Hdcp2Rtx, g_pucTmdsRx1Hdcp2Rrx, g_pucTmdsRx1Hdcp2Km, g_pucTmdsRx1Hdcp2Rn);

                // Save EDkeyKs from Write SRAM to FW
                ScalerTMDSRx1Hdcp2DownLoadWriteSRAMValue_EXINT0(0x01, 16, g_pucHdcp2EDkeyKs);

                // Save Riv from Write SRAM to FW
                ScalerTMDSRx1Hdcp2DownLoadWriteSRAMValue_EXINT0(0x11, 8, g_pucHdcp2Riv);
                ...
                {
                    g_pucHdcp2Ks[pData_EXINT[0]] = g_pucHdcp2EDkeyKs[pData_EXINT[0]] ^ (ScalerGetByte_EXINT((P63_81_HDCP_AES_OUT_15 + pData_EXINT[0])) ^ g_pucTmdsRx1Hdcp2Rrx[pData_EXINT[0] - 8]);
                }
                ...
                // Enable AES Decryption Cipher
                ScalerTMDSRx1Hdcp2AesOnlineCtrl_EXINT0(g_pucHdcp2Riv, g_pucHdcp2InputCipher);
    ...
    if((ScalerGetBit_EXINT(P2D_35_HDCP_I2C_CTRL_7, _BIT1) == _BIT1) && (ScalerGetBit_EXINT(P2D_36_HDCP_I2C_CTRL_8, _BIT1) == _BIT1))
    {
        ...
        for(pData_EXINT[0] = 0; pData_EXINT[0] < 16; ++pData_EXINT[0])
        {
            if(pData_EXINT[0] < 8)
            {
                g_pucHdcp2M[pData_EXINT[0]] = g_pucTmdsRx1Hdcp2Rtx[pData_EXINT[0]];
            }
            else
            {
                g_pucHdcp2M[pData_EXINT[0]] = g_pucTmdsRx1Hdcp2Rrx[pData_EXINT[0] - 8];
            }
        }
        ...
        for(pData_EXINT[0] = 0; pData_EXINT[0] < 16; ++pData_EXINT[0])
        {
            g_pucHdcp2EkhKm[pData_EXINT[0]] = ScalerGetByte_EXINT(P63_81_HDCP_AES_OUT_15 + pData_EXINT[0]) ^ g_pucTmdsRx1Hdcp2Km[pData_EXINT[0]];
        }

        ScalerTMDSRx1Hdcp2SetRdMsgValue_EXINT0(0x01, g_pucHdcp2EkhKm, 16);

        // Load AKE Send Pairing Info
        ScalerTMDSRx1Hdcp2SetRdMsgIDCode_EXINT0(_HDCP_2_2_AKE_SEND_PAIRING_INFO);
    ...
    ScalerSetByte_EXINT(P71_C3_HDCP_AP, g_pucHdcp2BackUp[3]);
}
//--------------------------------------------------
...
void ScalerTMDSRx1Hdcp2ResetProc(void)
{
    ...
    ScalerSetBit(P2D_3B_I2C_DUMMY_0, ~_BIT0, _BIT0);
    ScalerSetDataPortByte(P71_C3_HDCP_AP, _P71_C4_PT_70_PORT_PAGE71_HDCP2_STATUS1, 0x00);
    ...
    {
        ScalerSetDataPortBit(P71_C3_HDCP_AP, _P71_C4_PT_71_PORT_PAGE71_HDCP2_STATUS2, ~(_BIT3 | _BIT1 | _BIT0), _BIT3);
    }
    else
#endif
    {
        ScalerSetDataPortBit(P71_C3_HDCP_AP, _P71_C4_PT_71_PORT_PAGE71_HDCP2_STATUS2, ~(_BIT3 | _BIT1 | _BIT0), 0x00);
    }
    ...
    ScalerSetByte(P2D_28_HDCP_I2C_CTRL_2, 0x01);
    ...
    ScalerSetBit(P71_C0_HDCP_CR, ~_BIT0, _BIT0);
}
//--------------------------------------------------
...
// Output Value : None
//--------------------------------------------------
void ScalerTMDSRx1Hdcp2ResetProc_EXINT0(void) using 1
{
    // Disable Read Msg Done IRQ
    ScalerSetBit_EXINT(P2D_35_HDCP_I2C_CTRL_7, ~_BIT1, 0x00);
    ...
    ScalerSetByte_EXINT(P71_C4_HDCP_DP, 0x00);
    ScalerSetByte_EXINT(P71_C3_HDCP_AP, _P71_C4_PT_71_PORT_PAGE71_HDCP2_STATUS2);
    ScalerSetBit_EXINT(P71_C4_HDCP_DP, ~(_BIT3 | _BIT1 | _BIT0), 0x00);
    ScalerSetBit_EXINT(P2D_3B_I2C_DUMMY_0, ~_BIT0, 0x00);
...
// Output Value : None
//--------------------------------------------------
void ScalerTMDSRx1Hdcp2SetRdMsgIDCode_EXINT0(BYTE ucValue) using 1
{
...
// Output Value : None
//--------------------------------------------------
void ScalerTMDSRx1Hdcp2SetRdMsgValue_EXINT0(WORD usAddress, BYTE *pucReadArray, WORD usLength) using 1
{
    WORD usTemp = 0;
...
#if(_HDCP_2_2_ERRATA_TEST_SUPPORT == _ON)
//--------------------------------------------------
// Description  : HDCP 2.2 On-Line AES Ctrl for Rx1
// Input Value  : None
// Output Value : None
//--------------------------------------------------
void ScalerTMDSRx1Hdcp2AesOnlineCtrl(BYTE *pucInputArray, BYTE *pucCipherArray)
...
bit ScalerTMDSRx1Hdcp2CaptureKpubKm(void)
{
    ...
    {
        DebugMessageHDCP2("[D1]DCP LLC Signature", g_stRxHdcp2DownLoadKeyType.pucHdcp2KpubKm[usCount]);
    }
#else
...
void ScalerTMDSRx1Hdcp2CalculateKmKh(void)
{
    ...
    // Load H prime to Read SRAM, AKE Send H PRIME Message ID = 0x07
    ScalerTMDSRx1Hdcp2SetRdMsgIDCode(_HDCP_2_2_AKE_SEND_H_PRIME);

    memcpy(pucSHA256, (volatile BYTE xdata *)P63_35_HDCP_SHA_0, 32);

    for(pData[0] = 0; pData[0] < 32; pData[0]++)
    {
        DebugMessageHDCP2("[D1]H_prime", pucSHA256[pData[0]]);
    }
    ...
    // Enable HDCP2 Source Read Done IRQ
    ScalerSetBit(P2D_36_HDCP_I2C_CTRL_8, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT1);
    ...
    for(pData[0] = 0; pData[0] < 16; ++pData[0])
    {
        if(pData[0] < 8)
        {
            pucM[pData[0]] = g_pucTmdsRx1Hdcp2Rtx[pData[0]];
        }
        else
        {
            pucM[pData[0]] = g_pucTmdsRx1Hdcp2Rrx[pData[0] - 8];
        }
    }
    ...
    for(pData[0] = 0; pData[0] < 16; ++pData[0])
    {
        g_pucHdcp2Kh[pData[0]] = ScalerGetByte(P63_81_HDCP_AES_OUT_15 + pData[0]) ^ g_pucTmdsRx1Hdcp2Km[pData[0]];

        DebugMessageHDCP2("[D1]Ekh(km)", g_pucHdcp2Kh[pData[0]]);
    }
}
#endif
