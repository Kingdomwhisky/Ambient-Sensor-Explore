...
bit ScalerRotationCheckStatus(void)
{
#if((_FREESYNC_SUPPORT == _ON) && (_DISPLAY_ROTATION_TYPE == _DISPLAY_ROTATION_GEN_I))
...
void ScalerRotationFRCDisplayCtrl(WORD usHorSize, WORD usVerSize)
{
    ...
    {
        // Set Water Level
        // Water level = FIFO depth - disp_wr_len / 2
...
void ScalerRotationFRCInputCtrl(WORD usHorSize, WORD usVerSize)
{
    ...
    switch(GET_ROT_TYPE())
    {
        ...
        case _ROT_HOR_MIRROR:
            ...
            ScalerSetByte(P20_1E_CAP_M1_WATER_LEVEL_L, ((_ROTATION_WRITE_LENGTH_CW180 / 2) & 0xFF));
            ScalerSetBit(P60_1D_CAP_M2_WATER_LEVEL_H, ~(_BIT0), ((((WORD)_ROTATION_WRITE_LENGTH_CW180 / 2) >> 8) & 0x01));
            ScalerSetByte(P60_1E_CAP_M2_WATER_LEVEL_L, ((_ROTATION_WRITE_LENGTH_CW180 / 2) & 0xFF));
        ...
        default:
            ...
            ScalerSetWord(P20_1F_CAP_M1_PIXEL_NUM_H, PDATA_WORD(0));
...
// Input Value  : eunmRotationType, bEn --> Enable/Disable
// Output Value : None
//--------------------------------------------------
void ScalerRotationSetControl(EnumRotationType enumRotationType)
{
...
#endif // End of #if(_DISPLAY_ROTATION_TYPE == _DISPLAY_ROTATION_GEN_I)
