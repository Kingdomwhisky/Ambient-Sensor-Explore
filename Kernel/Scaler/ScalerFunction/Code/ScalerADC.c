...
void ScalerADCNREn(bit bEnable);
#endif
void ScalerADCThermalCompensationSetting(void);
#endif
...
void ScalerADCNREn(bit bEnable)
{
    ...
    {
        // Disable ADCNR
        ScalerSetByte(P33_00_ADCNR_CTRL1, 0x00);
    }
}
#endif

//--------------------------------------------------
// Description  : ADC & Apll thermal compensation
// Input Value  : None
// Output Value : None
//--------------------------------------------------
void ScalerADCThermalCompensationSetting(void)
{
    ...
    if(ScalerGetBit(P0_47_SYNC_SELECT, _BIT4) == _BIT4) // SOG mode
    {
        // APLL thermal compensation need set by w/i extro delay path
        SET_THERMO_LONG_PATH_STATUS();
    }
    else // Separate mode
    {
        // APLL thermal compensation need set by w/o extro delay path
