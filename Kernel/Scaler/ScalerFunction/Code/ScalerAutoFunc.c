...
#define GET_AUTO_RESULT_WORD0()                  (ScalerGetWord(&g_stRegVgaAuto.uc_16_AUTO_PHASE_1))
#define GET_AUTO_RESULT_MAX()                    (ScalerGetByte(P30_D7_VGATOP_AUTO_PHASE_0))
#define GET_AUTO_RESULT_MIN()                    (GET_AUTO_RESULT_MAX() ^ 0xFF)
#define GET_AUTO_ADC_GAIN()                      (ScalerGetByte((P0_C2_ADC_GAI_BLU_MSB - g_stRegVgaAuto.b2_0A_0_COLOR_SEL)))
#define GET_AUTO_ADC_OFFSET()                    (ScalerGetByte((P0_C5_ADC_OFF_BLU_MSB - g_stRegVgaAuto.b2_0A_0_COLOR_SEL)))
#define SET_AUTO_ADC_GAIN(ucValue)               (ScalerSetByte((P0_C2_ADC_GAI_BLU_MSB - g_stRegVgaAuto.b2_0A_0_COLOR_SEL), (ucValue)))
#define SET_AUTO_ADC_OFFSET(ucValue)             (ScalerSetByte((P0_C5_ADC_OFF_BLU_MSB - g_stRegVgaAuto.b2_0A_0_COLOR_SEL), (ucValue)))
#define SET_AUTO_ADC_CHANNEL(ucColor)            (g_stRegVgaAuto.b2_0A_0_COLOR_SEL = (((ucColor) == _AUTO_BLUE_CHANNEL) ? 0 : (((ucColor) == _AUTO_GREEN_CHANNEL) ? 1 : 2)))
#define SET_AUTO_ADC_NEXT_CHANNEL()              (g_stRegVgaAuto.b2_0A_0_COLOR_SEL = ((g_stRegVgaAuto.b2_0A_0_COLOR_SEL + 1) % 3))
...
EnumAutoResult ScalerAutoDoWhiteBalance(EnumAutoColorType enumAutoType)
{
    ...
    struct StructAdcSwapStatus
    {
        BYTE b1_ADC_R_G_SWAP : 1;
        BYTE b1_ADC_R_B_SWAP : 1;
        BYTE b1_ADC_G_B_SWAP : 1;
    } stAdcSwapStatus = {0};
    ...
    stAdcSwapStatus.b1_ADC_R_G_SWAP = g_stRegVgaCapture.b1_06_4_ADC_R_G_SWAP;
    stAdcSwapStatus.b1_ADC_R_B_SWAP = g_stRegVgaCapture.b1_06_5_ADC_R_B_SWAP;
    stAdcSwapStatus.b1_ADC_G_B_SWAP = g_stRegVgaCapture.b1_06_6_ADC_G_B_SWAP;
    ...
    g_stRegVgaCapture.b1_06_4_ADC_R_G_SWAP = stAdcSwapStatus.b1_ADC_R_G_SWAP;
    g_stRegVgaCapture.b1_06_5_ADC_R_B_SWAP = stAdcSwapStatus.b1_ADC_R_B_SWAP;
    g_stRegVgaCapture.b1_06_6_ADC_G_B_SWAP = stAdcSwapStatus.b1_ADC_G_B_SWAP;
...
void ScalerAutoInitializeAutoColor(EnumAutoColorType enumAutoType)
{
    ...
    g_stRegVgaCapture.b1_06_4_ADC_R_G_SWAP = _FALSE;
    g_stRegVgaCapture.b1_06_5_ADC_R_B_SWAP = _FALSE;
    g_stRegVgaCapture.b1_06_6_ADC_G_B_SWAP = _FALSE;
...
EnumAutoResult ScalerAutoUpdateAdcGain(BYTE ucGainBias, BYTE ucStepRatio)
{
    ...
    g_stRegVgaAuto.b1_06_0_NEW_RESULT_MODE = _TRUE;

    // Enable 121-LPF
    g_stRegVgaAuto.b1_0A_5_FILTER_SEL = _TRUE;
    ...
    for(ucIndex = 0; ucIndex < 3; ++ucIndex)
    {
        ...
        ucMax = ScalerGetByte((&g_stRegVgaAuto.uc_14_AUTO_PHASE_3) + ucIndex);
...
EnumAutoResult ScalerAutoAccumulationMeasure(EnumMeasureType enumType, BYTE ucThreshold)
{
    ...
    // Set threshold
    g_stRegVgaAuto.uc_09_DIFF_TH = ucThreshold;
...
EnumAutoResult ScalerAutoMainToneMeasure(BYTE ucStartLevel, BYTE *pucMainTone)
{
    ...
    *pucMainTone = 3;
    ...
    g_stRegVgaAuto.uc_09_DIFF_TH = ucStartLevel;
    ...
    g_stRegVgaAuto.b3_0B_0_AUTOPHASE_STEP = (1 - 1);
    g_stRegVgaAuto.b5_0B_3_AUTOSOD_STEP_NUM = (5 - 1);

    // Initial phase = current phase
    g_stRegVgaAuto.b7_0C_0_INIT_PHASE = ScalerGetByte(P1_B4_PLLPHASE_CTRL1);
    ...
    for(ucIndex = 0; ucIndex < 5; ++ucIndex)
    {
        ...
        // Decrease threshold
        g_stRegVgaAuto.uc_09_DIFF_TH -= 1;
...
EnumAutoResult ScalerAutoCustomUpdateAdcGainChannel(BYTE ucColor, BYTE ucGainBias, BYTE ucStepRatio)
{
    ...
    // Disable field select; Disable hardware acceleration;
    g_stRegVgaAuto.uc_09_DIFF_TH = 0x00;
    g_stRegVgaAuto.b1_0A_7_ODD_SEL_EN = _FALSE;
    g_stRegVgaAuto.b1_0A_4_RGB_IN_ONE_EN = _FALSE;
