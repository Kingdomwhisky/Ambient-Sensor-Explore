...
//----------------------------------------------------------------------------------------------------
// ID Code      : ScalerCommonDPTxMSTInclude.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define SET_REG_DP_TX_DOWNSTREAM_MSG_WRITE_DISABLE_EXINT()          (ScalerSetBit_EXINT(PBD_B5_MSG_WR_CTRL, ~_BIT0, 0x00))
...
#define SET_REG_DP_TX_DOWNSTREAM_MSG_WRITE_PTR_EXINT(x)             (ScalerSetByte_EXINT(PBD_C6_BUF_FW_WRPTR, ((x) & 0x3F)))
...
#define SET_REG_DP_TX_UPSTREAM_MSG_READ_DISABLE_EXINT()             (ScalerSetBit_EXINT(PBD_CA_AUX_TX_MSG_RD_CTRL, ~_BIT0, 0x00))
...
#define GET_REG_DP_TX_UPSTREAM_MSG_LCT()                            ((ScalerGetBit(PBD_CF_MSG_RD_DATA0, (_BIT7 | _BIT6 | _BIT5 | _BIT4))) >> 4)
#define GET_REG_DP_TX_UPSTREAM_MSG_LCR()                            (ScalerGetBit(PBD_CF_MSG_RD_DATA0, (_BIT3 | _BIT2 | _BIT1 | _BIT0)))
#define GET_REG_DP_TX_UPSTREAM_MSG_BROADCAST()                      ((ScalerGetBit(PBD_D7_MSG_RD_DATA8, _BIT7)) >> 7)
#define GET_REG_DP_TX_UPSTREAM_MSG_PATH()                           ((ScalerGetBit(PBD_D7_MSG_RD_DATA8, _BIT6)) >> 6)
#define GET_REG_DP_TX_UPSTREAM_MSG_BODY_LENGTH()                    (ScalerGetBit(PBD_D7_MSG_RD_DATA8, (_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0)))
#define GET_REG_DP_TX_UPSTREAM_MSG_MSN()                            ((ScalerGetBit(PBD_D8_MSG_RD_DATA9, _BIT4)) >> 4)
...
#define CLR_REG_DP_TX_UPSTREAM_MSG_READ_FINISH_FLAG_EXINT()         (ScalerSetBit_EXINT(PBD_CC_MSG_RD_FINISH, ~(_BIT1 | _BIT0), _BIT0))
#define CLR_REG_DP_TX_UPSTREAM_SBMSG_FINISH_FLAG()                  (ScalerSetBit(PBD_CC_MSG_RD_FINISH, ~(_BIT1 | _BIT0), _BIT1))
#define CLR_REG_DP_TX_UPSTREAM_SBMSG_FINISH_FLAG_EXINT()            (ScalerSetBit_EXINT(PBD_CC_MSG_RD_FINISH, ~(_BIT1 | _BIT0), _BIT1))
...
#define CLR_REG_DP_TX_UPSTREAM_MSG_BUF_EXINT()                      (ScalerSetBit_EXINT(PBD_DE_MSG_BUF_CLR, ~_BIT0, _BIT0))
...
#define GET_DP_TX_HDCP_AUTH_PROCCESSING()                           (GET_DP_TX_HDCP_AUTH_STATE() != _DP_TX_HDCP_STATE_IDLE)

#if(_DP_HDCP_2_2_SUPPORT == _ON)
#define GET_DP_TX_HDCP2_AUTH_PROC_PASS()                            (GET_DP_TX_HDCP2_AUTH_STATE() == _HDCP_2_2_TX_STATE_AUTHEN_DONE)
#define GET_DP_TX_HDCP2_AUTH_PROCCESSING()                          (GET_DP_TX_HDCP2_AUTH_STATE() != _HDCP_2_2_TX_STATE_IDLE)
#endif

//--------------------------------------------------
// Macro of MST Infomation
//--------------------------------------------------
#define GET_DP_TX_MST_ENABLE()                                      (ScalerGetBit(PBB_00_DP_PHY_CTRL, _BIT1) == _BIT1)

#define GET_DP_TX_STX_TIMESLOT_LENGTH(x)                            (ScalerGetBit(GET_DP_TX_STX_END_ADDRESS(x), (_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0)) -\
                                                                     ScalerGetBit(GET_DP_TX_STX_START_ADDRESS(x), (_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0)) + 1)
//--------------------------------------------------
...
#define GET_DP_TX_WAIT_TOPOLOGY_REBUILD_MSG()                       (g_stTxMsgInfo.b1WaitTopologyRebuildProcess)
#define SET_DP_TX_WAIT_TOPOLOGY_REBUILD_MSG()                       (g_stTxMsgInfo.b1WaitTopologyRebuildProcess = _TRUE)
#define CLR_DP_TX_WAIT_TOPOLOGY_REBUILD_MSG()                       (g_stTxMsgInfo.b1WaitTopologyRebuildProcess = _FALSE)

#define GET_DP_TX_BYPASS_UNPLUG_CSN_IS_PENDING()                    (g_stTxMsgInfo.bUnplugCSNIsPending)
#define SET_DP_TX_BYPASS_UNPLUG_CSN_IS_PENDING()                    (g_stTxMsgInfo.bUnplugCSNIsPending = _TRUE)
#define CLR_DP_TX_BYPASS_UNPLUG_CSN_IS_PENDING()                    (g_stTxMsgInfo.bUnplugCSNIsPending = _FALSE)
...
//--------------------------------------------------
#define CLR_DP_TX_UP_REQUEST_MSG_HEADER()                           (memset(&g_stUpReqMsgHeaderInfo, 0, sizeof(g_stUpReqMsgHeaderInfo)))

#define GET_DP_TX_UP_REQUEST_MSG_LENGTH()                           (g_stUpReqMsgHeaderInfo.ucUpReqMsgLength)
#define SET_DP_TX_UP_REQUEST_MSG_LENGTH(x)                          (g_stUpReqMsgHeaderInfo.ucUpReqMsgLength = (x))

#define GET_DP_TX_UP_REQUEST_MSG_LCR()                              (g_stUpReqMsgHeaderInfo.b4UpReqMsgLCR)
#define SET_DP_TX_UP_REQUEST_MSG_LCR(x)                             (g_stUpReqMsgHeaderInfo.b4UpReqMsgLCR = (x))

#define GET_DP_TX_UP_REQUEST_MSG_LCT()                              (g_stUpReqMsgHeaderInfo.b4UpReqMsgLCT)
#define SET_DP_TX_UP_REQUEST_MSG_LCT(x)                             (g_stUpReqMsgHeaderInfo.b4UpReqMsgLCT = (x))

#define GET_DP_TX_UP_REQUEST_MSG_BROADCAST()                        (g_stUpReqMsgHeaderInfo.b1UpReqMsgBroadcast)
#define SET_DP_TX_UP_REQUEST_MSG_BROADCAST(x)                       (g_stUpReqMsgHeaderInfo.b1UpReqMsgBroadcast = (x))

#define GET_DP_TX_UP_REQUEST_MSG_PATH()                             (g_stUpReqMsgHeaderInfo.b1UpReqMsgPath)
#define SET_DP_TX_UP_REQUEST_MSG_PATH(x)                            (g_stUpReqMsgHeaderInfo.b1UpReqMsgPath = (x))

#define GET_DP_TX_UP_REQUEST_MSG_MSN()                              (g_stUpReqMsgHeaderInfo.b1UpReqMsgMsn)
#define SET_DP_TX_UP_REQUEST_MSG_MSN(x)                             (g_stUpReqMsgHeaderInfo.b1UpReqMsgMsn = (x))

#define GET_DP_TX_UP_REQUEST_MSG_READ_FINISH()                      (g_stUpReqMsgHeaderInfo.b1UpReqMsgReadFinish)
#define SET_DP_TX_UP_REQUEST_MSG_READ_FINISH(x)                     (g_stUpReqMsgHeaderInfo.b1UpReqMsgReadFinish = (x))
...
extern StructTxUpRequestMsgHeaderInfo g_stUpReqMsgHeaderInfo;
...
extern void ScalerDpTxMstReset_EXINT0(void);
#endif
