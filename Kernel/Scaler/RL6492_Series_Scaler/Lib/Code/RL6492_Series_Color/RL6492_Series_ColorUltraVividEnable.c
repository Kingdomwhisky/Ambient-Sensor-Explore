...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6492_Series_ColorUltraVividEnable.c
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
void ScalerColorUltraVividEnable(EnumFunctionOnOFF enumFunctionOnOff, EnumDBApply enumDBApply)
{
    if(enumFunctionOnOff == _FUNCTION_ON)
    {
        ...
        ScalerSetBit(P1_C7_DCLK_GATED_CTRL1, ~_BIT7, _BIT7);

        ScalerSetBit(P1_C7_DCLK_GATED_CTRL1, ~_BIT6, _BIT6);
    ...
    else
    {
        ...
        ScalerSetBit(P1_C7_DCLK_GATED_CTRL1, ~_BIT7, 0x00);

        ScalerSetBit(P1_C7_DCLK_GATED_CTRL1, ~_BIT6, 0x00);
    }
}
