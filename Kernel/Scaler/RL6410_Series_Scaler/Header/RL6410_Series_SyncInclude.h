...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6410_Series_SyncInclude.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define GET_HDMIRX4_AMD_SPD_INFO(x)                         (ScalerFreeSyncHDMIRx4GetAmdSpdInfo(x))
#define GET_HDMIRX5_AMD_SPD_INFO(x)                         (ScalerFreeSyncHDMIRx5GetAmdSpdInfo(x))
#endif
...
#define GET_TMDSRX4_HDR10_DATA(x)                           (ScalerTMDSRx4GetHDR10Data(x))
#define GET_TMDSRX5_HDR10_DATA(x)                           (ScalerTMDSRx5GetHDR10Data(x))
#endif
...
#define GET_TMDSRX4_FREESYNCII_DATA(x)                      (ScalerTMDSRx4GetFreeSyncIIData(x))
#define GET_TMDSRX5_FREESYNCII_DATA(x)                      (ScalerTMDSRx5GetFreeSyncIIData(x))
#endif
