...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6410_Series_OsdVerticalBoundaryFunction.c
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
void ScalerOsdVerticalBoundarySize(WORD usUpperBoundary, WORD usLowerBoundary)
{
    ScalerSetBit(P3A_33_FRAME_CTRL_33, ~(_BIT7), ((usUpperBoundary & 0x800) >> 4));         // OSD Vertical Upper Boundary [11]
    ScalerSetBit(P3A_33_FRAME_CTRL_33, ~(_BIT3), ((usLowerBoundary & 0x800) >> 8));         // OSD Vertical Lower Boundary [11]
