...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6410_Series_Osd.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6410_SERIES_OSD__
...
void ScalerOsdMapRotation(EnumOsdRotateType enumOsdRotateType, EnumOsdRotateMapA enumOsdRotateMapA, BYTE ucMapARowSize, EnumOsdRotateMapB enumOsdRotateMapB, BYTE ucMapBRowSize, EnumOsdRotateFontLib enumOsdRotateFontLib)
{
    ...
    {
        switch(ucTemp & (_BIT5 | _BIT4))   // OSD Auto Rotation Direction
        {
            case 0x00:
            ...
            case _BIT5:
                ucTemp = _OSD_ROTATE_DEGREE_180;    // CCW
                break;
    ...
    {
        ScalerSetBit(P3A_18_FRAME_CTRL_18, ~(_BIT7 | _BIT6), 0x00);
        ...
        switch(ucTemp)
        {
            ...
            case _OSD_ROTATE_DEGREE_180:
                ScalerSetByte(P3A_0B_FRAME_CTRL_0B, 0x00);
                ScalerSetByte(P3A_41_FRAME_CTRL_41, (_BIT5 | _BIT3)); // _OSD_ROTATE_CW180
                ScalerOsdFontLibraryRotation();
                break;
        ...
        switch(enumOsdRotateType)
        {
            ...
            case _OSD_ROTATE_DEGREE_180:
                ...
                ScalerSetBit(P3A_18_FRAME_CTRL_18, ~(_BIT7 | _BIT6), (_BIT7 | _BIT6));

                ScalerSetByte(P3A_0B_FRAME_CTRL_0B, 0x00);
                ScalerSetByte(P3A_41_FRAME_CTRL_41, ((_BIT5 | (BYTE)enumOsdRotateFontLib << 3 | (BYTE)enumOsdRotateMapA << 2 | (BYTE)enumOsdRotateMapB << 1) | _BIT0));         // _OSD_ROTATE_CW180
                ScalerOsdFontLibraryRotation();
                break;
    ...
    else if(ucTemp == _OSD_ROTATE_DEGREE_180)
    {
        ScalerSetByte(P3A_0B_FRAME_CTRL_0B, 0x00);
        ScalerSetByte(P3A_41_FRAME_CTRL_41, (_BIT5 | _BIT3)); // _OSD_ROTATE_CW180
    ...
    // Check Double Width / Height Function
