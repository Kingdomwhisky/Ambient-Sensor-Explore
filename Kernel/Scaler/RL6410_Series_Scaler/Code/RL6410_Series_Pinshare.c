...
void ScalerPinshareInitial(void)
{
    ...
    ScalerSetByte(P10_26_PIN_SHARE_CTRL66, (BYTE)_PIN_N29_OFF_REGION); // Page 10-26[2:0], Pin_N29
    ScalerSetByte(P10_27_PIN_SHARE_CTRL67, (BYTE)_PIN_N28_OFF_REGION); // Page 10-27[2:0], Pin_N28
    ScalerSetByte(P10_28_PIN_SHARE_CTRL70, (BYTE)_PIN_M29_OFF_REGION); // Page 10-28[2:0], Pin_M29
    ScalerSetByte(P10_29_PIN_SHARE_CTRL71, (BYTE)_PIN_M28_OFF_REGION); // Page 10-29[2:0], Pin_M28
    ScalerSetByte(P10_2A_PIN_SHARE_CTRL72, (BYTE)_PIN_J29_OFF_REGION); // Page 10-2A[2:0], Pin_J29
    ScalerSetByte(P10_2B_PIN_SHARE_CTRL73, (BYTE)_PIN_AJ28); // Page 10-2B[2:0], Pin_AJ28
    ScalerSetByte(P10_2C_PIN_SHARE_CTRL74, (BYTE)_PIN_N27_OFF_REGION); // Page 10-2C[2:0], Pin_N27
    ScalerSetByte(P10_2D_PIN_SHARE_CTRL75, (BYTE)_PIN_K27_OFF_REGION); // Page 10-2D[2:0], Pin_K27
    ScalerSetByte(P10_2E_PIN_SHARE_CTRL76, (BYTE)_PIN_M27_OFF_REGION); // Page 10-2E[2:0], Pin_M27
    ScalerSetByte(P10_2F_PIN_SHARE_CTRL77, (BYTE)_PIN_K29_OFF_REGION); // Page 10-2F[2:0], Pin_K29

    ScalerSetByte(P10_30_PIN_SHARE_CTRL80, (BYTE)_PIN_J28_OFF_REGION); // Page 10-30[2:0], Pin_J28
    ScalerSetByte(P10_31_PIN_SHARE_CTRL81, (BYTE)_PIN_J27_OFF_REGION); // Page 10-31[2:0], Pin_J27
    ScalerSetByte(P10_32_PIN_SHARE_CTRL82, (BYTE)_PIN_K28_OFF_REGION); // Page 10-32[2:0], Pin_K28
...
void ScalerPinshareAdjustConfig(EnumConfigPin enumConfigPin, EnumPinConfigType enumConfigType)
{
    switch(enumConfigPin)
    {
        ...
        case _CONFIG_PIN_N29_OFF_REGION:
        ...
        case _CONFIG_PIN_N28_OFF_REGION:
        ...
        case _CONFIG_PIN_M29_OFF_REGION:
        ...
        case _CONFIG_PIN_M28_OFF_REGION:
        ...
        case _CONFIG_PIN_J29_OFF_REGION:
        ...
        case _CONFIG_PIN_N27_OFF_REGION:
            ...
            switch(enumConfigType)
            {
                ...
                case _WS:
                    ScalerSetBit(P10_2C_PIN_SHARE_CTRL74, ~(_BIT2 | _BIT1 | _BIT0), _BIT1 | _BIT0);
                    break;
        ...
        case _CONFIG_PIN_K27_OFF_REGION:
            ...
            switch(enumConfigType)
            {
                ...
                case _SCK:
                    ScalerSetBit(P10_2D_PIN_SHARE_CTRL75, ~(_BIT2 | _BIT1 | _BIT0), _BIT1 | _BIT0);
                    break;
        ...
        case _CONFIG_PIN_M27_OFF_REGION:
            ...
            switch(enumConfigType)
            {
                ...
                case _MCK:
                    ScalerSetBit(P10_2E_PIN_SHARE_CTRL76, ~(_BIT2 | _BIT1 | _BIT0), _BIT1 | _BIT0);
                    break;
        ...
        case _CONFIG_PIN_K29_OFF_REGION:
        ...
        case _CONFIG_PIN_J28_OFF_REGION:
        ...
        case _CONFIG_PIN_J27_OFF_REGION:
        ...
        case _CONFIG_PIN_K28_OFF_REGION:
        ...
        case _CONFIG_PIN_AH21:

            switch(enumConfigType)
            {
                case _GPI:
                    ScalerSetBit(P10_33_PIN_SHARE_CTRL83, ~(_BIT7 | _BIT2 | _BIT1 | _BIT0), 0x00);
                    break;

                case _GPO_PP:
                    ScalerSetBit(P10_33_PIN_SHARE_CTRL83, ~(_BIT7 | _BIT2 | _BIT1 | _BIT0), _BIT0);
                    break;

                case _GPO_OD:
                    ScalerSetBit(P10_33_PIN_SHARE_CTRL83, ~(_BIT7 | _BIT2 | _BIT1 | _BIT0), _BIT1);
                    break;

                case _USB_SPI:
                    ScalerSetBit(P10_33_PIN_SHARE_CTRL83, ~(_BIT7 | _BIT2 | _BIT1 | _BIT0), _BIT7);
                    break;
