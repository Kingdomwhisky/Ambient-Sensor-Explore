...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6410_Series_QC_Color_DDomain_II.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6410_SERIES_QC_COLOR_DDOMAIN_II__
...
BYTE code tQC_D_DOMAIN_DCR_RESULT_TABLE_0_5K3K[]=
{
    0xe0, 0xec, 0xa5, 0x51, 0x29, 0x11, 0xbe, 0x70,
    0x5d, 0x6c, 0xd6, 0x1c, 0xba, 0xe4, 0x0d, 0x6c,
    0x13, 0xcc, 0xff, 0x00, 0x11, 0x83, 0x0a, 0x3e,
    0xff, 0x00, 0x11, 0x22, 0x0a, 0x09, 0xff, 0x00,
    0x0e, 0x0e, 0x0e, 0x0e, 0x0e, 0x0e, 0xff, 0x00,
    0x20, 0x80, 0xc0, 0x00, 0xc0, 0x00, 0xc0, 0x00,
    0x00, 0x00,
};

BYTE code tQC_D_DOMAIN_DCR_RESULT_TABLE_1_5K3K[]=
{
    0x34, 0x80, 0x90, 0x2e, 0x58, 0xfe, 0x3f, 0x88,
    0xdd, 0x04, 0x5f, 0x2a, 0x42, 0x98, 0x0d, 0x6c,
    0x13, 0xcc, 0xff, 0x00, 0x11, 0x83, 0x0a, 0x3e,
    0xff, 0x00, 0x11, 0x22, 0x0a, 0x09, 0xff, 0x00,
    0x0e, 0x0e, 0x0e, 0x0e, 0x0e, 0x0e, 0xff, 0x00,
    0x00, 0x4c, 0xc0, 0x00, 0xc0, 0x00, 0xc0, 0x00,
    0x00, 0x00,
};

BYTE code tQC_D_DOMAIN_DCR_RESULT_TABLE_2_5K3K[]=
{
    0x15, 0x05, 0xd9, 0x0c, 0xf2, 0xb0, 0xc7, 0x0a,
    0xc2, 0x07, 0x08, 0xa4, 0x12, 0x73, 0xb4, 0xff,
    0xb9, 0x64, 0xff, 0x00, 0xb4, 0xb9, 0xb3, 0x10,
    0xff, 0x00, 0xb4, 0xbd, 0xb3, 0x52, 0xff, 0x00,
    0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0xff, 0x01,
    0x00, 0x08, 0xc0, 0x00, 0xc0, 0x00, 0xc0, 0x00,
    0x00, 0x00,
};

BYTE code tQC_D_DOMAIN_DCR_RESULT_TABLE_3_5K3K[]=
{
    0xc4, 0x1e, 0xef, 0x64, 0x50, 0x99, 0xef, 0x04,
    0xef, 0x1a, 0x04, 0xed, 0xde, 0x39, 0x89, 0xd2,
    0x1e, 0x73, 0xff, 0x00, 0x85, 0x07, 0x0e, 0x6e,
    0xff, 0x00, 0xb8, 0x45, 0xf5, 0xae, 0xff, 0x00,
    0x0e, 0x0c, 0x0f, 0x0c, 0x10, 0x0b, 0xff, 0x00,
    0x00, 0x08, 0xc0, 0x00, 0xc0, 0x00, 0xc0, 0x00,
    0xc0, 0x00,
};

BYTE code tQC_D_DOMAIN_DCR_RESULT_TABLE_4_5K3K[]=
{
    0x05, 0x10, 0x57, 0x20, 0x38, 0x73, 0x8c, 0x10,
    0x5d, 0x17, 0x54, 0x6f, 0xfb, 0x22, 0x06, 0x5d,
    0xb4, 0x58, 0xff, 0x00, 0x29, 0x6f, 0xac, 0x51,
    0xff, 0x00, 0x54, 0x0e, 0xa9, 0x2f, 0xff, 0x00,
    0x02, 0x01, 0x02, 0x01, 0x02, 0x01, 0xff, 0x01,
    0x00, 0xc0, 0xc0, 0x00, 0xc0, 0x00, 0xc0, 0x00,
    0xc0, 0x00,
};
#endif
//--------------------------------------------------
...
#if(_QC_5K3K_MODE_ == _ON)
BYTE code tQC_DCC_CRC_TABLE0_5K3K[] = {
    0x08, 0x08, 0xE9, 0x59, 0xA2, 0xF4, // M1
    0x3C, 0x8F, 0x15, 0xF9, 0xD9, 0xAD, // M2
    0x44, 0x02, 0x24, 0xB3, 0x3C, 0x01, // S1
    0xE1, 0x8B, 0xCA, 0xAB, 0xB6, 0x54, // S2
};

BYTE code tQC_DCC_CRC_TABLE1_5K3K[] = {
    0x1B, 0x95, 0x8E, 0xB1, 0xCA, 0x83, // M1
    0x5B, 0x2E, 0x89, 0x3A, 0xF4, 0x01, // M2
    0x03, 0xCB, 0xC6, 0x66, 0x86, 0x8D, // S1
    0xDB, 0x99, 0xEC, 0x4D, 0xED, 0x94, // S2
};

BYTE code tQC_DCC_CRC_TABLE2_5K3K[] = {
    0x37, 0x33, 0xFC, 0x42, 0x64, 0xFF, // M1
    0xA6, 0x47, 0x05, 0xA1, 0xAD, 0x55, // M2
    0xCF, 0x87, 0xFB, 0xF4, 0xC4, 0x0F, // S1
    0x08, 0x85, 0x1E, 0xCD, 0xA4, 0x7F, // S2
};

BYTE code tQC_DCC_CRC_TABLE3_5K3K[] = {
    0xEB, 0x8F, 0x25, 0x8A, 0xFD, 0x80, // M1
    0xBD, 0x4B, 0x7B, 0x20, 0x32, 0x43, // M2
    0x8F, 0x9D, 0xFA, 0xE4, 0xA9, 0x84, // S1
    0x99, 0xE3, 0x98, 0x90, 0xF7, 0xF8, // S2
};

BYTE code tQC_DCC_CRC_TABLE4_5K3K[] = {
    0x9F, 0xC7, 0x73, 0x00, 0x5E, 0x96, // M1
    0xBC, 0x3C, 0xD8, 0x70, 0x79, 0x11, // M2
    0xC6, 0x5F, 0x40, 0x0A, 0x60, 0x9C, // S1
    0x39, 0xA8, 0x1F, 0xE2, 0xA0, 0xF3, // S2
};

BYTE code tQC_DCC_CRC_TABLE5_5K3K[] = {
    0x2F, 0x77, 0x22, 0x93, 0xFC, 0x14, // M1
    0xC6, 0x79, 0x83, 0x56, 0x7A, 0x68, // M2
    0xDE, 0xEA, 0x12, 0x50, 0xF0, 0x0B, // S1
    0x05, 0x26, 0xB8, 0x72, 0xFB, 0xD0, // S2
};

BYTE code tQC_DCC_CRC_TABLE6_5K3K[] = {
    0x24, 0xE2, 0xC4, 0x3D, 0xF2, 0x33, // M1
    0xBE, 0xCD, 0xA2, 0x7F, 0xC8, 0x72, // M2
    0x40, 0xAF, 0x4B, 0x71, 0x9A, 0x2B, // S1
    0x22, 0xA3, 0xEB, 0x32, 0x03, 0x3D, // S2
};

BYTE code tQC_DCC_CRC_TABLE7_5K3K[] = {
    0x43, 0x21, 0xBC, 0x0D, 0x10, 0xCC, // M1
    0x54, 0x1B, 0xAB, 0xF8, 0x28, 0x4C, // M2
    0x81, 0xFA, 0x28, 0x4E, 0x10, 0x92, // S1
    0x3F, 0x8E, 0x69, 0x4C, 0x59, 0x00, // S2
};

BYTE code tQC_DCC_CRC_TABLE8_5K3K[] = {
    0x0C, 0xAB, 0x9C, 0x19, 0x02, 0x91, // M1
    0xCA, 0xA4, 0x09, 0xB1, 0xC6, 0x2A, // M2
    0xEC, 0x90, 0x82, 0x29, 0xC8, 0x0E, // S1
    0xBB, 0x10, 0xFC, 0x6C, 0xE2, 0x7F, // S2
};

BYTE code tQC_DCC_CRC_TABLE9_5K3K[] = {
    0xBF, 0xC7, 0x87, 0xE3, 0x6F, 0xE6, // M1
    0xB6, 0xE6, 0xC9, 0x43, 0x7A, 0xF6, // M2
    0x24, 0x60, 0x56, 0x7C, 0x62, 0x0D, // S1
    0xE1, 0xFB, 0x5A, 0x86, 0xDF, 0xDB, // S2
};

BYTE code tQC_DCC_CRC_TABLE10_5K3K[] = {
    0x58, 0x9A, 0x96, 0x06, 0x18, 0x79, // M1
    0x6B, 0xDA, 0x6B, 0x81, 0xE7, 0x24, // M2
    0xCC, 0xF0, 0x15, 0xC9, 0x76, 0xA5, // S1
    0x4D, 0x2E, 0xDF, 0x17, 0x49, 0xD3, // S2
};

BYTE code tQC_DCC_CRC_TABLE11_5K3K[] = {
    0x2A, 0x28, 0x06, 0xD9, 0xFC, 0x99, // M1
    0x27, 0x4A, 0x07, 0x7D, 0xAC, 0x55, // M2
    0xBB, 0xBA, 0x54, 0x60, 0xF4, 0xF9, // S1
    0x4D, 0x25, 0x44, 0x4D, 0x5B, 0xDB, // S2
};

BYTE code tQC_DCC_CRC_TABLE12_5K3K[] = {
    0x8D, 0x98, 0xB8, 0x66, 0x28, 0x03, // M1
    0x1D, 0x35, 0x19, 0x13, 0x2B, 0x0F, // M2
    0x4C, 0xF5, 0x3C, 0xCE, 0xEE, 0x3D, // S1
    0x62, 0xEF, 0xC5, 0x0F, 0xD8, 0x41, // S2
};
#endif
...
#if(_QC_5K3K_MODE_ == _ON)
BYTE code tQC_DCC_SETTING0_5K3K[] =
{
    //---------Dcc-------------
    4, _NON_AUTOINC, 0x9F, 0x07,
    4, _NON_AUTOINC, 0xC7, 0xE4,
    ...
    4, _NON_AUTOINC, 0xC7, 0xE4,
    4, _NON_AUTOINC, 0xC9, 0x00,
    15, _NON_AUTOINC, 0xCA, 0x00, 0x01, 0x22, 0x80, 0x00, 0xC0, 0xB4, 0xF0, 0x10, 0x10, 0x00, 0xFF,
...
BYTE code tQC_DCC_SETTING1_5K3K[] =
{
    //---------Dcc-------------
    4, _NON_AUTOINC, 0x9F, 0x07,
    4, _NON_AUTOINC, 0xC7, 0x84,
    ...
    4, _NON_AUTOINC, 0xC7, 0x84,
    4, _NON_AUTOINC, 0xC9, 0x00,
    15, _NON_AUTOINC, 0xCA, 0x00, 0x01, 0x22, 0x00, 0x00, 0xC0, 0x00, 0xFF, 0xFF, 0x10, 0x00, 0xFF,
...
BYTE code tQC_DCC_SETTING2_5K3K[] =
{
    //---------Dcc-------------
    4, _NON_AUTOINC, 0x9F, 0x07,
    4, _NON_AUTOINC, 0xC7, 0xD4,
    ...
    4, _NON_AUTOINC, 0xC7, 0xD4,
    4, _NON_AUTOINC, 0xC9, 0x00,
    15, _NON_AUTOINC, 0xCA, 0x00, 0x01, 0x22, 0x00, 0x00, 0xC0, 0x00, 0x00, 0x00, 0x10, 0x00, 0xFF,
...
BYTE code tQC_DCC_SETTING3_5K3K[] =
{
    //---------Dcc-------------
    4, _NON_AUTOINC, 0x9F, 0x07,
    4, _NON_AUTOINC, 0xC7, 0xA0,
    ...
    4, _NON_AUTOINC, 0xC7, 0xA0,
    4, _NON_AUTOINC, 0xC9, 0x00,
    15, _NON_AUTOINC, 0xCA, 0x00, 0x01, 0x1B, 0x8F, 0x00, 0x00, 0x4B, 0xFF, 0x00, 0x10, 0x00, 0xFF,
...
BYTE code tQC_DCC_SETTING4_5K3K[] =
{
    //---------Dcc-------------
    4, _NON_AUTOINC, 0x9F, 0x07,
    4, _NON_AUTOINC, 0xC7, 0xD4,
    ...
    4, _NON_AUTOINC, 0xC7, 0xD4,
    4, _NON_AUTOINC, 0xC9, 0x00,
    15, _NON_AUTOINC, 0xCA, 0x00, 0x01, 0x1B, 0x8F, 0x00, 0xC0, 0x00, 0x00, 0xFF, 0x10, 0x00, 0xFF,
...
BYTE code tQC_DCC_SETTING5_5K3K[] =
{
    //---------Dcc-------------
    4, _NON_AUTOINC, 0x9F, 0x07,
    4, _NON_AUTOINC, 0xC7, 0xB4,
    ...
    4, _NON_AUTOINC, 0xC7, 0xB4,
    4, _NON_AUTOINC, 0xC9, 0x00,
    15, _NON_AUTOINC, 0xCA, 0x00,0x01,0x22,0x87,0x00,0xC0,0xFF,0xF0,0x10,0x10,0x00,0xFF,
...
BYTE code tQC_DCC_SETTING6_5K3K[] =
{
    //---------Dcc-------------
    4, _NON_AUTOINC, 0x9F, 0x07,
    4, _NON_AUTOINC, 0xC7, 0xE4,
    ...
    4, _NON_AUTOINC, 0xC7, 0xE4,
    4, _NON_AUTOINC, 0xC9, 0x00,
    15, _NON_AUTOINC, 0xCA, 0x00,0x08,0xD4,0x88,0x00,0xC0,0x00,0x0F,0xEF,0x10,0x00,0xFF,
...
BYTE code tQC_DCC_SETTING7_5K3K[] =
{
    //---------Dcc-------------
    4, _NON_AUTOINC, 0x9F, 0x07,
    4, _NON_AUTOINC, 0xC7, 0xB4,
    ...
    4, _NON_AUTOINC, 0xC7, 0xB4,
    4, _NON_AUTOINC, 0xC9, 0x00,
    15, _NON_AUTOINC, 0xCA, 0x00,0x01,0x45,0x00,0x00,0xC0,0xB4,0xF0,0x10,0x10,0x00,0xFF,
...
BYTE code tQC_DCC_SETTING8_5K3K[] =
{
    //---------Dcc-------------
    4, _NON_AUTOINC, 0x9F, 0x07,
    4, _NON_AUTOINC, 0xC7, 0x80,
    ...
    4, _NON_AUTOINC, 0xC7, 0x80,
    4, _NON_AUTOINC, 0xC9, 0x00,
    15, _NON_AUTOINC, 0xCA, 0x00, 0x01, 0x1B, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x00, 0x10, 0x00, 0xFF,
...
BYTE code tQC_DCC_SETTING9_5K3K[] =
{
    //---------Dcc-------------
    4, _NON_AUTOINC, 0x9F, 0x07,
    4, _NON_AUTOINC, 0xC7, 0xA0,
    ...
    4, _NON_AUTOINC, 0xC7, 0xA0,
    4, _NON_AUTOINC, 0xC9, 0x00,
    15, _NON_AUTOINC, 0xCA, 0x00, 0x01, 0x1B, 0x04, 0x00, 0x00, 0xB4, 0xFF, 0x00, 0x10, 0x00, 0xFF,
...
BYTE code tQC_DCC_SETTING10_5K3K[] =
{
    //---------Dcc-------------
    4, _NON_AUTOINC, 0x9F, 0x07,
    4, _NON_AUTOINC, 0xC7, 0x80,
    ...
    4, _NON_AUTOINC, 0xC7, 0x80,
    4, _NON_AUTOINC, 0xC9, 0x00,
    15, _NON_AUTOINC, 0xCA, 0x00,0x01,0x22,0x00,0x00,0x00,0x00,0xFF,0x00,0x10,0x00,0xFF,
...
BYTE code tQC_DCC_SETTING11_5K3K[] =
{
    //---------Dcc-------------
    4, _NON_AUTOINC, 0x9F, 0x07,
    4, _NON_AUTOINC, 0xC7, 0xA0,
    ...
    4, _NON_AUTOINC, 0xC7, 0xA0,
    4, _NON_AUTOINC, 0xC9, 0x00,
    15, _NON_AUTOINC, 0xCA, 0x00,0x01,0x1B,0x04,0x00,0x00,0xFF,0xFF,0x00,0x10,0x00,0xFF,
...
#if(_QC_5K3K_MODE_ == _ON)
BYTE code tQC_DCC_SETTING12_5K3K[] =
{
    //---------Dcc-------------
    4, _NON_AUTOINC, 0x9F, 0x07,
    4, _NON_AUTOINC, 0xC7, 0x84,
    ...
    4, _NON_AUTOINC, 0xC7, 0x84,
    4, _NON_AUTOINC, 0xC9, 0x00,
    15, _NON_AUTOINC, 0xCA, 0x00, 0x01, 0x1B, 0x80, 0x98, 0xC0, 0x00, 0xFA, 0x05, 0x10, 0x00, 0xFF,
...
#if(_QC_5K3K_MODE_ == _ON)
BYTE code tQC_ICM_CRC_TABLE0_5K3K[] = {
    0xF9, 0x4E, 0x66, 0x1B, 0x92, 0x71, // M1
    0x91, 0x28, 0x8F, 0x99, 0xC5, 0xA3, // M2
    0xE1, 0x07, 0x3A, 0x98, 0x88, 0x4D, // S1
    0xEF, 0x5D, 0xDB, 0xE2, 0xE4, 0xFF, // S2
};

BYTE code tQC_ICM_CRC_TABLE1_5K3K[] = {
    0xB5, 0xB0, 0x27, 0xC5, 0xAF, 0xDC, // M1
    0xEF, 0x54, 0x64, 0x9E, 0x4F, 0x70, // M2
    0xB8, 0x22, 0xD8, 0xAB, 0xF2, 0xE5, // S1
    0x0E, 0x82, 0xCF, 0x9B, 0x89, 0xB1, // S2
};

BYTE code tQC_ICM_CRC_TABLE2_5K3K[] = {
    0x64, 0xF5, 0x10, 0xA4, 0x89, 0xA1, // M1
    0x91, 0x83, 0xFF, 0x72, 0xB2, 0xD5, // M2
    0xCE, 0x47, 0x4A, 0x72, 0x05, 0x26, // S1
    0xF2, 0x94, 0xCB, 0xC4, 0xD4, 0x42, // S2
};

BYTE code tQC_ICM_CRC_TABLE3_5K3K[] = {
    0xC0, 0x27, 0xEE, 0xE7, 0x51, 0x4A, // M1
    0x6C, 0x41, 0x59, 0x3A, 0x7C, 0xA9, // M2
    0x15, 0x56, 0xCC, 0x7D, 0x14, 0x9C, // S1
    0xBF, 0x17, 0xEE, 0x6B, 0x8E, 0xB5, // S2
};

BYTE code tQC_ICM_CRC_TABLE4_5K3K[] = {
    0xA5, 0x3A, 0x09, 0xA7, 0x35, 0x23, // M1
    0x4C, 0x13, 0xA5, 0x2D, 0x55, 0x46, // M2
    0xF1, 0x92, 0x4B, 0x02, 0x21, 0x79, // S1
    0xDB, 0xD8, 0x22, 0x08, 0xF5, 0x3D, // S2
};

BYTE code tQC_ICM_CRC_TABLE5_5K3K[] = {
    0x4D, 0x69, 0x6B, 0x45, 0x1E, 0x46, // M1
    0x04, 0x5C, 0x1B, 0x57, 0x58, 0x88, // M2
    0x1F, 0xC2, 0xD7, 0xE1, 0x93, 0x28, // S1
    0x38, 0x2D, 0x17, 0x2E, 0xB4, 0x56, // S2
};

BYTE code tQC_ICM_CRC_TABLE6_5K3K[] = {
    0x4C, 0x05, 0x41, 0x57, 0x8A, 0xB0, // M1
    0x83, 0x0B, 0xED, 0x9E, 0xFB, 0xE0, // M2
    0x11, 0x9F, 0xAD, 0x91, 0x5F, 0x28, // S1
    0xBA, 0x4F, 0x07, 0x36, 0x73, 0xD2, // S2
};

BYTE code tQC_ICM_CRC_TABLE7_5K3K[] = {
    0x7B, 0x9D, 0x85, 0xF0, 0x7F, 0x3A, // M1
    0x3D, 0x55, 0x9C, 0xF8, 0x10, 0x85, // M2
    0x9D, 0x0E, 0x32, 0xFC, 0x88, 0x36, // S1
    0x24, 0x9B, 0xAE, 0xFE, 0x09, 0x74, // S2
};

BYTE code tQC_ICM_CRC_TABLE8_5K3K[] = {
    0x43, 0x00, 0x11, 0xA6, 0xE9, 0xF2, // M1
    0xC4, 0x16, 0xDC, 0x7A, 0x86, 0x04, // M2
    0xC3, 0x14, 0x1D, 0x1C, 0xA7, 0xAB, // S1
    0x7A, 0xC6, 0x16, 0x09, 0x5A, 0xBA, // S2
};

BYTE code tQC_ICM_CRC_TABLE9_5K3K[] = {
    0x5A, 0x57, 0xAA, 0x37, 0x55, 0x88, // M1
    0xF4, 0x78, 0x13, 0xE0, 0xB1, 0xB1, // M2
    0x4E, 0x25, 0xE0, 0xAB, 0x8A, 0x0D, // S1
    0xB2, 0x98, 0x80, 0xD2, 0xEE, 0x34, // S2
};
#endif
...
// Description  : CtsBri Result
//--------------------------------------------------
BYTE code tQC_CON_BRI_DCRC_TABLE_5K3K_0[] =
{
    0x11, 0x60, 0x05, 0xF7, 0x70, 0xF5, // M1
    0x0B, 0xC1, 0x0F, 0x13, 0xDE, 0x37, // M2
    0xEE, 0x4A, 0xDA, 0x97, 0xE4, 0x9E, // S1
    0xDF, 0x9C, 0x8E, 0x3E, 0xCD, 0x6F, // S2
};

BYTE code tQC_CON_BRI_DCRC_TABLE_5K3K_1[] =
{
    0xEF, 0x05, 0xCE, 0xD3, 0x60, 0x2B, // M1
    0x88, 0x55, 0xFB, 0x5E, 0x72, 0x9F, // M2
    0xFD, 0xEC, 0x84, 0x36, 0xB1, 0x2C, // S1
    0x2A, 0x96, 0x2D, 0x21, 0x41, 0x5D, // S2
};

BYTE code tQC_CON_BRI_DCRC_TABLE_5K3K_2[] =
{
    0x2E, 0xAB, 0x0E, 0x60, 0x2C, 0x8D, // M1
    0x55, 0x5C, 0x2D, 0x18, 0x87, 0x79, // M2
    0xAF, 0x9A, 0x97, 0x07, 0x6F, 0x04, // S1
    0x5B, 0x68, 0x40, 0xFC, 0x00, 0xA8, // S2
};

BYTE code tQC_CON_BRI_DCRC_TABLE_5K3K_3[] =
{
    0xF6, 0xD7, 0xD9, 0x9C, 0x10, 0x24, // M1
    0xC5, 0x01, 0x3D, 0x48, 0xCE, 0x5F, // M2
    0xA2, 0x18, 0xE0, 0x7E, 0x8C, 0x50, // S1
    0xDB, 0x60, 0x89, 0xA0, 0xC2, 0x7D, // S2
};

BYTE code tQC_CON_BRI_DCRC_TABLE_5K3K_4[] =
{
...
#if(_QC_5K3K_MODE_ == _ON)
BYTE code tQC_IAPSGAIN_CRCTABLE_0_5K3K[] =
{
    0x66, 0x07, 0x55, 0x81, 0x1A, 0xB4, // M1
    0x75, 0xB9, 0xB3, 0xB1, 0x0B, 0x98, // M2
    0x07, 0xE0, 0xA6, 0x99, 0xD1, 0x41, // S1
    0xEC, 0x39, 0x5D, 0x4A, 0xB4, 0xEC, // S2
};

BYTE code tQC_IAPSGAIN_CRCTABLE_1_5K3K[] =
{
    0xD7, 0x55, 0x23, 0xE1, 0x47, 0x07, // M1
    0x18, 0x60, 0x42, 0xD8, 0x37, 0x67, // M2
    0xA3, 0xCC, 0xB2, 0xD3, 0xF1, 0xC1, // S1
    0x9F, 0x80, 0x56, 0xF4, 0x8F, 0xDC, // S2

};

BYTE code tQC_IAPSGAIN_CRCTABLE_2_5K3K[] =
{
    0x04, 0x16, 0x4B, 0xD7, 0xC5, 0xF2, // M1
    0xD0, 0x0E, 0xB5, 0xBC, 0xBA, 0x28, // M2
    0x91, 0x6B, 0x53, 0xD7, 0x8E, 0x79, // S1
    0xF7, 0xD3, 0xD3, 0x7D, 0xAB, 0x9C, // S2
};

BYTE code tQC_IAPSGAIN_CRCTABLE_3_5K3K[] =
{
    0xF3, 0x81, 0x09, 0x1C, 0xBA, 0x15, // M1
    0x4F, 0xBF, 0xFB, 0x15, 0x99, 0xF4, // M2
    0x66, 0x5D, 0xCA, 0x49, 0x54, 0xE1, // S1
    0x3D, 0x6C, 0xB9, 0xFF, 0xE6, 0x8D, // S2
};

BYTE code tQC_IAPSGAIN_CRCTABLE_4_5K3K[] =
{
    0xF8, 0x26, 0x8C, 0x41, 0xFA, 0x37, // M1
    0xEB, 0x85, 0xEA, 0x26, 0x14, 0xD5, // M2
    0x5F, 0x05, 0x67, 0x0B, 0xED, 0x2D, // S1
    0x07, 0xA5, 0x1E, 0x6C, 0x0A, 0xE9, // S2
};

BYTE code tQC_IAPSGAIN_CRCTABLE_5_5K3K[] =
{
    0xBF, 0x94, 0x17, 0xAF, 0x42, 0x3C, // M1
    0xE1, 0xDD, 0xD8, 0x23, 0x89, 0xDC, // M2
    0x1C, 0xD7, 0x5B, 0x58, 0xB3, 0x4C, // S1
    0x77, 0xA4, 0x74, 0x0F, 0xF6, 0x8F, // S2
};

BYTE code tQC_IAPSGAIN_CRCTABLE_6_5K3K[] =
{
    0xAA, 0x9B, 0x4C, 0xDB, 0xC9, 0x96, // M1
    0xB7, 0x1B, 0x4D, 0x47, 0x85, 0x92, // M2
    0xBF, 0xA0, 0x15, 0x60, 0xD9, 0x4B, // S1
    0x19, 0x8C, 0x77, 0x36, 0x35, 0x3D, // S2
};

BYTE code tQC_IAPSGAIN_CRCTABLE_7_5K3K[] =
{
    0xAB, 0xC9, 0x92, 0x50, 0xFD, 0x9C, // M1
    0x09, 0x26, 0x33, 0x3F, 0x00, 0x43, // M2
    0x53, 0x03, 0x79, 0xDB, 0xAE, 0x14, // S1
    0x56, 0x1F, 0x07, 0xB8, 0x69, 0xC8, // S2
};

BYTE code tQC_IAPSGAIN_CRCTABLE_8_5K3K[] =
{
    0xD8, 0x14, 0xCD, 0xAA, 0x63, 0x60, // M1
    0xC9, 0xAF, 0xD2, 0x2B, 0xD5, 0x76, // M2
    0xE6, 0x4A, 0x9E, 0xEC, 0x27, 0xE4, // S1
    0x1F, 0x16, 0x1D, 0x39, 0x3E, 0x59, // S2
};

BYTE code tQC_IAPSGAIN_CRCTABLE_9_5K3K[] =
{
    0xF5, 0xDF, 0xE1, 0x4E, 0x3C, 0x30, // M1
    0x10, 0xD0, 0x82, 0x6D, 0x75, 0x54, // M2
    0x41, 0xE4, 0x61, 0x49, 0x27, 0xEA, // S1
    0x91, 0x0F, 0x6A, 0x61, 0xAF, 0xA7, // S2

};

BYTE code tQC_IAPSGAIN_CRCTABLE_10_5K3K[] =
{
    0x3C, 0xE7, 0xEE, 0xA0, 0xAC, 0x12, // M1
    0x0F, 0x90, 0x21, 0x71, 0x8F, 0x0F, // M2
    0x52, 0x8C, 0xD3, 0x34, 0x89, 0x31, // S1
    0x69, 0x63, 0xD0, 0xCA, 0x0B, 0x21, // S2
};

BYTE code tQC_IAPSGAIN_CRCTABLE_11_5K3K[] =
{
    0x10, 0xA6, 0xD6, 0x54, 0x41, 0xAF, // M1
    0x84, 0xEC, 0x1E, 0x55, 0xFB, 0xE2, // M2
    0x9D, 0x87, 0x21, 0x6E, 0x08, 0x25, // S1
    0xEA, 0xBE, 0xFD, 0x02, 0xF1, 0xE8, // S2
};
#endif
...
#if(_QC_5K3K_MODE_ == _ON)
bit ScalerQC5K3KDCRTest(void);
bit ScalerQC5K3KDCCTest(void);
bit ScalerQC5K3KICMTest(void);
bit ScalerQC5K3KCTSBRITest(void);
bit ScalerQC5K3KIAPSGainTest(void);
#endif
//****************************************************************************
...
#if(_QC_5K3K_MODE_ == _ON)
//--------------------------------------------------
// Description  : DCR Test 5K3K Case
// Input Value  : None
// Output Value : _TEST_PASS or _TEST_FAIL
//--------------------------------------------------
bit ScalerQC5K3KDCRTest(void)
{
    ...
    DebugMessageQC("5. DCR 5K3K Start", 0x00);
    ScalerQCDDomainRandomGenOn(_MASS, _BIT_MODE_12);
    ...
    for(ucCnt = 0; ucCnt < 50; ucCnt++)
    {
        if(pData[ucCnt] != tQC_D_DOMAIN_DCR_RESULT_TABLE_0_5K3K[ucCnt])
        {
            break;
        }
    }
    ...
    for(ucCnt = 0; ucCnt < 50; ucCnt++)
    {
        if(pData[ucCnt] != tQC_D_DOMAIN_DCR_RESULT_TABLE_1_5K3K[ucCnt])
        {
            break;
        }
    }
    ...
    for(ucCnt = 0; ucCnt < 50; ucCnt++)
    {
        if(pData[ucCnt] != tQC_D_DOMAIN_DCR_RESULT_TABLE_2_5K3K[ucCnt])
        {
            break;
        }
    }
    ...
    for(ucCnt = 0; ucCnt < 50; ucCnt++)
    {
        if(pData[ucCnt] != tQC_D_DOMAIN_DCR_RESULT_TABLE_3_5K3K[ucCnt])
        {
            break;
        }
    }
    ...
    for(ucCnt = 0; ucCnt < 50; ucCnt++)
    {
        if(pData[ucCnt] != tQC_D_DOMAIN_DCR_RESULT_TABLE_4_5K3K[ucCnt])
        {
            break;
        }
    }
    ...
    DebugMessageQC("5. DCR 5K3K End", 0x00);
    if(ucData == 0x00)
    {
        DebugMessageQC("6. DCR 5K3K PASS", 0x00);
        return _TEST_PASS;
    }
    else
    {
        DebugMessageQC("6. Fail Mode", ucData);
        DebugMessageQC("6. DCR 5K3K FAIL", 0x00);
        return _TEST_FAIL;
    }
}

//--------------------------------------------------
// Description  : DCC Test 5K3K Case
// Input Value  : None
// Output Value : _TEST_PASS or _TEST_FAIL
//--------------------------------------------------
bit ScalerQC5K3KDCCTest(void)
{
    ...
    DebugMessageQC("5. DCC 5K3K Start", 0x00);
    ScalerQCDDomainRandomGenOn(_MASS, _BIT_MODE_12);
    ScalerDDomainBackgroundEnable(_DISABLE);
    ...
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    ScalerTimerDelayXms(8);
    ScalerBurstWrite(tQC_DCC_SETTING12_5K3K, sizeof(tQC_DCC_SETTING12_5K3K), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DCC_CRC_TABLE12_5K3K, 1) << 8));

    // DCC Mode0
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    ScalerTimerDelayXms(8);
    ScalerBurstWrite(tQC_DCC_SETTING0_5K3K, sizeof(tQC_DCC_SETTING0_5K3K), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_0", 0x00);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DCC_CRC_TABLE0_5K3K, 1) << 0));

    // DCC Mode1
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    ScalerTimerDelayXms(8);
    ScalerBurstWrite(tQC_DCC_SETTING1_5K3K, sizeof(tQC_DCC_SETTING1_5K3K), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_1", 0x00);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DCC_CRC_TABLE1_5K3K, 1) << 1));

    // DCC Mode2
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    ScalerTimerDelayXms(8);
    ScalerBurstWrite(tQC_DCC_SETTING2_5K3K, sizeof(tQC_DCC_SETTING2_5K3K), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_2", 0x00);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DCC_CRC_TABLE2_5K3K, 1) << 2));

    // DCC Mode3
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    ScalerTimerDelayXms(8);
    ScalerBurstWrite(tQC_DCC_SETTING3_5K3K, sizeof(tQC_DCC_SETTING3_5K3K), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_3", 0x00);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DCC_CRC_TABLE3_5K3K, 1) << 3));

    // DCC Mode4
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    ScalerTimerDelayXms(8);
    ScalerBurstWrite(tQC_DCC_SETTING4_5K3K, sizeof(tQC_DCC_SETTING4_5K3K), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_4", 0x00);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DCC_CRC_TABLE4_5K3K, 1) << 4));
    ...
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_0E_HLW_CONTROL0, ~(_BIT3 | _BIT2), 0x00);
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_12_HLW_SETSEL1, ~(_BIT7 | _BIT6), 0x00);
    ScalerBurstWrite(tQC_DCC_SETTING5_5K3K, sizeof(tQC_DCC_SETTING5_5K3K), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_5", 0x00);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DCC_CRC_TABLE5_5K3K, 1) << 5));
    ...
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_0E_HLW_CONTROL0, ~(_BIT3 | _BIT2), _BIT2);
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_12_HLW_SETSEL1, ~(_BIT7 | _BIT6), 0x00);
    ScalerBurstWrite(tQC_DCC_SETTING6_5K3K, sizeof(tQC_DCC_SETTING6_5K3K), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_6", 0x00);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DCC_CRC_TABLE6_5K3K, 1) << 6));
    ...
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_0E_HLW_CONTROL0, ~(_BIT3 | _BIT2), _BIT3);
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_12_HLW_SETSEL1, ~(_BIT7 | _BIT6), 0x00);
    ScalerBurstWrite(tQC_DCC_SETTING7_5K3K, sizeof(tQC_DCC_SETTING7_5K3K), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_7", 0x00);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DCC_CRC_TABLE7_5K3K, 1) << 7));
    ...
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_0E_HLW_CONTROL0, ~(_BIT3 | _BIT2), 0x00);
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_12_HLW_SETSEL1, ~(_BIT7 | _BIT6), _BIT6);
    ScalerBurstWrite(tQC_DCC_SETTING8_5K3K, sizeof(tQC_DCC_SETTING8_5K3K), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_8", 0x00);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DCC_CRC_TABLE8_5K3K, 1) << 7));
    ...
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_0E_HLW_CONTROL0, ~(_BIT3 | _BIT2), 0x00);
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_12_HLW_SETSEL1, ~(_BIT7 | _BIT6), _BIT6);
    ScalerBurstWrite(tQC_DCC_SETTING9_5K3K, sizeof(tQC_DCC_SETTING9_5K3K), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_9", 0x00);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DCC_CRC_TABLE9_5K3K, 1) << 7));
    ...
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_0E_HLW_CONTROL0, ~(_BIT3 | _BIT2), 0x00);
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_12_HLW_SETSEL1, ~(_BIT7 | _BIT6), _BIT7);
    ScalerBurstWrite(tQC_DCC_SETTING10_5K3K, sizeof(tQC_DCC_SETTING10_5K3K), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_10", 0x00);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DCC_CRC_TABLE10_5K3K, 1) << 7));
    ...
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_0E_HLW_CONTROL0, ~(_BIT3 | _BIT2), 0x00);
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_12_HLW_SETSEL1, ~(_BIT7 | _BIT6), _BIT7);
    ScalerBurstWrite(tQC_DCC_SETTING11_5K3K, sizeof(tQC_DCC_SETTING11_5K3K), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_11", 0x00);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DCC_CRC_TABLE11_5K3K, 1) << 7));
    ...
    // Check Result
    DebugMessageQC("5. DCC 5K3K End", 0x00);

    if(usData == 0x00)
    {
        DebugMessageQC("6. DCC 5K3K PASS", 0x00);
        return _TEST_PASS;
    }
    else
    {
        ScalerSetByte(0x00C1, 0x55);
        DebugMessageQC("6. Fail Mode", usData);
        DebugMessageQC("6. DCC 5K3K FAIL", 0x00);
        return _TEST_FAIL;
    }
}

//--------------------------------------------------
// Description  : ICM Test 5K3K Case
// Input Value  : None
// Output Value : _TEST_PASS or _TEST_FAIL
//--------------------------------------------------
bit ScalerQC5K3KICMTest(void)
{
    ...
    DebugMessageQC("5. ICM 5K3K Start", 0x00);
    ScalerQCDDomainRandomGenOn(_MASS, _BIT_MODE_12);
    ScalerDDomainBackgroundEnable(_DISABLE);
    ...
    ScalerBurstWrite(tQC_ICM_SETTING0, sizeof(tQC_ICM_SETTING0), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_0", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_ICM_CRC_TABLE0_5K3K, 1) << 0));


    // ICM Mode1
    ScalerBurstWrite(tQC_ICM_SETTING1, sizeof(tQC_ICM_SETTING1), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_1", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_ICM_CRC_TABLE1_5K3K, 1) << 1));

    // ICM Mode2
    ScalerBurstWrite(tQC_ICM_SETTING2, sizeof(tQC_ICM_SETTING2), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_2", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_ICM_CRC_TABLE2_5K3K, 1) << 2));

    // ICM Mode3
    ScalerBurstWrite(tQC_ICM_SETTING3, sizeof(tQC_ICM_SETTING3), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_3", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_ICM_CRC_TABLE3_5K3K, 1) << 3));

    // ICM Mode4
    ScalerBurstWrite(tQC_ICM_SETTING4, sizeof(tQC_ICM_SETTING4), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_4", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_ICM_CRC_TABLE4_5K3K, 1) << 4));

    // ICM Mode5
    ScalerBurstWrite(tQC_ICM_SETTING5, sizeof(tQC_ICM_SETTING5), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_5", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_ICM_CRC_TABLE5_5K3K, 1) << 5));

    // ICM Mode6
    ScalerBurstWrite(tQC_ICM_SETTING6, sizeof(tQC_ICM_SETTING6), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_6", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_ICM_CRC_TABLE6_5K3K, 1) << 6));


    // ICM Mode7
    ScalerBurstWrite(tQC_ICM_SETTING7, sizeof(tQC_ICM_SETTING7), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_7", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_ICM_CRC_TABLE7_5K3K, 1) << 7));

    // ICM Mode8
    ScalerBurstWrite(tQC_ICM_SETTING8, sizeof(tQC_ICM_SETTING8), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_8", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_ICM_CRC_TABLE8_5K3K, 1) << 8));


    // ICM Mode9
    ScalerBurstWrite(tQC_ICM_SETTING9, sizeof(tQC_ICM_SETTING9), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    DebugMessageQC("5. Mode_9", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_ICM_CRC_TABLE9_5K3K, 1) << 9));
    ...
    // Check Result
    DebugMessageQC("5. ICM 5K3K End", 0x00);

    if(usData == 0x00)
    {
        DebugMessageQC("6. ICM 5K3K PASS", 0x00);
        return _TEST_PASS;
    }
    else
    {
        DebugMessageQC("6. Fail Mode", usData);
        DebugMessageQC("6. ICM 5K3K FAIL", 0x00);
        return _TEST_FAIL;
    }
...
bit ScalerQC5K3KCTSBRITest(void)
{
    ...
    DebugMessageQC("5. 5K3K Cts Bri Start", 0x00);
    ScalerQCDDomainRandomGenOn(_MASS, _BIT_MODE_12);
    ScalerQCHighlightWindowOff();
    ScalerSetBit(P0_62_SRGB_CTRL, ~(_BIT1 | _BIT0), _BIT1 | _BIT0);
    ...
    ScalerSetByte(P0_64_CTS_BRI_PORT_ADD, 0x00);
    ScalerBurstWrite(tQC_CON_BRI_SETTING_0, sizeof(tQC_CON_BRI_SETTING_0), GET_CURRENT_BANK_NUMBER(), P0_65_CTS_BRI_PORT_DATA, _BURSTWRITE_DATA_COMMON, _BURSTWRITE_FROM_FLASH);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_CON_BRI_DCRC_TABLE_5K3K_0, 1) << 0);
    ...
    ScalerSetByte(P0_64_CTS_BRI_PORT_ADD, 0x00);
    ScalerBurstWrite(tQC_CON_BRI_SETTING_1, sizeof(tQC_CON_BRI_SETTING_1), GET_CURRENT_BANK_NUMBER(), P0_65_CTS_BRI_PORT_DATA, _BURSTWRITE_DATA_COMMON, _BURSTWRITE_FROM_FLASH);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_CON_BRI_DCRC_TABLE_5K3K_1, 1) << 1);
    ...
    ScalerSetByte(P0_64_CTS_BRI_PORT_ADD, 0x00);
    ScalerBurstWrite(tQC_CON_BRI_SETTING_2, sizeof(tQC_CON_BRI_SETTING_2), GET_CURRENT_BANK_NUMBER(), P0_65_CTS_BRI_PORT_DATA, _BURSTWRITE_DATA_COMMON, _BURSTWRITE_FROM_FLASH);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_CON_BRI_DCRC_TABLE_5K3K_2, 1) << 2);
    ...
    ScalerSetByte(P0_64_CTS_BRI_PORT_ADD, 0x00);
    ScalerBurstWrite(tQC_CON_BRI_SETTING_3, sizeof(tQC_CON_BRI_SETTING_3), GET_CURRENT_BANK_NUMBER(), P0_65_CTS_BRI_PORT_DATA, _BURSTWRITE_DATA_COMMON, _BURSTWRITE_FROM_FLASH);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_CON_BRI_DCRC_TABLE_5K3K_3, 1) << 2);
    ...
    ScalerSetByte(P0_64_CTS_BRI_PORT_ADD, 0x00);
    ScalerBurstWrite(tQC_CON_BRI_SETTING_4, sizeof(tQC_CON_BRI_SETTING_4), GET_CURRENT_BANK_NUMBER(), P0_65_CTS_BRI_PORT_DATA, _BURSTWRITE_DATA_COMMON, _BURSTWRITE_FROM_FLASH);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_CON_BRI_DCRC_TABLE_5K3K_4, 1) << 2);
    ...
    ScalerQCDDomainPatternGenOff();
    ScalerQCHighlightWindowOff();
    DebugMessageQC("5. 5K3K Cts Bri End", 0x00);

    if(ucData == 0x00)
    {
        DebugMessageQC("6. 5K3K Cts Bri PASS", 0x00);
        return _TEST_PASS;
    }
    else
    {
        DebugMessageQC("6. Fail Mode", ucData);
        DebugMessageQC("6. 5K3K Cts Bri FAIL", 0x00);
        return _TEST_FAIL;
    }
}

//--------------------------------------------------
// Description  : IAPS Gain Test 5K3K Case
// Input Value  : None
// Output Value : _TEST_PASS or _TEST_FAIL
//--------------------------------------------------
bit ScalerQC5K3KIAPSGainTest(void)
{
    BYTE ucData = 0;
    DebugMessageQC("5. IAPS Gain 5K3K Start", 0x00);
    ScalerQCDDomainRandomGenOn(_MASS, _BIT_MODE_12);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1 , 0x02);
    DebugMessageQC("5. Mode_0", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_IAPSGAIN_CRCTABLE_0_5K3K, 1) << 0);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1 , 0x02);
    DebugMessageQC("5. Mode_1", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_IAPSGAIN_CRCTABLE_1_5K3K, 1) << 1);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_2", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_IAPSGAIN_CRCTABLE_2_5K3K, 1) << 2);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_3", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_IAPSGAIN_CRCTABLE_3_5K3K, 1) << 3);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_4", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_IAPSGAIN_CRCTABLE_4_5K3K, 1) << 4);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_5", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_IAPSGAIN_CRCTABLE_5_5K3K, 1) << 5);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_6", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_IAPSGAIN_CRCTABLE_6_5K3K, 1) << 6);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_7", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_IAPSGAIN_CRCTABLE_7_5K3K, 1) << 7);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_8", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_IAPSGAIN_CRCTABLE_8_5K3K, 1) << 7);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_9", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_IAPSGAIN_CRCTABLE_9_5K3K, 1) << 7);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_10", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_IAPSGAIN_CRCTABLE_10_5K3K, 1) << 7);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_11", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_IAPSGAIN_CRCTABLE_11_5K3K, 1) << 7);
    ...
    ScalerQCDDomainPatternGenOff();
    ScalerQCHighlightWindowOff();
    DebugMessageQC("5. IAPS Gian 5K3K End", 0x00);

    if(ucData == 0x00)
    {
        DebugMessageQC("6. IAPS Gian 5K3K PASS", 0x00);
        return _TEST_PASS;
    }
    else
    {
        DebugMessageQC("6. Fail Mode", ucData);
        DebugMessageQC("6. IAPS Gian 5K3K FAIL", 0x00);
        return _TEST_FAIL;
    }
}
