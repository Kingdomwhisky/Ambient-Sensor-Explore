...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6410_Series_QC_BIST.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6410_SERIES_QC_BIST__
...
// 3D Gamma BIST
    ucBistResult2 = ucBistResult2 | (BYTE)ScalerQC3DGammaBistTest();
// Panel Uniformity
    ucBistResult2 = ucBistResult2 | ((BYTE)ScalerQCPanelUniformityBistTest() << 1);
// Display Conversion
    ucBistResult2 = ucBistResult2 | ((BYTE)ScalerQCDisplayConversionBistTest() << 2);
// OD
    ucBistResult2 = ucBistResult2 | ((BYTE)ScalerQCODBistTest() << 3);
// OSD
    ucBistResult2 = ucBistResult2 | ((BYTE)ScalerQCOSDBistTest() << 4);

    if((ucBistResult == 0) && (ucBistResult2 == 0))
    {
...
//-----------FormatConv DRF BIST---------------//
    ...
    ScalerSetBit(P31_6D_FRONT_BACK_BIST_CTRL, ~(_BIT7 | _BIT3), _BIT7 | _BIT3);

    if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P31_6D_FRONT_BACK_BIST_CTRL, _BIT6, _TRUE) == _TRUE)
    {
        if(ScalerGetBit(P31_6D_FRONT_BACK_BIST_CTRL, _BIT5) != 0x00)
        {
            DebugMessageQC("5. FormatConv FB bist_result_1 Fail", 0x00);
            ucFBBistResult |= _BIT7;
        }

        if(ScalerGetBit(P31_6D_FRONT_BACK_BIST_CTRL, _BIT4) != 0x00)
        {
            DebugMessageQC("5. FormatConv FB bist_result_0 Fail", 0x00);
            ucFBBistResult |= _BIT6;
        }
    }
    else
    {
        DebugMessageQC("5. FormatConv FB Bist Time Out Fail", 0x00);
        ucFBBistResult |= _BIT0;
    }

    ScalerSetBit(P31_6D_FRONT_BACK_BIST_CTRL, ~_BIT7, 0x00);

    if(ucFBBistResult == 0x00)
    {
        DebugMessageQC("6. FormatConv FB Bist PASS", 0x00);
    }
    else
    {
        DebugMessageQC("6. FormatConv FB Bist FAIL", ucFBBistResult);
        return _TEST_FAIL;
    }

//-----------FormatConv DRF BIST---------------//

    DebugMessageQC("5. ====FormatConv FB DRF Bist Test Start", 0x00);
    ScalerSetBit(P31_6D_FRONT_BACK_BIST_CTRL, ~_BIT2, _BIT2);
    ScalerSetBit(P31_6D_FRONT_BACK_BIST_CTRL, ~_BIT2, 0x00);
    //1.Start DRF BIST mode
    ScalerSetBit(P31_6E_FRONT_BACK_DRF_BIST_CTRL, ~(_BIT7 | _BIT6), _BIT7);

    for(ucCnt = 0; ucCnt < 2; ucCnt++)
    {
        if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P31_6E_FRONT_BACK_DRF_BIST_CTRL, _BIT5, _TRUE) == _TRUE)
        {
             //3.Wait 1ms
            ScalerTimerDelayXms(2);
            ScalerSetBit(P31_6E_FRONT_BACK_DRF_BIST_CTRL, ~_BIT6, _BIT6);
            ScalerSetBit(P31_6E_FRONT_BACK_DRF_BIST_CTRL, ~_BIT6, 0x00);
        }
        else
        {
            DebugMessageQC("5. FormatConv FB DRF Bist Time Out Fail", 0x00);
            ucFBBistResult |= _BIT3;
        }
    }

    if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P31_6E_FRONT_BACK_DRF_BIST_CTRL, _BIT4, _TRUE) == _TRUE)
    {
        if(ScalerGetBit(P31_6E_FRONT_BACK_DRF_BIST_CTRL, _BIT3) != 0x00)
        {
            DebugMessageQC("5. FormatConv FB DRF bist_result_1 Fail", 0x00);
            ucFBBistResult |= (_BIT7 | _BIT1);
        }

        if(ScalerGetBit(P31_6E_FRONT_BACK_DRF_BIST_CTRL, _BIT2) != 0x00)
        {
            DebugMessageQC("5. FormatConv FB DRF bist_result_0 Fail", 0x00);
            ucFBBistResult |= (_BIT6 | _BIT1);
        }
    }
    else
    {
        DebugMessageQC("5. FormatConv DRF FB Bist Time Out Fail", 0x00);
        ucFBBistResult |= _BIT2;
    }

    // Disable  bist test
    ScalerSetBit(P31_6E_FRONT_BACK_DRF_BIST_CTRL, ~(_BIT7 | _BIT6), 0x00);
    ScalerSetBit(P31_6D_FRONT_BACK_BIST_CTRL, ~_BIT3, 0x00);

    if(ucFBBistResult == 0x00)
    {
        DebugMessageQC("6. FormatConv FB DRF Bist PASS", 0x00);
    }
    else
    {
        DebugMessageQC("6. FormatConv FB DRF Bist FAIL", ucBistResult);
    }

    if((ucBistResult != 0x00) || (ucFBBistResult != 0x00))
    {
        return _TEST_FAIL;
    }
...
bit ScalerQCDTGBistTest(void)
{
    ...
    //Test DisplayTimingGen Sub1 Bist Mode
    DebugMessageQC("5. ====DisplayTimingGen Sub1 Bist Test Start", 0x00);
    ScalerSetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_4B_BIST_CLK_RST_EN, ~(_BIT5 | _BIT1), _BIT5);
    ...
    if(ScalerQCTimerPollingPortFlagProc(_BIST_TIMEOUT, P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_44_SUB_BIST_CTRL, _BIT2, _TRUE) == _TRUE)
    {
        ...
        {
            DebugMessageQC("5. DisplayTimingGen Sub1 BIST Fail for SRAM No.3", 0x00);
            ucBistResult |= _BIT7;
        };

        if(ScalerGetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_45_SUB_BIST_RESULT, _BIT6) != 0x00)
        {
            DebugMessageQC("5. DisplayTimingGen Sub1 BIST Fail for SRAM No.2", 0x00);
            ucBistResult |= _BIT6;
        };

        if(ScalerGetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_45_SUB_BIST_RESULT, _BIT5) != 0x00)
        {
            DebugMessageQC("5. DisplayTimingGen Sub1 BIST Fail for SRAM No.1", 0x00);
            ucBistResult |= _BIT5;
        };

        if(ScalerGetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_45_SUB_BIST_RESULT, _BIT4) != 0x00)
        {
            DebugMessageQC("5. DisplayTimingGen Sub1 BIST Fail for SRAM No.0", 0x00);
            ucBistResult |= _BIT4;
        };
    }
    else
    {
        DebugMessageQC("5. DisplayTimingGen Sub1 Bist Time Out Fail", 0x00);
        ucBistResult |= _BIT3;
    }
    ...
    if(ucBistResult == 0x00)
    {
        DebugMessageQC("6. DisplayTimingGen Sub1 Bist PASS", 0x00);
    }
    else
    {
        DebugMessageQC("6. DisplayTimingGen Sub1 Bist Fail Mode", ucBistResult);
        DebugMessageQC("6. DisplayTimingGen Sub1 Bist FAIL", 0x00);
        return _TEST_FAIL;
    }

    ScalerSetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_4B_BIST_CLK_RST_EN, ~(_BIT5 | _BIT1), _BIT5 | _BIT1);
    ScalerSetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_4B_BIST_CLK_RST_EN, ~(_BIT5 | _BIT1), _BIT5);

    DebugMessageQC("5. ====DisplayTimingGen Sub1 DRF Bist Test Start", 0x00);
    //1.Start DRF BIST mode
    ...
    for(ucCnt = 0; ucCnt < 2; ucCnt++)
    {
        if(ScalerQCTimerPollingPortFlagProc(_BIST_TIMEOUT, P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_44_SUB_BIST_CTRL, _BIT0, _TRUE) == _TRUE)
        {
            //3.Wait 1ms
        ...
        {
            DebugMessageQC("5. DisplayTimingGen Sub1 DRF Bist Start Pause Time Out Fail", 0x00);
            ucBistResult |= _BIT7;
        }
    }
    //8.Wait DRF Bist Done
    if(ScalerQCTimerPollingPortFlagProc(_BIST_TIMEOUT, P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_44_SUB_BIST_CTRL, _BIT1, _TRUE) == _TRUE)
    {
        ...
        {
            DebugMessageQC("5. DisplayTimingGen Sub1 DRF BIST Fail for SRAM No.3", 0x00);
            ucBistResult |= _BIT6;
        }

        if(ScalerGetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_45_SUB_BIST_RESULT, _BIT2) != 0x00)
        {
            DebugMessageQC("5. DisplayTimingGen Sub1 DRF BIST Fail for SRAM No.2", 0x00);
            ucBistResult |= _BIT5;
        }

        if(ScalerGetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_45_SUB_BIST_RESULT, _BIT1) != 0x00)
        {
            DebugMessageQC("5. DisplayTimingGen Sub1 DRF BIST Fail for SRAM No.1", 0x00);
            ucBistResult |= _BIT4;
        }

        if(ScalerGetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_45_SUB_BIST_RESULT, _BIT0) != 0x00)
        {
            DebugMessageQC("5. DisplayTimingGen Sub1 DRF BIST Fail for SRAM No.0", 0x00);
            ucBistResult |= _BIT3;
        }
    }
    else
    {
        DebugMessageQC("5. DisplayTimingGen Sub1 DRF Bist Time Out Fail", 0x00);
        ucBistResult |= _BIT2;
    }

    // Disable DisplayTimingGen Sub DRF bist test
    ScalerSetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_44_SUB_BIST_CTRL, ~(_BIT5 | _BIT4), 0x00);

    if(ucBistResult == 0x00)
    {
        DebugMessageQC("6. DisplayTimingGen Sub1 DRF Bist PASS", 0x00);
    }
    else
    {
        DebugMessageQC("6. DisplayTimingGen Sub1 DRF Bist Fail Mode", ucBistResult);
        DebugMessageQC("6. DisplayTimingGen Sub1 DRF Bist FAIL", 0x00);
        return _TEST_FAIL;
    }
    ucBistResult = 0x00;
    ...
    // Disable DisplayTimingGen Sub DRF bist test
    ScalerSetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_46_FIFO_BIST_CTRL, ~(_BIT5 | _BIT4), 0x00);
    ...
    //Test DisplayTimingGen Sub2 Bist Mode
    DebugMessageQC("5. ====DisplayTimingGen Sub2 Bist Test Start", 0x00);
    ScalerSetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_4B_BIST_CLK_RST_EN, ~(_BIT4 | _BIT0), _BIT4);

    ScalerSetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_49_SUB2_BIST_CTRL, ~_BIT6, _BIT6);
    if(ScalerQCTimerPollingPortFlagProc(_BIST_TIMEOUT, P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_49_SUB2_BIST_CTRL, _BIT2, _TRUE) == _TRUE)
    {
        if(ScalerGetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_4A_SUB2_BIST_RESULT, _BIT5) != 0x00)
        {
            DebugMessageQC("5. DisplayTimingGen Sub2 BIST Fail for SRAM No.1", 0x00);
            ucBistResult |= _BIT7;
        };

        if(ScalerGetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_4A_SUB2_BIST_RESULT, _BIT4) != 0x00)
        {
            DebugMessageQC("5. DisplayTimingGen Sub2 BIST Fail for SRAM No.0", 0x00);
            ucBistResult |= _BIT6;
        };
    }
    else
    {
        DebugMessageQC("5. DisplayTimingGen Sub2 Bist Time Out Fail", 0x00);
        ucBistResult |= _BIT5;
    }
    //disable DisplayTimingGen Sub2 bist test
    ScalerSetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_49_SUB2_BIST_CTRL, ~_BIT6, 0x00);

    if(ucBistResult == 0x00)
    {
        DebugMessageQC("6. DisplayTimingGen Sub2 Bist PASS", 0x00);
    }
    else
    {
        DebugMessageQC("6. DisplayTimingGen Sub2 Bist Fail Mode", ucBistResult);
        DebugMessageQC("6. DisplayTimingGen Sub2 Bist FAIL", 0x00);
        return _TEST_FAIL;
    }

    ScalerSetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_4B_BIST_CLK_RST_EN, ~(_BIT4 | _BIT0), _BIT4 | _BIT0);
    ScalerSetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_4B_BIST_CLK_RST_EN, ~(_BIT4 | _BIT0), _BIT4);

    DebugMessageQC("5. ====DisplayTimingGen Sub2 DRF Bist Test Start", 0x00);
    //1.Start DRF BIST mode
    ScalerSetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_49_SUB2_BIST_CTRL, ~_BIT5, _BIT5);

    //2.Wait DRF Start Pause
    for(ucCnt = 0; ucCnt < 2; ucCnt++)
    {
        if(ScalerQCTimerPollingPortFlagProc(_BIST_TIMEOUT, P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_49_SUB2_BIST_CTRL, _BIT0, _TRUE) == _TRUE)
        {
            //3.Wait 1ms
            ScalerSetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_49_SUB2_BIST_CTRL, ~_BIT4, _BIT4);
            ScalerSetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_49_SUB2_BIST_CTRL, ~_BIT4, 0x00);
        }
        else
        {
            DebugMessageQC("5. DisplayTimingGen Sub2 DRF Bist Start Pause Time Out Fail", 0x00);
            ucBistResult |= _BIT7;
        }
    }
    //8.Wait DRF Bist Done
    if(ScalerQCTimerPollingPortFlagProc(_BIST_TIMEOUT, P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_49_SUB2_BIST_CTRL, _BIT1, _TRUE) == _TRUE)
    {
        if(ScalerGetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_4A_SUB2_BIST_RESULT, _BIT3) != 0x00)
        {
            DebugMessageQC("5. DisplayTimingGen Sub2 DRF BIST Fail for SRAM No.3", 0x00);
            ucBistResult |= _BIT6;
        }

        if(ScalerGetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_4A_SUB2_BIST_RESULT, _BIT2) != 0x00)
        {
            DebugMessageQC("5. DisplayTimingGen Sub2 DRF BIST Fail for SRAM No.2", 0x00);
            ucBistResult |= _BIT5;
        }

        if(ScalerGetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_4A_SUB2_BIST_RESULT, _BIT1) != 0x00)
        {
            DebugMessageQC("5. DisplayTimingGen Sub2 DRF BIST Fail for SRAM No.1", 0x00);
            ucBistResult |= _BIT4;
        }

        if(ScalerGetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_4A_SUB2_BIST_RESULT, _BIT0) != 0x00)
        {
            DebugMessageQC("5. DisplayTimingGen Sub2 DRF BIST Fail for SRAM No.0", 0x00);
            ucBistResult |= _BIT3;
        }
    }
    else
    {
        DebugMessageQC("5. DisplayTimingGen Sub2 DRF Bist Time Out Fail", 0x00);
        ucBistResult |= _BIT2;
    }

    // Disable DisplayTimingGen Sub DRF bist test
    ScalerSetDataPortBit(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_49_SUB2_BIST_CTRL, ~(_BIT5 | _BIT4), 0x00);

    if(ucBistResult == 0x00)
    {
        DebugMessageQC("6. DisplayTimingGen Sub2 DRF Bist PASS", 0x00);
    }
    else
    {
        DebugMessageQC("6. DisplayTimingGen Sub2 DRF Bist Fail Mode", ucBistResult);
        DebugMessageQC("6. DisplayTimingGen Sub2 DRF Bist FAIL", 0x00);
        return _TEST_FAIL;
    }
...
bit ScalerQCRGBGammaBistTest(void)
{
    ...
    // Disable BIST Clock and Disable DRF BIST Mode
   // ScalerSetBit(P9_10_RGB_GAMMA_CLK_M1, ~_BIT1, 0x00);
    ScalerSetByte(P9_10_RGB_GAMMA_CLK_M1, 0x00);
    ...
    //ScalerSetBit(P89_10_RGB_GAMMA_CLK_S1, ~_BIT0, 0x00);
    ScalerSetByte(P89_10_RGB_GAMMA_CLK_S1, 0x00);
...
bit ScalerQCDisplayConversionBistTest(void)
{
    ...
    // Test eDPTX1 Table SRAM
    DebugMessageQC("5. ====eDPTX1 Bist Test Start", 0x00);

    // Enable eDPTX1 Bist Clk
    ...
    if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P9C_E1_PG_MBIST_CTRL, _BIT6, _BIT6) == _TRUE)
    {
        ...
        {
            DebugMessageQC("5. eDPTX1 Bist Fail", 0x00);
            ucBistResult |= _BIT0;
        }
        else
        {
            DebugMessageQC("5. eDPTX1 Bist Pass", 0x00);
        }
    }
    else
    {
        DebugMessageQC("5. eDPTX1 Bist Time Out Fail", 0x00);
        ucBistResult |= _BIT1;
    }
    // Disable eDPTX1 Bist
    ScalerSetBit(P9C_E1_PG_MBIST_CTRL, ~_BIT7, 0x00);

    // eDPTX1 Bist Software Reset
    ScalerSetBit(P9C_E2_PG_DRF_MBIST_CTRL, ~_BIT0, _BIT0);
    ScalerSetBit(P9C_E2_PG_DRF_MBIST_CTRL, ~_BIT0, 0x00);

    DebugMessageQC("5. ====eDPTX1 DRF Bist Test Start", 0x00);

    // Enable eDPTX1 Drf Bist
    ScalerSetBit(P9C_E2_PG_DRF_MBIST_CTRL, ~(_BIT7 | _BIT1), (_BIT7 | _BIT1));

    // Wait eDPTX1 DRF Start Pause
    for(ucCnt = 0; ucCnt < 2; ucCnt++)
    {
        if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P9C_E2_PG_DRF_MBIST_CTRL, _BIT5, _BIT5) == _TRUE)
        {
            // Toggle drf_test_resume
            ScalerSetBit(P9C_E2_PG_DRF_MBIST_CTRL, ~(_BIT6 | _BIT1), _BIT1);
            ScalerSetBit(P9C_E2_PG_DRF_MBIST_CTRL, ~(_BIT6 | _BIT1), (_BIT6 | _BIT1));
            ScalerSetBit(P9C_E2_PG_DRF_MBIST_CTRL, ~(_BIT6 | _BIT1), _BIT1);
        }
        else
        {
            DebugMessageQC("5. eDPTX1 Drf Bist Time Out Fail: 0", 0x00);
            ucBistResult |= _BIT2;
        }
    }
    ...
    if((ucBistResult & _BIT2) != _BIT2)
    {
        if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P9C_E2_PG_DRF_MBIST_CTRL, _BIT4, _BIT4) == _TRUE)
        {
            ...
            {
                DebugMessageQC("5. eDPTX1 Drf Bist Fail", 0x00);
                ucBistResult |= _BIT3;
            }
            else
            {
                DebugMessageQC("5. eDPTX1 Drf Bist Pass", 0x00);
            }
        }
        else
        {
            DebugMessageQC("5. eDPTX1 Drf Bist Time Out Fail: 2", 0x00);
            ucBistResult |= _BIT4;
        }
    }
    // Disable eDPTX1 Drf Bist
    ScalerSetBit(P9C_E2_PG_DRF_MBIST_CTRL, ~_BIT7, 0x00);

    // Disalbe eDPTX1 Bist Clk
    ScalerSetBit(P9C_E2_PG_DRF_MBIST_CTRL, ~_BIT1, 0x00);


    // Test eDPTX2 Table SRAM
    DebugMessageQC("5. ====eDPTX2 Bist Test Start", 0x00);

    // Enable eDPTX2 Bist Clk
    ScalerSetBit(P9E_E2_PG_DRF_MBIST_CTRL, ~_BIT1, _BIT1);

    // Enable eDPTX2 Bist
    ScalerSetBit(P9E_E1_PG_MBIST_CTRL, ~_BIT7, _BIT7);
    if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P9E_E1_PG_MBIST_CTRL, _BIT6, _BIT6) == _TRUE)
    {
        // BIST Fail
        if(ScalerGetBit(P9E_E1_PG_MBIST_CTRL, _BIT5) != 0x00)
        {
            DebugMessageQC("5. eDPTX2 Bist Fail", 0x00);
            ucBistResult |= _BIT0;
        }
        else
        {
            DebugMessageQC("5. eDPTX2 Bist Pass", 0x00);
        }
    }
    else
    {
        DebugMessageQC("5. eDPTX2 Bist Time Out Fail", 0x00);
        ucBistResult |= _BIT1;
    }
    // Disable eDPTX1 Bist
    ScalerSetBit(P9E_E1_PG_MBIST_CTRL, ~_BIT7, 0x00);

    // eDPTX1 Bist Software Reset
    ScalerSetBit(P9E_E2_PG_DRF_MBIST_CTRL, ~_BIT0, _BIT0);
    ScalerSetBit(P9E_E2_PG_DRF_MBIST_CTRL, ~_BIT0, 0x00);

    DebugMessageQC("5. ====eDPTX2 DRF Bist Test Start", 0x00);

    // Enable eDPTX1 Drf Bist
    ScalerSetBit(P9E_E2_PG_DRF_MBIST_CTRL, ~(_BIT7 | _BIT1), (_BIT7 | _BIT1));

    // Wait eDPTX1 DRF Start Pause
    for(ucCnt = 0; ucCnt < 2; ucCnt++)
    {
        if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P9E_E2_PG_DRF_MBIST_CTRL, _BIT5, _BIT5) == _TRUE)
        {
            // Toggle drf_test_resume
            ScalerSetBit(P9E_E2_PG_DRF_MBIST_CTRL, ~(_BIT6 | _BIT1), _BIT1);
            ScalerSetBit(P9E_E2_PG_DRF_MBIST_CTRL, ~(_BIT6 | _BIT1), (_BIT6 | _BIT1));
            ScalerSetBit(P9E_E2_PG_DRF_MBIST_CTRL, ~(_BIT6 | _BIT1), _BIT1);
        }
        else
        {
            DebugMessageQC("5. eDPTX2 Drf Bist Time Out Fail: 0", 0x00);
            ucBistResult |= _BIT5;
        }
    }

    if((ucBistResult & _BIT5) != _BIT5)
    {
        if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P9E_E2_PG_DRF_MBIST_CTRL, _BIT4, _BIT4) == _TRUE)
        {
            // BIST Fail
            if(ScalerGetBit(P9E_E2_PG_DRF_MBIST_CTRL, _BIT3) != 0x00)
            {
                DebugMessageQC("5. eDPTX2 Drf Bist Fail", 0x00);
                ucBistResult |= _BIT3;
            }
            else
            {
                DebugMessageQC("5. eDPTX2 Drf Bist Pass", 0x00);
            }
        }
        else
        {
            DebugMessageQC("5. eDPTX2 Drf Bist Time Out Fail: 2", 0x00);
            ucBistResult |= _BIT4;
        }
    }
    // Disable eDPTX2 Drf Bist
    ScalerSetBit(P9E_E2_PG_DRF_MBIST_CTRL, ~_BIT7, 0x00);

    // Disalbe eDPTX2 Bist Clk
    ScalerSetBit(P9E_E2_PG_DRF_MBIST_CTRL, ~_BIT1, 0x00);
...
bit ScalerQCODBistTest(void)
{
    ...
    // OD BIST preprocess
    //==============================================
    // Enable OD Front/Back separation
    ScalerSetBit(P31_F1_FRONT_BACK_REG_SEP_CTRL_LS, ~_BIT7, _BIT7);

    // Enable OD BIST clock and disable BIST reset on each path
    ScalerSetBit(P3_DA_LS_DDR_START_ADDR_MSB, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT6 | _BIT5 | _BIT4));
    ScalerSetBit(P43_DA_LS_DDR_START_ADDR_MSB, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT6 | _BIT5 | _BIT4));
    ScalerSetBit(P83_DA_LS_DDR_START_ADDR_MSB, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT6 | _BIT5 | _BIT4));
    ScalerSetBit(PC3_DA_LS_DDR_START_ADDR_MSB, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT6 | _BIT5 | _BIT4));
    ...
    //=======================
    // OD S1 Cap
    ScalerSetBit(P83_DE_CAP_BIST_CTRL, ~_BIT1, _BIT1);
    if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P83_DE_CAP_BIST_CTRL, _BIT7, _TRUE) == _TRUE)
    {
        // S1 Cap BIST Fail
        if(ScalerGetBit(P83_DE_CAP_BIST_CTRL, _BIT5) != 0x00)
        {
            DebugMessageQC("5. OD S1 Cap Bist Fail", 0x00);
            ucBistResult |= _BIT4;
        }
    }
    else
    {
        DebugMessageQC("5. OD S1 Cap Bist Time Out Fail", 0x00);
        ucBistResult |= _BIT4;
    }
    ScalerSetBit(P83_DE_CAP_BIST_CTRL, ~_BIT1, 0x00);

    //----------------------------------------------
    // OD S1 Disp
    ScalerSetBit(P83_DF_DIS_BIST_CTRL, ~_BIT1, _BIT1);
    if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P83_DF_DIS_BIST_CTRL, _BIT7, _TRUE) == _TRUE)
    {
        // S1 Disp BIST Fail
        if(ScalerGetBit(P83_DF_DIS_BIST_CTRL, _BIT5) != 0x00)
        {
            DebugMessageQC("5. OD S1 Dis Bist Fail", 0x00);
            ucBistResult |= _BIT5;
        }
    }
    else
    {
        DebugMessageQC("5. OD S1 Dis Bist Time Out Fail", 0x00);
        ucBistResult |= _BIT5;
    }
    ScalerSetBit(P83_DF_DIS_BIST_CTRL, ~_BIT1, 0x00);

    //=======================
    // OD S2
    //=======================
    // OD S2 Cap
    ScalerSetBit(PC3_DE_CAP_BIST_CTRL, ~_BIT1, _BIT1);
    if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, PC3_DE_CAP_BIST_CTRL, _BIT7, _TRUE) == _TRUE)
    {
        // S2 Cap BIST Fail
        if(ScalerGetBit(PC3_DE_CAP_BIST_CTRL, _BIT5) != 0x00)
        {
            DebugMessageQC("5. OD S2 Cap Bist Fail", 0x00);
            ucBistResult |= _BIT6;
        }
    }
    else
    {
        DebugMessageQC("5. OD S2 Cap Bist Time Out Fail", 0x00);
        ucBistResult |= _BIT6;
    }
    ScalerSetBit(PC3_DE_CAP_BIST_CTRL, ~_BIT1, 0x00);

    //----------------------------------------------
    // OD S2 Disp
    ScalerSetBit(PC3_DF_DIS_BIST_CTRL, ~_BIT1, _BIT1);
    if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, PC3_DF_DIS_BIST_CTRL, _BIT7, _TRUE) == _TRUE)
    {
        // S2 Disp BIST Fail
        if(ScalerGetBit(PC3_DF_DIS_BIST_CTRL, _BIT5) != 0x00)
        {
            DebugMessageQC("5. OD S2 Dis Bist Fail", 0x00);
            ucBistResult |= _BIT7;
        }
    }
    else
    ...
    ScalerSetBit(PC3_DF_DIS_BIST_CTRL, ~_BIT1, 0x00);

    //==============================================
    // Clear Ordinary BIST result
    //==============================================
    // M1
    ScalerSetBit(P3_DA_LS_DDR_START_ADDR_MSB, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT5 | _BIT4));
    ScalerSetBit(P3_DA_LS_DDR_START_ADDR_MSB, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT6 | _BIT5 | _BIT4));

    // M2
    ScalerSetBit(P43_DA_LS_DDR_START_ADDR_MSB, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT5 | _BIT4));
    ScalerSetBit(P43_DA_LS_DDR_START_ADDR_MSB, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT6 | _BIT5 | _BIT4));

    // S1
    ScalerSetBit(P83_DA_LS_DDR_START_ADDR_MSB, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT5 | _BIT4));
    ScalerSetBit(P83_DA_LS_DDR_START_ADDR_MSB, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT6 | _BIT5 | _BIT4));

    // S2
    ScalerSetBit(PC3_DA_LS_DDR_START_ADDR_MSB, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT5 | _BIT4));
    ScalerSetBit(PC3_DA_LS_DDR_START_ADDR_MSB, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT6 | _BIT5 | _BIT4));
    ...
    //=======================
    // OD M1 Cap
    ScalerSetBit(P3_DE_CAP_BIST_CTRL, ~_BIT0, _BIT0);
    for(ucCnt = 0; ucCnt < 2; ucCnt++)
    {
        if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P3_DE_CAP_BIST_CTRL, _BIT3, _TRUE) == _TRUE)
        {
            // Resume DRF BIST
            ScalerSetBit(P3_DE_CAP_BIST_CTRL, ~_BIT2, _BIT2);
            ScalerSetBit(P3_DE_CAP_BIST_CTRL, ~_BIT2, 0x00);
        }
        else
        {
            DebugMessageQC("5. OD M1 Cap Drf Bist Pause Resume Time Out Fail", 0x00);
            ucBistResult |= _BIT0;
        }
    }

    if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P3_DE_CAP_BIST_CTRL, _BIT6, _TRUE) == _TRUE)
    {
        // M1 Cap DRF BIST Fail
        if(ScalerGetBit(P3_DE_CAP_BIST_CTRL, _BIT4) != 0x00)
        {
            DebugMessageQC("5. OD M1 Cap Drf Bist Fail", 0x00);
            ucBistResult |= _BIT0;
        }
    }
    else
    {
        DebugMessageQC("5. OD M1 Cap Drf Bist Time Out Fail", 0x00);
        ucBistResult |= _BIT0;
    }

    ScalerSetBit(P3_DE_CAP_BIST_CTRL, ~(_BIT2 | _BIT0), 0x00);

    //----------------------------------------------
    // OD M1 Disp
    ScalerSetBit(P3_DF_DIS_BIST_CTRL, ~_BIT0, _BIT0);
    for(ucCnt = 0; ucCnt < 2; ucCnt++)
    {
        if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P3_DF_DIS_BIST_CTRL, _BIT3, _TRUE) == _TRUE)
        {
            // Resume DRF BIST
            ScalerSetBit(P3_DF_DIS_BIST_CTRL, ~_BIT2, _BIT2);
            ScalerSetBit(P3_DF_DIS_BIST_CTRL, ~_BIT2, 0x00);
        }
        else
        {
            DebugMessageQC("5. OD M1 Disp Drf Bist Pause Resume Time Out Fail", 0x00);
            ucBistResult |= _BIT1;
        }
    }

    if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P3_DF_DIS_BIST_CTRL, _BIT6, _TRUE) == _TRUE)
    {
        // M1 Disp DRF BIST Fail
        if(ScalerGetBit(P3_DF_DIS_BIST_CTRL, _BIT4) != 0x00)
        {
            DebugMessageQC("5. OD M1 Disp Drf Bist Fail", 0x00);
            ucBistResult |= _BIT1;
        }
    }
    else
    {
        DebugMessageQC("5. OD M1 Disp Drf Bist Time Out Fail", 0x00);
        ucBistResult |= _BIT1;
    }

    ScalerSetBit(P3_DF_DIS_BIST_CTRL, ~(_BIT2 | _BIT0), 0x00);

    //=======================
    // OD M2
    //=======================
    // OD M2 Cap
    ScalerSetBit(P43_DE_CAP_BIST_CTRL, ~_BIT0, _BIT0);
    for(ucCnt = 0; ucCnt < 2; ucCnt++)
    {
        if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P43_DE_CAP_BIST_CTRL, _BIT3, _TRUE) == _TRUE)
        {
            // Resume DRF BIST
            ScalerSetBit(P43_DE_CAP_BIST_CTRL, ~_BIT2, _BIT2);
            ScalerSetBit(P43_DE_CAP_BIST_CTRL, ~_BIT2, 0x00);
        }
        else
        {
            DebugMessageQC("5. OD M2 Cap Drf Bist Pause Resume Time Out Fail", 0x00);
            ucBistResult |= _BIT2;
        }
    }

    if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P43_DE_CAP_BIST_CTRL, _BIT6, _TRUE) == _TRUE)
    {
        // M2 Cap DRF BIST Fail
        if(ScalerGetBit(P43_DE_CAP_BIST_CTRL, _BIT4) != 0x00)
        {
            DebugMessageQC("5. OD M2 Cap Drf Bist Fail", 0x00);
            ucBistResult |= _BIT2;
        }
    }
    else
    {
        DebugMessageQC("5. OD M2 Cap Drf Bist Time Out Fail", 0x00);
        ucBistResult |= _BIT2;
    }

    ScalerSetBit(P43_DE_CAP_BIST_CTRL, ~(_BIT2 | _BIT0), 0x00);

    //----------------------------------------------
    // OD M2 Disp
    ScalerSetBit(P43_DF_DIS_BIST_CTRL, ~_BIT0, _BIT0);
    for(ucCnt = 0; ucCnt < 2; ucCnt++)
    {
        if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P43_DF_DIS_BIST_CTRL, _BIT3, _TRUE) == _TRUE)
        {
            // Resume DRF BIST
            ScalerSetBit(P43_DF_DIS_BIST_CTRL, ~_BIT2, _BIT2);
            ScalerSetBit(P43_DF_DIS_BIST_CTRL, ~_BIT2, 0x00);
        }
        else
        {
            DebugMessageQC("5. OD M2 Disp Drf Bist Pause Resume Time Out Fail", 0x00);
            ucBistResult |= _BIT3;
        }
    }

    if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P43_DF_DIS_BIST_CTRL, _BIT6, _TRUE) == _TRUE)
    {
        // M2 Disp DRF BIST Fail
        if(ScalerGetBit(P43_DF_DIS_BIST_CTRL, _BIT4) != 0x00)
        {
            DebugMessageQC("5. OD M2 Disp Drf Bist Fail", 0x00);
            ucBistResult |= _BIT3;
        }
    }
    else
    {
        DebugMessageQC("5. OD M2 Disp Drf Bist Time Out Fail", 0x00);
        ucBistResult |= _BIT3;
    }

    ScalerSetBit(P43_DF_DIS_BIST_CTRL, ~(_BIT2 | _BIT0), 0x00);

    //=======================
    // OD S1
    //=======================
    // OD S1 Cap
    ScalerSetBit(P83_DE_CAP_BIST_CTRL, ~_BIT0, _BIT0);
    for(ucCnt = 0; ucCnt < 2; ucCnt++)
    {
        if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P83_DE_CAP_BIST_CTRL, _BIT3, _TRUE) == _TRUE)
        {
            // Resume DRF BIST
            ScalerSetBit(P83_DE_CAP_BIST_CTRL, ~_BIT2, _BIT2);
            ScalerSetBit(P83_DE_CAP_BIST_CTRL, ~_BIT2, 0x00);
        }
        else
        {
            DebugMessageQC("5. OD S1 Cap Drf Bist Pause Resume Time Out Fail", 0x00);
            ucBistResult |= _BIT4;
        }
    }

    if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P83_DE_CAP_BIST_CTRL, _BIT6, _TRUE) == _TRUE)
    {
        // S1 Cap DRF BIST Fail
        if(ScalerGetBit(P83_DE_CAP_BIST_CTRL, _BIT4) != 0x00)
        {
            DebugMessageQC("5. OD S1 Cap Drf Bist Fail", 0x00);
            ucBistResult |= _BIT4;
        }
    }
    else
    {
        DebugMessageQC("5. OD S1 Cap Drf Bist Time Out Fail", 0x00);
        ucBistResult |= _BIT4;
    }

    ScalerSetBit(P83_DE_CAP_BIST_CTRL, ~(_BIT2 | _BIT0), 0x00);

    //----------------------------------------------
    // OD S1 Disp
    ScalerSetBit(P83_DF_DIS_BIST_CTRL, ~_BIT0, _BIT0);
    for(ucCnt = 0; ucCnt < 2; ucCnt++)
    {
        if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P83_DF_DIS_BIST_CTRL, _BIT3, _TRUE) == _TRUE)
        {
            // Resume DRF BIST
            ScalerSetBit(P83_DF_DIS_BIST_CTRL, ~_BIT2, _BIT2);
            ScalerSetBit(P83_DF_DIS_BIST_CTRL, ~_BIT2, 0x00);
        }
        else
        {
            DebugMessageQC("5. OD S1 Disp Drf Bist Pause Resume Time Out Fail", 0x00);
            ucBistResult |= _BIT5;
        }
    }

    if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P83_DF_DIS_BIST_CTRL, _BIT6, _TRUE) == _TRUE)
    {
        // S1 Disp DRF BIST Fail
        if(ScalerGetBit(P83_DF_DIS_BIST_CTRL, _BIT4) != 0x00)
        {
            DebugMessageQC("5. OD S1 Disp Drf Bist Fail", 0x00);
            ucBistResult |= _BIT5;
        }
    }
    else
    {
        DebugMessageQC("5. OD S1 Disp Drf Bist Time Out Fail", 0x00);
        ucBistResult |= _BIT5;
    }

    ScalerSetBit(P83_DF_DIS_BIST_CTRL, ~(_BIT2 | _BIT0), 0x00);

    //=======================
    // OD S2
    //=======================
    // OD S2 Cap
    ScalerSetBit(PC3_DE_CAP_BIST_CTRL, ~_BIT0, _BIT0);
    for(ucCnt = 0; ucCnt < 2; ucCnt++)
    {
        if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, PC3_DE_CAP_BIST_CTRL, _BIT3, _TRUE) == _TRUE)
        {
            // Resume DRF BIST
            ScalerSetBit(PC3_DE_CAP_BIST_CTRL, ~_BIT2, _BIT2);
            ScalerSetBit(PC3_DE_CAP_BIST_CTRL, ~_BIT2, 0x00);
        }
        else
        {
            DebugMessageQC("5. OD S2 Cap Drf Bist Pause Resume Time Out Fail", 0x00);
            ucBistResult |= _BIT6;
        }
    }

    if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, PC3_DE_CAP_BIST_CTRL, _BIT6, _TRUE) == _TRUE)
    {
        // S2 Cap DRF BIST Fail
        if(ScalerGetBit(PC3_DE_CAP_BIST_CTRL, _BIT4) != 0x00)
        {
            DebugMessageQC("5. OD S2 Cap Drf Bist Fail", 0x00);
            ucBistResult |= _BIT6;
        }
    }
    else
    {
        DebugMessageQC("5. OD S2 Cap Drf Bist Time Out Fail", 0x00);
        ucBistResult |= _BIT6;
    }

    ScalerSetBit(PC3_DE_CAP_BIST_CTRL, ~(_BIT2 | _BIT0), 0x00);

    //----------------------------------------------
    // OD S2 Disp
    ScalerSetBit(PC3_DF_DIS_BIST_CTRL, ~_BIT0, _BIT0);
    for(ucCnt = 0; ucCnt < 2; ucCnt++)
    {
        if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, PC3_DF_DIS_BIST_CTRL, _BIT3, _TRUE) == _TRUE)
        {
            // Resume DRF BIST
            ScalerSetBit(PC3_DF_DIS_BIST_CTRL, ~_BIT2, _BIT2);
            ScalerSetBit(PC3_DF_DIS_BIST_CTRL, ~_BIT2, 0x00);
        }
        else
        {
            DebugMessageQC("5. OD S2 Disp Drf Bist Pause Resume Time Out Fail", 0x00);
            ucBistResult |= _BIT7;
        }
    }

    if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, PC3_DF_DIS_BIST_CTRL, _BIT6, _TRUE) == _TRUE)
    {
        // S2 Disp DRF BIST Fail
        if(ScalerGetBit(PC3_DF_DIS_BIST_CTRL, _BIT4) != 0x00)
        {
            DebugMessageQC("5. OD S2 Disp Drf Bist Fail", 0x00);
            ucBistResult |= _BIT7;
        }
    }
    else
    {
        DebugMessageQC("5. OD S2 Disp Drf Bist Time Out Fail", 0x00);
        ucBistResult |= _BIT7;
    }

    ScalerSetBit(PC3_DF_DIS_BIST_CTRL, ~(_BIT2 | _BIT0), 0x00);


    //==============================================
    // OD BIST postprocess
    //==============================================
    // disable OD BIST clock on each path
    ScalerSetBit(P3_DA_LS_DDR_START_ADDR_MSB, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT6));
    ScalerSetBit(P43_DA_LS_DDR_START_ADDR_MSB, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT6));
    ScalerSetBit(P83_DA_LS_DDR_START_ADDR_MSB, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT6));
    ScalerSetBit(PC3_DA_LS_DDR_START_ADDR_MSB, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT6));

    // Disable OD Front/Back separation
...
bit ScalerQCOSDBistTest(void)
{
    ...
    DebugMessageQC("5. ====OSD DRF Bist Test Start", 0x00);

    ScalerSetBit(P3A_91_OSD_LUT_DRF_BIST_CTRL, ~_BIT7, _BIT7);

    // Wait OSD DRF Start Pause
    for(ucCnt = 0; ucCnt < 2; ucCnt++)
    {
        if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P3A_91_OSD_LUT_DRF_BIST_CTRL, _BIT5, _BIT5) == _TRUE)
        {
            // Toggle drf_test_resume
            ScalerSetBit(P3A_91_OSD_LUT_DRF_BIST_CTRL, ~_BIT6, 0x00);
            ScalerSetBit(P3A_91_OSD_LUT_DRF_BIST_CTRL, ~_BIT6, _BIT6);
            ScalerSetBit(P3A_91_OSD_LUT_DRF_BIST_CTRL, ~_BIT6, 0x00);
        }
        else
        {
            DebugMessageQC("5. OSD Drf Bist Time Out Fail: 0", 0x00);
            ucBistResult0 |= _BIT2;
        }
    }
    ...
    {
        if(ScalerTimerPollingFlagProc(_BIST_TIMEOUT, P3A_91_OSD_LUT_DRF_BIST_CTRL, _BIT4, _BIT4) == _TRUE)
        {
            // BIST Fail
            if(ScalerGetBit(P3A_91_OSD_LUT_DRF_BIST_CTRL, _BIT3) != 0x00)
            {
                DebugMessageQC("5. OSD Drf Bist No.3 Fail", 0x00);
                ucBistResult0 |= _BIT3;
            }

            if(ScalerGetBit(P3A_91_OSD_LUT_DRF_BIST_CTRL, _BIT2) != 0x00)
            {
                DebugMessageQC("5. OSD Drf Bist No.2 Fail", 0x00);
                ucBistResult0 |= _BIT3;
            }

            if(ScalerGetBit(P3A_91_OSD_LUT_DRF_BIST_CTRL, _BIT1) != 0x00)
            {
                DebugMessageQC("5. OSD Drf Bist No.1 Fail", 0x00);
                ucBistResult0 |= _BIT3;
            }

            if(ScalerGetBit(P3A_91_OSD_LUT_DRF_BIST_CTRL, _BIT0) != 0x00)
            {
                DebugMessageQC("5. OSD Drf Bist No.0 Fail", 0x00);
                ucBistResult0 |= _BIT3;
            }

            if((ucBistResult0 & _BIT3) != _BIT3)
            {
                DebugMessageQC("5. OSD Drf Bist Pass", 0x00);
            }
        }
        else
        {
            DebugMessageQC("5. OSD Drf Bist Time Out Fail: 2", 0x00);
            ucBistResult0 |= _BIT4;
        }
    }
    ScalerSetBit(P3A_91_OSD_LUT_DRF_BIST_CTRL, ~_BIT7, 0x00);

    // Disable OSD Bist Clk
    ScalerSetBit(P3A_90_OSD_LUT_BIST_CTRL, ~_BIT1, 0x00);

    DebugMessageQC("5. ====OSD Drf Bist Test End", 0x00);
