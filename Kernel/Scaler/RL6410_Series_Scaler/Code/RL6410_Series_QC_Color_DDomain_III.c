...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6410_Series_QC_Color_DDomain_III.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6410_SERIES_QC_COLOR_DDOMAIN_III__
...
#if(_QC_4P_MODE_ == _ON)
BYTE code tQC_CONV_YUV2RGB_ITUBT2020_NON_CONSTANT[] =
{
    25, _AUTOINC,    P14_A2_SR_YCC2RGB_COEF_K11_MSB,    0xE4, 0xAB, 0x06, 0xBC, 0x60, 0xC0,
...
BYTE code tQC_CONV_YUV2RGB_ITUBT2020_CONSTANT[] =
{
    52, _AUTOINC,    P14_40_SR_BT2020_COEF_H11_HSB,    0x01, 0x2A, 0xF8, 0x01, 0x2A, 0xF8, 0x01, 0x2A, 0xF8,
                                                       ...
                                                       0x80, 0x00, 0x80, 0x00,
    15, _AUTOINC,    P14_AC_SR_YCC2RGB_R_OFFSET_MSB,   0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
BYTE code tDCOLORCONV_CRC_TABLE_0_5K3K[] = { // ITU601
    0x49, 0x35, 0xE0, 0x63, 0x54, 0x67, // M1
    0xDA, 0xB5, 0x94, 0xA6, 0xAF, 0xB4, // M2
    0xDD, 0x8E, 0x11, 0x66, 0x25, 0xE5, // S1
    0x6E, 0x86, 0xCF, 0xAA, 0x53, 0x90, // S2
    0xC3, 0x97, 0xC2, 0xDC, 0x8D, 0x65, // M1
    0xEF, 0x84, 0x11, 0x1F, 0xE9, 0xD6, // M2
    0xC3, 0x97, 0xC2, 0xDC, 0x8D, 0x65, // S1
    0xEF, 0x84, 0x11, 0x1F, 0xE9, 0xD6, // S2
};

BYTE code tDCOLORCONV_CRC_TABLE_1_5K3K[] = { // ITU709
    0xBE, 0x0C, 0x79, 0x17, 0xB9, 0x99, // M1
    0x6F, 0x85, 0xA9, 0xBF, 0x1E, 0xA6, // M2
    0xE0, 0x85, 0xA7, 0x8C, 0x4D, 0xA2, // S1
    0x2B, 0x82, 0xF6, 0xA4, 0x07, 0xA6, // S2
    0x9A, 0x42, 0x6F, 0x10, 0x19, 0xCD, // M1
    0x71, 0x5E, 0xBD, 0x98, 0x51, 0x94, // M2
    0x9A, 0x42, 0x6F, 0x10, 0x19, 0xCD, // S1
    0x71, 0x5E, 0xBD, 0x98, 0x51, 0x94, // S2
};

BYTE code tDCOLORCONV_CRC_TABLE_2_5K3K[] = { // ITU709_RGBLIMIT
    0x6C, 0x80, 0x0E, 0x53, 0x2D, 0xFD, // M1
    0xF9, 0x8A, 0x40, 0xD8, 0x19, 0x07, // M2
    0x14, 0x03, 0x19, 0x98, 0x98, 0xDA, // S1
    0x48, 0x21, 0x10, 0x89, 0x15, 0xB4, // S2
    0x7F, 0x50, 0x14, 0xFD, 0x89, 0x17, // M1
    0x41, 0xF5, 0x1F, 0xAE, 0xC2, 0x46, // M2
    0x7F, 0x50, 0x14, 0xFD, 0x89, 0x17, // S1
    0x41, 0xF5, 0x1F, 0xAE, 0xC2, 0x46, // S2
};

BYTE code tDCOLORCONV_CRC_TABLE_3_5K3K[] = { // ITU601_YUVFULL
    0x34, 0xDC, 0x25, 0x3C, 0x8A, 0x80, // M1
    0xCD, 0x7E, 0x6E, 0x8D, 0xD8, 0x7C, // M2
    0xEA, 0xF2, 0x30, 0x2A, 0x69, 0xAB, // S1
    0x5D, 0xC4, 0x81, 0x37, 0xD5, 0xE0, // S2
    0x87, 0x4C, 0x32, 0xB2, 0xB3, 0x05, // M1
    0xDB, 0x23, 0x48, 0x40, 0x47, 0x6B, // M2
    0x87, 0x4C, 0x32, 0xB2, 0xB3, 0x05, // S1
    0xDB, 0x23, 0x48, 0x40, 0x47, 0x6B, // S2
};

BYTE code tDCOLORCONV_CRC_TABLE_4_5K3K[] = { // ITU709_YUVFULL
    0x5E, 0xDB, 0x43, 0x70, 0x12, 0x84, // M1
    0x8D, 0xA5, 0xD0, 0x8D, 0x6A, 0x61, // M2
    0x26, 0x94, 0xA6, 0x9B, 0xF5, 0x04, // S1
    0xF2, 0xA6, 0xAC, 0x22, 0x1A, 0xC9, // S2
    0x49, 0x05, 0x5F, 0xBC, 0x94, 0xD1, // M1
    0x04, 0x8D, 0xF5, 0x4F, 0x59, 0x24, // M2
    0x49, 0x05, 0x5F, 0xBC, 0x94, 0xD1, // S1
    0x04, 0x8D, 0xF5, 0x4F, 0x59, 0x24, // S2
};

BYTE code tDCOLORCONV_CRC_TABLE_5_5K3K[] = { // bypass
    0x5A, 0x74, 0xE1, 0x53, 0x07, 0x73, // M1
    0x25, 0xEA, 0x45, 0x06, 0xE5, 0x0C, // M2
    0x49, 0xED, 0x3B, 0x4B, 0x06, 0xFA, // S1
    0x1C, 0x51, 0x4B, 0x1E, 0x7A, 0x08, // S2
    0x55, 0xA4, 0x58, 0x2D, 0x27, 0x63, // M1
    0x88, 0x6B, 0x6D, 0x3E, 0xFD, 0x75, // M2
    0x55, 0xA4, 0x58, 0x2D, 0x27, 0x63, // S1
    0x88, 0x6B, 0x6D, 0x3E, 0xFD, 0x75, // S2
};

BYTE code tDCOLORCONV_CRC_TABLE_6_5K3K[] = { // BT2020 Non-Constant
    0x73, 0x14, 0x17, 0xEB, 0x8B, 0x23, // M1
    0x97, 0x23, 0x33, 0x74, 0xDB, 0xC8, // M2
    0xE7, 0xA2, 0x7B, 0x86, 0x40, 0x42, // S1
    0x69, 0xB2, 0xFD, 0xED, 0x54, 0x84, // S2
    0x42, 0x58, 0x1F, 0xE2, 0x58, 0x80, // M1
    0xBB, 0x42, 0xAB, 0xDF, 0xDB, 0x91, // M2
    0x42, 0x58, 0x1F, 0xE2, 0x58, 0x80, // S1
    0xBB, 0x42, 0xAB, 0xDF, 0xDB, 0x91, // S2
};

BYTE code tDCOLORCONV_CRC_TABLE_7_5K3K[] = { // BT2020 Non-Constant
    0xCA, 0x74, 0x7A, 0xC1, 0xF3, 0xCD, // M1
    0x0D, 0xB7, 0x32, 0x3C, 0x81, 0xAF, // M2
    0x73, 0xD3, 0x5A, 0x12, 0x51, 0x8F, // S1
    0x52, 0x90, 0x5E, 0x5D, 0x91, 0x3E, // S2
    0xB7, 0x07, 0xF9, 0xA4, 0xE7, 0xAA, // M1
    0xA9, 0xB4, 0x04, 0xFA, 0x7E, 0xFB, // M2
    0xB7, 0x07, 0xF9, 0xA4, 0xE7, 0xAA, // S1
    0xA9, 0xB4, 0x04, 0xFA, 0x7E, 0xFB, // S2
};
#endif
...
#if(_QC_5K3K_MODE_ == _ON)
// -----------CRC Table of 5k3k1P SHP------------
BYTE code tSHP_5K3K1P_Table0[] = {
    0xAD, 0xB6, 0xFB, 0xEA, 0xBA, 0x63, // M1
    0x6F, 0x25, 0xD0, 0x36, 0x32, 0x63, // M2
    0x3B, 0xBA, 0x6F, 0xD9, 0x40, 0x69, // S1
    0xF6, 0x27, 0xA0, 0x29, 0xE7, 0xB0, // S2
};

BYTE code tSHP_5K3K1P_Table1[] = {
    0x73, 0x68, 0x81, 0x12, 0x37, 0x7C, // M1
    0x7B, 0x50, 0xBE, 0xCF, 0x2E, 0x97, // M2
    0x26, 0xC7, 0xBB, 0x78, 0x41, 0xCA, // S1
    0xF8, 0x90, 0xEB, 0x28, 0x45, 0x59, // S2
};
#endif
...
#if(_QC_5K3K_MODE_ == _ON)
BYTE code tQC_DDITHER_CRCTABLE_5K3K_0[] =
{
    0x94, 0xF5, 0xBD, 0xAA, 0x9F, 0x15, // M1
    0xDC, 0x2F, 0x47, 0x3B, 0x0F, 0x7C, // M2
    0x29, 0x11, 0xAE, 0x8C, 0x16, 0x96, // S1
    0xC3, 0xFB, 0x0B, 0xCC, 0x30, 0xBB, // S2

    0x45, 0xED, 0x63, 0xE9, 0x0E, 0x94, // M1
    0x14, 0xA2, 0xEC, 0xE7, 0xB8, 0xCD, // M2
    0x96, 0x6B, 0x0E, 0x7B, 0xC1, 0x1B, // S1
    0x5C, 0xCF, 0x68, 0x17, 0xBB, 0x09, // S2

    0x2A, 0xFD, 0x82, 0x75, 0x2F, 0x83, // M1
    0xAC, 0x34, 0xB3, 0x7D, 0x86, 0x8B, // M2
    0xBD, 0x8F, 0xA2, 0x0C, 0xB1, 0x03, // S1
    0x67, 0x39, 0x11, 0x28, 0x9F, 0xA3, // S2

    0xDD, 0x18, 0x6A, 0xF7, 0x7B, 0xCD, // M1
    0x45, 0x18, 0x3A, 0x14, 0x16, 0xBE, // M2
    0x38, 0x26, 0x1E, 0xD8, 0xA2, 0x1C, // S1
    0x6F, 0x74, 0x47, 0x16, 0xBD, 0xAB, // S2

    0x6D, 0xB6, 0x2D, 0xA7, 0x42, 0x8B, // M1
    0x01, 0xF1, 0x7D, 0xCF, 0xC7, 0xDE, // M2
    0xDF, 0x9D, 0x86, 0xB2, 0x35, 0xA5, // S1
    0x21, 0x01, 0xF7, 0x6D, 0x2C, 0x3E, // S2

    0x10, 0xEC, 0xBD, 0x4C, 0x0C, 0xE7, // M1
    0xB8, 0x3A, 0x21, 0xA9, 0x72, 0x42, // M2
    0xA5, 0x6B, 0x98, 0x7A, 0x93, 0x86, // S1
    0x41, 0xDE, 0x1E, 0x3D, 0xD0, 0x19, // S2

    0x04, 0x42, 0x00, 0x0D, 0x78, 0x81, // M1
    0x61, 0x37, 0x29, 0xF1, 0xEE, 0x46, // M2
    0x7F, 0x52, 0x4E, 0xE0, 0x21, 0x3C, // S1
    0xA9, 0xD3, 0xAC, 0xE3, 0x88, 0xDB, // S2

    0x28, 0x2F, 0x15, 0x51, 0x73, 0x47, // M1
    0xD3, 0x18, 0x98, 0x79, 0xE0, 0x2F, // M2
    0x55, 0xA0, 0x93, 0xB0, 0x7B, 0x7C, // S1
    0xD8, 0x3D, 0x71, 0x7E, 0xF3, 0x7A, // S2

    0x9E, 0x2D, 0x12, 0x56, 0x69, 0x67, // M1
    0x39, 0xC8, 0x54, 0x3E, 0x8B, 0x23, // M2
    0x57, 0x88, 0xE4, 0x7F, 0xB1, 0xDF, // S1
    0x9E, 0xD6, 0xC4, 0x8C, 0x5F, 0xE7, // S2
    ...
    0x85, 0xC9, 0x5B, 0x33, 0x0A, 0x92, // M1
    0x8E, 0x06, 0x7A, 0x0C, 0x07, 0x89, // M2
    0x69, 0x20, 0x83, 0x53, 0xD5, 0xF3, // S1
    0xA7, 0x4A, 0x99, 0x3C, 0xD5, 0x26, // S2

    0x75, 0x6B, 0xB7, 0xC8, 0x8F, 0xC6, // M1
    0xAE, 0x8C, 0xFA, 0x9E, 0xAE, 0x4D, // M2
    0xB9, 0x9B, 0x82, 0xAC, 0xCF, 0xB9, // S1
    0x5B, 0xBB, 0x32, 0xB7, 0x5A, 0xC8, // S2

    0x43, 0xFC, 0x11, 0xBB, 0x83, 0x2B, // M1
    0x6B, 0x8A, 0x50, 0xE7, 0x26, 0xA3, // M2
    0xA2, 0x85, 0xF5, 0x8C, 0x61, 0x73, // S1
    0x40, 0x84, 0xD9, 0x40, 0x38, 0xC8, // S2

    0x72, 0xAF, 0x6E, 0x6E, 0x95, 0xDB, // M1
    0x85, 0xB1, 0xE5, 0xE7, 0xA4, 0x1D, // M2
    0x38, 0xDC, 0x7A, 0x44, 0xC9, 0x36, // S1
    0x17, 0x05, 0x88, 0x6E, 0x9C, 0xD3, // S2

    0x8A, 0x8C, 0xD5, 0xE4, 0x1D, 0xB3, // M1
    0xE2, 0xA2, 0x8A, 0x0B, 0xA6, 0xDA, // M2
    0x60, 0x1F, 0xFF, 0x5A, 0x1C, 0x83, // S1
    0x03, 0xC7, 0x46, 0x5C, 0x53, 0x84, // S2

    0xBB, 0xB7, 0xD2, 0x8F, 0xEC, 0x3A, // M1
    0x60, 0x6D, 0xC1, 0x88, 0x1C, 0xF0, // M2
    0x73, 0xCD, 0x92, 0x30, 0xDD, 0xB0, // S1
    0x57, 0xED, 0x06, 0x1A, 0x55, 0xCF, // S2
...
BYTE code tQC_DDITHER_CRCTABLE_5K3K_1[] =
{
    0x94, 0x76, 0x63, 0x62, 0xE8, 0xCE, // M1
    0x80, 0xBA, 0xAF, 0x4B, 0xC5, 0xC4, // M2
    0xDE, 0x41, 0x59, 0x95, 0x0A, 0xD6, // S1
    0xF7, 0xD2, 0x03, 0x87, 0xA3, 0xF0, // S2

    0x20, 0xED, 0x28, 0x8D, 0xD8, 0x7C, // M1
    0xDE, 0xF9, 0x83, 0x32, 0x0C, 0x67, // M2
    0xF0, 0x68, 0xC9, 0x33, 0x29, 0x92, // S1
    0x86, 0xA0, 0xE8, 0x0B, 0xF5, 0x9E, // S2

    0x6A, 0x53, 0x10, 0x4A, 0x61, 0x44, // M1
    0x76, 0x45, 0x12, 0xF1, 0xF5, 0x10, // M2
    0x39, 0x62, 0xA2, 0xB6, 0x91, 0x84, // S1
    0x65, 0xFD, 0xCF, 0xD9, 0xF0, 0x53, // S2

    0xBC, 0x7E, 0x0C, 0x6F, 0x64, 0x53, // M1
    0xB8, 0x42, 0x85, 0x28, 0x5B, 0x2B, // M2
    0xA5, 0x57, 0x6E, 0x21, 0x48, 0x4E, // S1
    0x6F, 0xAC, 0x5E, 0x5D, 0x4F, 0xD3, // S2

    0x34, 0x69, 0x5F, 0x9B, 0xBE, 0x29, // M1
    0x93, 0xC1, 0x29, 0x24, 0xDE, 0xB0, // M2
    0x84, 0xB9, 0x7F, 0xB8, 0xE7, 0xDA, // S1
    0xFC, 0x04, 0x2C, 0xB9, 0x77, 0xAE, // S2

    0xDE, 0x6B, 0xA1, 0xE2, 0x99, 0x7B, // M1
    0x73, 0xE3, 0xCF, 0xD2, 0x72, 0x5C, // M2
    0x30, 0x7A, 0x4B, 0x44, 0xA9, 0x90, // S1
    0x48, 0x1D, 0x21, 0x1D, 0xBE, 0xEE, // S2

    0x0F, 0xCC, 0xCD, 0x4D, 0x25, 0x8D, // M1
    0xFD, 0x3D, 0x72, 0x8B, 0xA3, 0x27, // M2
    0xC7, 0x37, 0x75, 0x08, 0x09, 0x9E, // S1
    0xEA, 0x86, 0x2C, 0x4B, 0xDA, 0xFC, // S2

    0x1C, 0x19, 0x9E, 0x85, 0xFE, 0x54, // M1
    0x65, 0xFE, 0x41, 0x2D, 0x4E, 0xE8, // M2
    0x6C, 0x54, 0xCD, 0xEC, 0x29, 0x41, // S1
    0x6C, 0xBA, 0xA2, 0x3C, 0xAA, 0x5E, // S2

    0xD9, 0x4B, 0xF1, 0x89, 0x8D, 0x93, // M1
    0xB9, 0x74, 0xD8, 0xA7, 0x1A, 0xA1, // M2
    0x4B, 0xB1, 0x34, 0x44, 0x66, 0x26, // S1
    0xE4, 0x3C, 0x6F, 0x8F, 0xC7, 0x65, // S2

    0x28, 0xF9, 0x38, 0x9A, 0x8A, 0x8A, // M1
    0x7F, 0x10, 0x6F, 0x70, 0x6F, 0x75, // M2
    0x04, 0x36, 0x48, 0xD6, 0x19, 0x1F, // S1
    0x99, 0xDE, 0xA8, 0xC0, 0x59, 0x87, // S2

    0xF7, 0xE8, 0xAE, 0xA1, 0x2B, 0x55, // M1
    0x48, 0x58, 0x62, 0x62, 0x08, 0x66, // M2
    0xAA, 0xF6, 0xD2, 0x65, 0xF3, 0x29, // S1
    0xC9, 0xF1, 0xFD, 0xBF, 0x63, 0x4D, // S2

    0x30, 0x07, 0xFB, 0x3F, 0xD0, 0xB3, // M1
    0xE0, 0x21, 0x9B, 0x4E, 0x5F, 0x12, // M2
    0xE6, 0x92, 0x17, 0xCE, 0x14, 0xDF, // S1
    0x37, 0x92, 0x01, 0xFC, 0x34, 0xF6, // S2

    0x08, 0x12, 0x57, 0xB1, 0xFC, 0xA0, // M1
    0x58, 0x32, 0xDF, 0xFE, 0xEA, 0x24, // M2
    0x94, 0x22, 0x72, 0x30, 0x7A, 0x89, // S1
    0x00, 0x35, 0x01, 0x83, 0x10, 0x7E, // S2

    0x7E, 0x6E, 0x9E, 0xF7, 0xBE, 0x7A, // M1
    0xBE, 0x72, 0xBE, 0xF0, 0xAC, 0xDE, // M2
    0xAE, 0xD5, 0x2D, 0x2E, 0x9E, 0x42, // S1
    0x29, 0x35, 0x30, 0x41, 0xC1, 0x10, // S2

    0xC2, 0x09, 0xF0, 0xE0, 0x1D, 0x32, // M1
    0x8B, 0x84, 0x9D, 0x45, 0x33, 0x58, // M2
    0x5C, 0xFB, 0xE5, 0x85, 0x53, 0x39, // S1
    0x7E, 0x87, 0x02, 0x07, 0xE9, 0xCF, // S2

    0x14, 0x08, 0xCA, 0x86, 0x59, 0x9D, // M1
    0xEA, 0xE0, 0x94, 0xC5, 0x07, 0x67, // M2
    0xB4, 0x56, 0x9D, 0xE8, 0x2A, 0x24, // S1
    0x10, 0x5E, 0x04, 0x94, 0x0F, 0xF5, // S2

    0x0E, 0xBB, 0xA8, 0xB6, 0x7B, 0x2B, // M1
    0xFC, 0x4B, 0x85, 0x0F, 0xA8, 0x94, // M2
    0x54, 0x64, 0x3B, 0x3E, 0x7F, 0x69, // S1
    0xDC, 0xB7, 0xC9, 0x99, 0x2B, 0xD5, // S2

    0x6A, 0x0D, 0x58, 0x86, 0xA8, 0x0B, // M1
    0x2F, 0x34, 0x91, 0x9B, 0xD5, 0x86, // M2
    0x83, 0xFC, 0x43, 0x6D, 0x24, 0xDC, // S1
    0xA6, 0x9A, 0xF3, 0xFE, 0x58, 0x7A, // S2

    0x46, 0xA8, 0x21, 0x0F, 0x07, 0x52, // M1
    0xA8, 0x02, 0x63, 0x54, 0x9E, 0xD5, // M2
    0x3E, 0xFD, 0xA5, 0x49, 0xA2, 0xE2, // S1
    0x78, 0x55, 0x05, 0x06, 0x24, 0xFC, // S2

    0xE2, 0xEC, 0x92, 0xB8, 0xCF, 0x2E, // M1
    0x85, 0x42, 0x76, 0x13, 0x12, 0x21, // M2
    0x44, 0x18, 0xD9, 0x2C, 0xAB, 0xAB, // S1
    0xAA, 0x0E, 0x95, 0xEA, 0x89, 0x83, // S2

    0x7A, 0x75, 0x81, 0x8F, 0xE2, 0x0A, // M1
    0x79, 0x93, 0x7F, 0x1B, 0x3B, 0xD7, // M2
    0xBF, 0x8F, 0x80, 0x18, 0x83, 0x41, // S1
    0x7B, 0xA3, 0xDD, 0xFD, 0x31, 0xDA, // S2

    0x12, 0xAF, 0x7B, 0xD2, 0x35, 0x47, // M1
    0xD4, 0xF3, 0x34, 0x53, 0x8E, 0x99, // M2
    0xF1, 0xA8, 0x9E, 0x69, 0x9E, 0xD1, // S1
    0xD4, 0xDD, 0x0A, 0x97, 0x22, 0x72, // S2

    0x05, 0xDE, 0x04, 0x1B, 0xD4, 0xD5, // M1
    0xFA, 0x6E, 0xB9, 0xBE, 0xD2, 0x3A, // M2
    0x95, 0x99, 0xB9, 0x79, 0x7A, 0x20, // S1
    0x1E, 0xF1, 0xE6, 0xC3, 0x13, 0xDC, // S2

    0x76, 0x51, 0xA2, 0xDD, 0xD1, 0xF7, // M1
    0xB6, 0xC3, 0x84, 0x0D, 0xC1, 0xC3, // M2
    0x1E, 0x4B, 0x8D, 0x9B, 0xE0, 0x96, // S1
    0xA6, 0xF1, 0x60, 0xBC, 0xAF, 0xAD, // S2

    0x4F, 0x52, 0x07, 0xA5, 0xBF, 0xC4, // M1
    0xFE, 0x71, 0x29, 0xED, 0xD1, 0x34, // M2
    0x2E, 0x27, 0x20, 0x76, 0x2B, 0xC6, // S1
    0x8A, 0xD9, 0xB5, 0x8D, 0x8B, 0x36, // S2

    0x95, 0xEC, 0xA4, 0x0D, 0x81, 0x21, // M1
    0x8F, 0x76, 0x3E, 0x08, 0xD2, 0x8E, // M2
    0x7B, 0xD7, 0xAC, 0x7C, 0x68, 0x1A, // S1
    0x88, 0x1A, 0xEA, 0x91, 0x98, 0x00, // S2

    0x22, 0xFF, 0x43, 0x71, 0xD6, 0x10, // M1
    0x4D, 0xE3, 0xCB, 0x2F, 0x23, 0x35, // M2
    0xDB, 0x37, 0x7B, 0x77, 0x66, 0x0D, // S1
    0xA7, 0xBF, 0x3B, 0x81, 0x38, 0x8E, // S2

    0xCA, 0x54, 0xBA, 0x30, 0x25, 0xE0, // M1
    0x3B, 0x4C, 0x84, 0x1A, 0x40, 0xEB, // M2
    0xA7, 0xA0, 0x49, 0xC1, 0xB4, 0x2B, // S1
    0x22, 0x61, 0xD4, 0x2D, 0xDB, 0x26, // S2

    0x03, 0xFD, 0x2B, 0xE6, 0xFF, 0x99, // M1
    0x81, 0x37, 0x33, 0x74, 0xD3, 0x4E, // M2
    0x6D, 0x16, 0xEB, 0xB7, 0x94, 0xCF, // S1
    0x4E, 0xC8, 0xD2, 0x96, 0x20, 0xB8, // S2

    0x91, 0xEF, 0x3C, 0xC4, 0x48, 0x31, // M1
    0x19, 0x12, 0x27, 0xFE, 0x30, 0x35, // M2
    0x64, 0x3A, 0x66, 0x1C, 0xA4, 0x2A, // S1
    0xBD, 0x93, 0x6D, 0x83, 0x1A, 0x78, // S2

    0xC9, 0x3A, 0x7E, 0xB6, 0x5B, 0x16, // M1
    0xEC, 0x48, 0x47, 0xC5, 0x82, 0x92, // M2
    0xE0, 0x86, 0xE7, 0xE8, 0xCF, 0x3A, // S1
    0x8F, 0x41, 0x3F, 0x0B, 0xC0, 0x76, // S2

    0xBE, 0x30, 0x10, 0x42, 0x16, 0x0A, // M1
    0x2F, 0x95, 0x17, 0xA7, 0xE6, 0xB9, // M2
    0x9D, 0x06, 0x3E, 0xF0, 0xFB, 0x4A, // S1
    0xF5, 0xF4, 0x18, 0x63, 0xCE, 0x5E, // S2

    0x5B, 0x02, 0xF3, 0x96, 0x1A, 0xB8, // M1
    0xDA, 0xA3, 0x93, 0xEF, 0xB8, 0x9F, // M2
    0x31, 0xCF, 0xEC, 0x14, 0xFA, 0xB8, // S1
    0x15, 0xB8, 0xA5, 0x0D, 0x56, 0xBE, // S2

    0xB1, 0xD6, 0xC1, 0xFC, 0x10, 0x87, // M1
    0x97, 0x50, 0x6D, 0x8F, 0x99, 0x6E, // M2
    0xAD, 0x06, 0x60, 0xFB, 0x5D, 0xFD, // S1
    0x25, 0x39, 0x3B, 0xBE, 0xBF, 0x84, // S2

    0xBB, 0x4D, 0xF5, 0xFD, 0x61, 0xC9, // M1
    0x89, 0x49, 0xD8, 0xEB, 0x1C, 0xA5, // M2
    0x4B, 0x91, 0xC1, 0x92, 0xE4, 0x95, // S1
    0xC3, 0x37, 0x9A, 0x0F, 0xFE, 0x62, // S2

    0x79, 0xC7, 0x57, 0x9A, 0x80, 0x15, // M1
    0x30, 0x6E, 0x85, 0x2A, 0x16, 0xCF, // M2
    0x50, 0xB4, 0x06, 0x1C, 0x7D, 0x47, // S1
    0xCA, 0x9D, 0xFD, 0xE4, 0x80, 0xC8, // S2

    0x65, 0xE5, 0x76, 0xC0, 0xC1, 0xC0, // M1
    0x1C, 0xA5, 0x5C, 0xD8, 0x4C, 0x36, // M2
    0x05, 0xE3, 0x0A, 0x3A, 0x9C, 0x42, // S1
    0x07, 0xC1, 0xA2, 0x34, 0xC6, 0x8A, // S2

    0x2F, 0xE1, 0x0F, 0xDF, 0xFA, 0x85, // M1
    0x92, 0x65, 0x1A, 0x46, 0x0F, 0xCE, // M2
    0x46, 0x2C, 0x08, 0xA0, 0x02, 0x6E, // S1
    0x56, 0x84, 0xF1, 0xF9, 0x42, 0x94, // S2

    0x50, 0x39, 0x77, 0x3F, 0x10, 0x34, // M1
    0xF3, 0xDC, 0x8B, 0x25, 0xDB, 0x6F, // M2
    0x74, 0xA5, 0xEB, 0xB8, 0x9C, 0xCE, // S1
    0xA5, 0xAC, 0x72, 0xFE, 0x75, 0x45, // S2

    0x63, 0x27, 0xF3, 0x58, 0x27, 0x5F, // M1
    0x9F, 0x5A, 0x84, 0x45, 0x39, 0x90, // M2
    0x3B, 0x03, 0x0E, 0x35, 0xB0, 0x76, // S1
    0x8F, 0x5D, 0xC1, 0x03, 0x3B, 0x7A, // S2

    0x62, 0xC6, 0xE3, 0xA0, 0xF0, 0x3C, // M1
    0xA6, 0x1A, 0xFE, 0x11, 0xEB, 0xC6, // M2
    0x64, 0xC4, 0xC7, 0xAD, 0x2C, 0x6C, // S1
    0xB1, 0x48, 0xB3, 0xB0, 0x6D, 0xE6, // S2

    0xA1, 0xBA, 0xE5, 0xD0, 0x6F, 0x90, // M1
    0xC6, 0x91, 0x5A, 0xCC, 0xAB, 0x9E, // M2
    0x0F, 0x97, 0x27, 0x15, 0xA4, 0xB1, // S1
    0x7B, 0x93, 0x0D, 0x25, 0xE2, 0x5B, // S2

    0x39, 0x77, 0xB6, 0xA1, 0xAE, 0xB6, // M1
    0x73, 0x6E, 0xE8, 0x17, 0x3B, 0xC0, // M2
    0x60, 0x8E, 0x0A, 0xB6, 0xAC, 0x4D, // S1
    0x9A, 0x7F, 0x51, 0xAC, 0x3E, 0xA5, // S2

    0x8D, 0xE6, 0x19, 0x52, 0x54, 0x4D, // M1
    0x38, 0x1D, 0xDE, 0x10, 0x86, 0x1A, // M2
    0xBB, 0x88, 0xB4, 0x29, 0x07, 0xF1, // S1
    0xA6, 0x99, 0x4C, 0x17, 0x28, 0x8C, // S2

    0xAE, 0x2B, 0xF8, 0x68, 0xB0, 0x50, // M1
    0x68, 0x81, 0x93, 0xFA, 0x17, 0xB3, // M2
    0x5E, 0x15, 0x83, 0x3A, 0x4E, 0xA8, // S1
    0xCE, 0xF5, 0x3E, 0xB9, 0x8E, 0xFB, // S2

    0x05, 0x9A, 0x72, 0x77, 0x6F, 0xAE, // M1
    0x39, 0xA6, 0xDF, 0x29, 0xBF, 0xD4, // M2
    0xAF, 0x9A, 0xE5, 0x86, 0xC8, 0x05, // S1
    0x6A, 0x6A, 0xE7, 0x2D, 0x85, 0x4F, // S2

    0x7C, 0x2D, 0xEF, 0x7F, 0x7A, 0x8D, // M1
    0xEF, 0x69, 0x2E, 0x7E, 0xC9, 0xA8, // M2
    0x19, 0x16, 0x5B, 0x85, 0x53, 0xFA, // S1
    0x28, 0x7E, 0x9A, 0x79, 0x97, 0xD6, // S2

    0x3B, 0x8D, 0x6C, 0x1F, 0xED, 0xEF, // M1
    0x84, 0xFD, 0x3D, 0x1B, 0xFF, 0x02, // M2
    0x8D, 0xF7, 0x3C, 0x62, 0x23, 0xAE, // S1
    0x82, 0x90, 0xA2, 0x45, 0xD3, 0x41, // S2
...
BYTE code tQC_DDITHER_CRCTABLE_5K3K_2[] =
{
    0x92, 0x3B, 0xDF, 0xC7, 0xB3, 0xA9, // M1
    0xB0, 0x4C, 0x40, 0x6A, 0x51, 0x7A, // M2
    0x6D, 0x32, 0xF7, 0xC1, 0x45, 0x03, // S1
    0x23, 0x9F, 0x5B, 0x74, 0x2C, 0x1A, // S2
};

BYTE code tQC_DDITHER_CRCTABLE_5K3K_3[] =
{
    0x22, 0xF4, 0xFC, 0x31, 0x6E, 0xD7, // M1
    0x4D, 0x28, 0x54, 0x29, 0xE8, 0x57, // M2
    0x8E, 0x73, 0xAE, 0xE2, 0x41, 0x55, // S1
    0x9E, 0xA8, 0x33, 0x9C, 0x08, 0x9E, // S2

    0x8C, 0xA2, 0x6F, 0x1F, 0x6B, 0x20, // M1
    0xB7, 0x69, 0xF8, 0x74, 0x3F, 0xA8, // M2
    0xD9, 0x27, 0xAD, 0x41, 0x99, 0xE3, // S1
    0xFA, 0xDE, 0x97, 0xF5, 0x0F, 0x6A, // S2

    0xDF, 0x6D, 0x8A, 0x9B, 0x12, 0x55, // M1
    0x93, 0x10, 0x33, 0x5B, 0x39, 0x1F, // M2
    0x25, 0x15, 0xEA, 0xD8, 0x04, 0xCE, // S1
    0xA2, 0x58, 0x75, 0xAD, 0xAE, 0x01, // S2

    0x82, 0x95, 0xB4, 0x85, 0x8F, 0xF9, // M1
    0x18, 0x11, 0x24, 0x8C, 0x2E, 0x7F, // M2
    0x76, 0x71, 0x07, 0x07, 0x62, 0xAE, // S1
    0xAF, 0x44, 0x59, 0xA7, 0x2F, 0x2F, // S2

    0x16, 0x03, 0xA0, 0xE9, 0x15, 0x18, // M1
    0x27, 0xC8, 0xE8, 0x62, 0xAB, 0x39, // M2
    0x58, 0x6C, 0x9E, 0x47, 0x53, 0x1D, // S1
    0xDB, 0xF4, 0x50, 0xC2, 0x83, 0xEA, // S2

    0x42, 0xD4, 0xC6, 0x8A, 0xB7, 0x6D, // M1
    0xE2, 0x38, 0x9C, 0xF3, 0xC1, 0xD5, // M2
    0xCB, 0xBD, 0x3B, 0x37, 0xF9, 0x75, // S1
    0xB8, 0x93, 0xD6, 0x05, 0xB6, 0x60, // S2

    0xC5, 0x8C, 0xD7, 0xE7, 0xC7, 0xDF, // M1
    0xB5, 0xCB, 0x92, 0x27, 0xD5, 0xD7, // M2
    0xA3, 0xCB, 0x8C, 0xC0, 0xE1, 0x71, // S1
    0xC2, 0x38, 0x87, 0xBC, 0xB4, 0x82, // S2

    0xE3, 0x27, 0x74, 0x40, 0x81, 0x39, // M1
    0x5A, 0x99, 0xBE, 0xB5, 0x1B, 0x5A, // M2
    0xB9, 0x24, 0xFA, 0x8B, 0xC3, 0xE5, // S1
    0x11, 0x03, 0x6F, 0xB8, 0x02, 0x41, // S2

    0x84, 0xD8, 0x5B, 0x30, 0x54, 0xC6, // M1
    0xEC, 0x42, 0x1E, 0xD2, 0xC8, 0x5E, // M2
    0x99, 0xB1, 0x02, 0x1E, 0x15, 0x73, // S1
    0xB4, 0xB5, 0x06, 0xFA, 0xB0, 0x36, // S2

    0xA0, 0x1B, 0x69, 0x8E, 0xB5, 0xED, // M1
    0x46, 0x2B, 0x6F, 0x8F, 0x9F, 0x5F, // M2
    0x4F, 0x57, 0x1E, 0x70, 0x63, 0x3C, // S1
    0x4E, 0x09, 0x1D, 0x10, 0xB0, 0x5D, // S2

    0x85, 0xDE, 0xC6, 0x28, 0xA7, 0xA0, // M1
    0x95, 0x0A, 0xF7, 0x9D, 0xD4, 0x06, // M2
    0xFF, 0x49, 0xEC, 0xBF, 0x5C, 0x93, // S1
    0x8D, 0xBB, 0xD8, 0xDC, 0xFA, 0x32, // S2

    0xF3, 0x9C, 0x94, 0x6D, 0x75, 0x62, // M1
    0x2B, 0x2B, 0xE4, 0xD4, 0x73, 0xA4, // M2
    0x8B, 0xBA, 0x52, 0xCC, 0x21, 0xB8, // S1
    0x9A, 0x27, 0x0D, 0xB8, 0xC4, 0x33, // S2

    0xD4, 0x4D, 0x0D, 0xC3, 0x16, 0xA7, // M1
    0xD8, 0xB4, 0xC2, 0x84, 0x1F, 0x39, // M2
    0x6B, 0xAB, 0xB3, 0x0C, 0xC7, 0x34, // S1
    0x08, 0xC9, 0xD7, 0x67, 0x59, 0x8D, // S2

    0xEE, 0x1E, 0xE7, 0xE3, 0xAE, 0x21, // M1
    0xC4, 0x68, 0xC7, 0xF6, 0x33, 0x7A, // M2
    0x56, 0x00, 0x20, 0x95, 0xBF, 0x91, // S1
    0x1D, 0x6D, 0x67, 0x5A, 0x64, 0x59, // S2

    0x94, 0x4B, 0xE2, 0xDC, 0x60, 0x4A, // M1
    0x97, 0xB3, 0x24, 0xA3, 0xC8, 0x5A, // M2
    0x8F, 0x56, 0x45, 0x89, 0x0C, 0x07, // S1
    0x9F, 0x6A, 0xF9, 0xE9, 0xD1, 0x83, // S2

    0x1F, 0xD0, 0xC5, 0x3E, 0x82, 0x87, // M1
    0x61, 0xF6, 0x95, 0x66, 0x17, 0x1C, // M2
    0x65, 0xA5, 0x5B, 0x70, 0x53, 0x8D, // S1
    0x12, 0x38, 0x4F, 0x18, 0x59, 0x7E, // S2

    0x27, 0x0F, 0xE5, 0x36, 0xE4, 0x4B, // M1
    0x78, 0xDB, 0x9D, 0x19, 0x5C, 0x4D, // M2
    0x2F, 0x7F, 0x9C, 0xA1, 0x9B, 0x11, // S1
    0x29, 0x69, 0x16, 0x93, 0xB1, 0x5D, // S2

    0xC6, 0x1F, 0x55, 0xBB, 0x0F, 0x34, // M1
    0xC1, 0xDF, 0xCC, 0x9B, 0x23, 0x76, // M2
    0xD2, 0x4A, 0x75, 0xB2, 0x36, 0xEE, // S1
    0xEB, 0xAB, 0x64, 0xEA, 0x0B, 0x65, // S2

    0x19, 0x08, 0xA6, 0x59, 0xC7, 0x93, // M1
    0xAA, 0x2A, 0xFE, 0xAD, 0x86, 0x64, // M2
    0x52, 0x85, 0xEF, 0xEE, 0xE7, 0x65, // S1
    0xB9, 0x6C, 0xDE, 0xD0, 0x43, 0xEF, // S2

    0xAE, 0x2C, 0xB2, 0x14, 0x51, 0x34, // M1
    0xE9, 0x53, 0xB3, 0x77, 0x8E, 0x88, // M2
    0xE0, 0x01, 0xB4, 0x36, 0x98, 0x71, // S1
    0x1B, 0x93, 0xD3, 0x42, 0x90, 0x18, // S2

    0xD5, 0x9D, 0x95, 0x2C, 0x4A, 0x42, // M1
    0x2B, 0x01, 0xEC, 0xA4, 0xA0, 0x58, // M2
    0x8E, 0xF0, 0xA9, 0x32, 0x6A, 0xF2, // S1
    0x77, 0x01, 0xDE, 0xB0, 0xD7, 0xC7, // S2

    0x24, 0xD0, 0xFA, 0xBF, 0x0D, 0xB4, // M1
    0x65, 0xCC, 0x3F, 0xE7, 0x7D, 0xFC, // M2
    0x56, 0xA0, 0x50, 0xF5, 0xAC, 0xA7, // S1
    0x1D, 0x31, 0xAF, 0xFF, 0x0D, 0x58, // S2

    0xC0, 0x77, 0xCE, 0xE0, 0x4D, 0x43, // M1
    0x80, 0x38, 0x5B, 0x17, 0x61, 0xCD, // M2
    0x02, 0xC7, 0xBE, 0x83, 0x3B, 0x35, // S1
    0x75, 0xF9, 0xA2, 0xB3, 0x0D, 0x41, // S2

    0xA9, 0x9A, 0x4E, 0xE4, 0xE5, 0x2D, // M1
    0x2C, 0x2F, 0x8A, 0x5A, 0x07, 0x84, // M2
    0xB2, 0x49, 0x22, 0x78, 0x6C, 0xE8, // S1
    0x00, 0x76, 0x9C, 0xA7, 0x06, 0x4E, // S2

    0x42, 0xBD, 0x77, 0xF2, 0x81, 0x00, // M1
    0xD5, 0x78, 0xD3, 0x24, 0x77, 0x25, // M2
    0xEE, 0x21, 0x07, 0x28, 0xF6, 0xD8, // S1
    0xAF, 0x81, 0xAD, 0x87, 0x5D, 0xD8, // S2
    ...
    0x46, 0x40, 0xF3, 0xED, 0xF8, 0xFA, // M1
    0x99, 0xC3, 0xF3, 0x5B, 0xDF, 0x67, // M2
    0x29, 0xD5, 0xDB, 0xCA, 0x65, 0x7C, // S1
    0x21, 0x4E, 0x56, 0xAE, 0xAE, 0x1F, // S2

    0x95, 0x98, 0xA8, 0x58, 0xCF, 0xBB, // M1
    0xAC, 0xDF, 0x47, 0xC0, 0xCF, 0x8D, // M2
    0x16, 0xA7, 0x39, 0x0E, 0x74, 0x6A, // S1
    0x3F, 0x85, 0x74, 0x42, 0x7F, 0x0B, // S2

    0xD1, 0xB6, 0x14, 0xC4, 0x9C, 0x3B, // M1
    0xED, 0x47, 0x0B, 0xB4, 0xAB, 0x23, // M2
    0xCA, 0xA7, 0x81, 0x4F, 0x1D, 0x70, // S1
    0xBF, 0x08, 0xF2, 0x68, 0xE0, 0x4E, // S2

    0xA4, 0xA3, 0xDD, 0x47, 0xCA, 0x35, // M1
    0xB2, 0xDE, 0xF3, 0x19, 0x2F, 0xA4, // M2
    0x5D, 0x6D, 0xF8, 0x66, 0x10, 0x9C, // S1
    0x0C, 0x18, 0x94, 0x45, 0x60, 0x56, // S2

    0x52, 0x2E, 0xCE, 0x1E, 0xB5, 0x8C, // M1
    0xAE, 0x89, 0xE9, 0x55, 0x77, 0x21, // M2
    0xF8, 0xC6, 0x40, 0xBF, 0xEF, 0xAC, // S1
    0x84, 0x5E, 0x52, 0x94, 0x3C, 0x6D, // S2

    0x33, 0x69, 0xC3, 0xAF, 0x5C, 0x4A, // M1
    0x90, 0xB4, 0x02, 0x9D, 0xB7, 0xEB, // M2
    0xF3, 0xD5, 0xE8, 0x41, 0xA9, 0x52, // S1
    0xA6, 0xEF, 0xC5, 0xFD, 0xE6, 0x49, // S2

    0xE4, 0x91, 0xD0, 0xF3, 0xBB, 0x11, // M1
    0x74, 0x12, 0x99, 0xDF, 0x57, 0x2C, // M2
    0xF9, 0xE3, 0xAB, 0xD4, 0xA2, 0xFE, // S1
    0x85, 0x9C, 0x98, 0xE1, 0xE5, 0x70, // S2
    ...
    0x1C, 0xF3, 0xBF, 0x5E, 0x4D, 0x0F, // M1
    0x9F, 0xD9, 0x37, 0x9D, 0x32, 0x7E, // M2
    0xF3, 0x89, 0xDD, 0xAD, 0x3D, 0x21, // S1
    0x0E, 0xAD, 0xFB, 0xDF, 0xFA, 0x2C, // S2

    0xE4, 0x91, 0x88, 0xB0, 0x35, 0x20, // M1
    0x9F, 0xE5, 0x87, 0x98, 0x92, 0x56, // M2
    0xEB, 0x6C, 0x6C, 0xC5, 0x37, 0x7C, // S1
    0x0A, 0xE6, 0x20, 0x5D, 0x94, 0x17, // S2

    0x13, 0xF8, 0xB9, 0xEE, 0x9F, 0x84, // M1
    0x12, 0x3B, 0x21, 0x52, 0x1F, 0x23, // M2
    0xF9, 0x60, 0xAC, 0x04, 0x89, 0x59, // S1
    0x6C, 0x35, 0x75, 0xCD, 0x3A, 0x29, // S2

    0x08, 0x69, 0xFC, 0x2E, 0xD3, 0x79, // M1
    0x94, 0x8E, 0xA8, 0x1C, 0xDD, 0x0B, // M2
    0xC0, 0xD0, 0xE3, 0xC4, 0x56, 0x78, // S1
    0xA9, 0xE6, 0x25, 0x1A, 0xB2, 0x6F, // S2

    0x03, 0xE9, 0xFB, 0x25, 0x12, 0x19, // M1
    0x8C, 0xF1, 0x5F, 0xD1, 0x6A, 0xAC, // M2
    0xD4, 0x5B, 0x89, 0xF6, 0x02, 0xDA, // S1
    0xD9, 0x0C, 0x2C, 0xC1, 0x59, 0x6C, // S2

    0xCF, 0x9E, 0x72, 0xD1, 0x5F, 0xF4, // M1
    0xAB, 0xDB, 0x29, 0x4E, 0xBB, 0xAD, // M2
    0x2F, 0x54, 0x49, 0xBA, 0x39, 0x3A, // S1
    0xA5, 0xD4, 0xE5, 0x5D, 0xBD, 0x76, // S2

    0x47, 0x46, 0x6E, 0xF5, 0x0B, 0x9C, // M1
    0xE0, 0x8B, 0x1A, 0x14, 0xC3, 0x3F, // M2
    0x4F, 0x2D, 0x35, 0x6B, 0x2C, 0x9C, // S1
    0x18, 0x40, 0x88, 0x88, 0xE4, 0x1B, // S2
    ...
    0x80, 0x25, 0xDF, 0x2F, 0x2D, 0x3C, // M1
    0xA0, 0xF9, 0x3E, 0xAD, 0x60, 0x1C, // M2
    0x5E, 0x45, 0xDE, 0xFC, 0x86, 0xD7, // S1
    0x3A, 0x7A, 0xFD, 0xD3, 0x43, 0xF1, // S2

    0xB9, 0x21, 0xAE, 0xC9, 0x11, 0x76, // M1
    0x5D, 0x9D, 0xD0, 0x3B, 0x6F, 0x7A, // M2
    0x80, 0xD7, 0x8A, 0x3F, 0x8E, 0xB5, // S1
    0x8B, 0x52, 0xFE, 0xA7, 0xC0, 0x3C, // S2

    0x12, 0x28, 0x21, 0x01, 0xC3, 0x61, // M1
    0xE1, 0x8E, 0x0F, 0x72, 0xA0, 0x42, // M2
    0x1C, 0x3B, 0xB6, 0x3A, 0x24, 0x9F, // S1
    0x13, 0xFD, 0x7C, 0x1A, 0xB4, 0x63, // S2

    0xC2, 0xA7, 0xE1, 0x72, 0x70, 0xEC, // M1
    0x35, 0x2A, 0x50, 0x0D, 0x93, 0x8D, // M2
    0xC0, 0x70, 0x93, 0xA4, 0x45, 0x4E, // S1
    0xA9, 0xBA, 0xED, 0xBF, 0xDB, 0x6E, // S2

    0x57, 0xD5, 0xD7, 0x19, 0x3F, 0x10, // M1
    0x9B, 0x7A, 0x20, 0x65, 0xC3, 0x3B, // M2
    0x59, 0xCA, 0x72, 0xFC, 0x35, 0xE8, // S1
    0x33, 0x9F, 0x77, 0x9B, 0x85, 0xAE, // S2

    0x79, 0xD4, 0xF9, 0x0B, 0x38, 0x5E, // M1
    0xE6, 0x02, 0x36, 0x72, 0xAB, 0x35, // M2
    0xF8, 0xB8, 0x30, 0xB2, 0x06, 0x5F, // S1
    0xB7, 0x9A, 0x36, 0xE2, 0xE2, 0x46, // S2
...
BYTE code tQC_DDITHER_CRCTABLE_5K3K_4[] =
{
    0x09, 0xA8, 0xB0, 0xA3, 0xA4, 0xE5, // M1
    0x16, 0x26, 0x69, 0xC2, 0x84, 0xCE, // M2
    0x4D, 0x9D, 0x5C, 0x94, 0xBC, 0xC0, // S1
    0x88, 0xF1, 0xE4, 0xCD, 0x77, 0xD6, // S2

    0xD1, 0xFD, 0xF6, 0x0E, 0x36, 0x7D, // M1
    0x53, 0x3E, 0xDB, 0xCC, 0x7D, 0x17, // M2
    0xB0, 0xC8, 0xC1, 0x48, 0x6B, 0xC2, // S1
    0x78, 0x91, 0x19, 0x7B, 0xF5, 0x11, // S2

    0x63, 0x63, 0x36, 0x69, 0x48, 0x8B, // M1
    0xEC, 0xE1, 0x8B, 0x56, 0x39, 0x06, // M2
    0xF6, 0x33, 0xDE, 0x34, 0x96, 0x3F, // S1
    0xBD, 0xDE, 0x6A, 0x31, 0xEA, 0x9D, // S2

    0xCD, 0x04, 0x86, 0x4D, 0x3B, 0x38, // M1
    0x49, 0x78, 0x08, 0xE6, 0xF4, 0xC4, // M2
    0x0F, 0x55, 0xDC, 0x05, 0x34, 0x28, // S1
    0x11, 0x4C, 0x18, 0x0B, 0x23, 0xF9, // S2

    0x56, 0x91, 0xCF, 0x15, 0x35, 0x9D, // M1
    0x94, 0x90, 0xEF, 0xEB, 0x8E, 0xD0, // M2
    0xDD, 0x80, 0x2F, 0xC0, 0xAB, 0x4D, // S1
    0x94, 0xBD, 0xD0, 0xCD, 0xC7, 0x96, // S2

    0xC1, 0xB0, 0xBA, 0x94, 0x7D, 0x46, // M1
    0xA1, 0xD6, 0x90, 0x73, 0xBE, 0xEE, // M2
    0x6F, 0x9E, 0x8E, 0xFD, 0xAA, 0xF0, // S1
    0xCF, 0x1C, 0x3C, 0xB2, 0x48, 0xFF, // S2

    0xF1, 0xC8, 0xFE, 0x3C, 0x4F, 0xC8, // M1
    0xFA, 0x78, 0xC8, 0x8E, 0xE5, 0xE9, // M2
    0x02, 0x1C, 0xB5, 0x95, 0xA0, 0x9C, // S1
    0xFC, 0x09, 0xD4, 0xEA, 0x33, 0xB9, // S2

    0x42, 0x1D, 0xE6, 0xD8, 0xAF, 0xCE, // M1
    0x7D, 0x78, 0xD0, 0x41, 0x10, 0x27, // M2
    0xBC, 0x34, 0x36, 0xC0, 0x6C, 0xD1, // S1
    0xFE, 0x12, 0x0D, 0xA9, 0x33, 0x46, // S2

    0x01, 0x05, 0x51, 0x54, 0xA3, 0x17, // M1
    0x9D, 0x52, 0x32, 0x02, 0xBE, 0xFA, // M2
    0x65, 0x9C, 0x55, 0xAD, 0x00, 0x77, // S1
    0x45, 0xF9, 0xAE, 0xBA, 0x85, 0x9E, // S2

    0x14, 0x6E, 0x46, 0xB7, 0x57, 0x0E, // M1
    0x28, 0x98, 0x24, 0x1C, 0x95, 0xB3, // M2
    0x02, 0x34, 0x4A, 0x80, 0x53, 0xFF, // S1
    0xD6, 0xA8, 0x6F, 0x4C, 0xDE, 0xDF, // S2

    0x9F, 0x33, 0xD1, 0x16, 0xAD, 0xBF, // M1
    0xCB, 0x3B, 0xF5, 0x32, 0x71, 0xF2, // M2
    0x51, 0xBA, 0xF5, 0x14, 0xD8, 0xB6, // S1
    0x5F, 0xE1, 0x08, 0x14, 0x6C, 0x0C, // S2

    0x30, 0x78, 0xD9, 0xD1, 0x5B, 0x23, // M1
    0x48, 0x8E, 0x41, 0x74, 0xD6, 0x54, // M2
    0xD2, 0x00, 0xEF, 0xD0, 0x4D, 0xB7, // S1
    0x70, 0x38, 0xB9, 0x44, 0xC3, 0x55, // S2

    0x5D, 0x80, 0xD1, 0xDE, 0xC3, 0x55, // M1
    0xA6, 0x05, 0x02, 0xDF, 0x59, 0xF5, // M2
    0x9E, 0x0D, 0x98, 0x01, 0x8C, 0xF1, // S1
    0x57, 0x3E, 0x25, 0x5B, 0xE2, 0xE5, // S2

    0x30, 0x9C, 0x4E, 0x7E, 0x4C, 0xE7, // M1
    0x8D, 0xA2, 0xA7, 0x60, 0x5C, 0xDB, // M2
    0x64, 0xCC, 0x49, 0xE8, 0x2E, 0x3A, // S1
    0x06, 0x68, 0x3F, 0x90, 0xE1, 0x2F, // S2

    0x1C, 0xAC, 0x1C, 0x1E, 0x61, 0x64, // M1
    0x09, 0xE4, 0x08, 0xC6, 0x69, 0xCB, // M2
    0x16, 0x14, 0x9F, 0x5D, 0xEE, 0x7C, // S1
    0x34, 0x3D, 0x22, 0x77, 0x40, 0xA2, // S2

    0x63, 0x7D, 0xFF, 0x99, 0x34, 0x0A, // M1
    0x7A, 0x56, 0xAD, 0x74, 0x7C, 0x72, // M2
    0x64, 0x1B, 0x9C, 0x1C, 0xD5, 0x52, // S1
    0x81, 0xC2, 0x80, 0x23, 0x37, 0x61, // S2

    0xF6, 0x19, 0x72, 0x46, 0x39, 0x6E, // M1
    0x8F, 0x35, 0x34, 0xF9, 0x38, 0x29, // M2
    0x63, 0x76, 0xCA, 0x46, 0x7D, 0x8F, // S1
    0x14, 0xA6, 0x4D, 0x98, 0x25, 0x99, // S2

    0xBA, 0xB6, 0xDE, 0xD1, 0x6A, 0x33, // M1
    0xA4, 0xE5, 0x75, 0x1F, 0xB1, 0x88, // M2
    0x96, 0x52, 0x4E, 0x90, 0x1F, 0xB2, // S1
    0x48, 0x0C, 0x25, 0xF4, 0x1F, 0xF5, // S2

    0x55, 0xAD, 0xB8, 0x34, 0xB7, 0xDA, // M1
    0x72, 0x4E, 0x3E, 0x19, 0xE1, 0x80, // M2
    0x00, 0x3C, 0x82, 0xBA, 0xDE, 0x61, // S1
    0x21, 0x86, 0x77, 0x95, 0x76, 0xE7, // S2

    0x53, 0x96, 0xAB, 0x76, 0x3F, 0xE6, // M1
    0x16, 0x1D, 0x74, 0x37, 0x64, 0x0B, // M2
    0x6B, 0x5C, 0x11, 0xB3, 0x16, 0x7C, // S1
    0x18, 0x4C, 0x94, 0xEA, 0xC0, 0xAF, // S2

    0x6E, 0xB0, 0xDF, 0x47, 0x78, 0x28, // M1
    0xDB, 0x79, 0x90, 0x09, 0xDF, 0xF4, // M2
    0x8E, 0x7F, 0xD4, 0x13, 0xC9, 0xF1, // S1
    0xA0, 0xA3, 0x84, 0xCF, 0xDE, 0xB2, // S2

    0x94, 0x0F, 0x07, 0xE9, 0x15, 0x72, // M1
    0x1D, 0x7D, 0xCB, 0xD6, 0x42, 0x2D, // M2
    0x20, 0x99, 0xAE, 0x84, 0x03, 0x76, // S1
    0xE7, 0xAE, 0xA3, 0xF8, 0xF4, 0xCE, // S2

    0xFE, 0x55, 0xB5, 0xF1, 0x6E, 0x6E, // M1
    0x4C, 0xB5, 0x03, 0xB6, 0x39, 0xCE, // M2
    0x9F, 0xCA, 0xF2, 0x81, 0x71, 0x24, // S1
    0x60, 0xF8, 0x44, 0x50, 0x00, 0x24, // S2

    0x99, 0x14, 0x68, 0x00, 0x4E, 0x36, // M1
    0xCA, 0x4D, 0x3C, 0x5F, 0xD2, 0x26, // M2
    0xFC, 0x1F, 0x4E, 0x3B, 0xEA, 0x7C, // S1
    0x87, 0x4E, 0x31, 0xEE, 0x04, 0x56, // S2

    0xD5, 0x85, 0x37, 0xC0, 0x44, 0xED, // M1
    0xB8, 0x16, 0x50, 0x0B, 0xA5, 0x6F, // M2
    0x3A, 0x40, 0x0C, 0xB9, 0x13, 0xD9, // S1
    0xF7, 0x82, 0x05, 0xB4, 0x71, 0x2C, // S2

    0xE1, 0x6B, 0xBA, 0xE4, 0x0B, 0x38, // M1
    0x3D, 0x50, 0x62, 0x43, 0x3F, 0xF0, // M2
    0x05, 0x01, 0x0A, 0x05, 0xDB, 0x1A, // S1
    0xE2, 0x75, 0x0F, 0xDC, 0xC5, 0x05, // S2

    0x26, 0x73, 0xCF, 0x99, 0xCD, 0xB1, // M1
    0xE6, 0x91, 0x31, 0x21, 0x19, 0x62, // M2
    0x70, 0xC5, 0xA8, 0x6D, 0xD5, 0x39, // S1
    0x5F, 0x3F, 0x5B, 0x81, 0x9A, 0xC0, // S2

    0x17, 0x36, 0xB1, 0x8F, 0xA2, 0x96, // M1
    0x82, 0x49, 0x68, 0x83, 0x8F, 0x25, // M2
    0x5E, 0xC7, 0x4B, 0x8F, 0x96, 0x87, // S1
    0x66, 0xB7, 0x0F, 0x00, 0xC5, 0xE3, // S2

    0xCF, 0xD6, 0x19, 0xF4, 0xC5, 0x36, // M1
    0xE1, 0x1B, 0x46, 0x9D, 0x05, 0xD8, // M2
    0xDA, 0x3D, 0xC5, 0x82, 0x12, 0x35, // S1
    0x26, 0x5A, 0x54, 0x75, 0x58, 0x43, // S2

    0x9D, 0x13, 0x36, 0xA7, 0xF6, 0x21, // M1
    0x0B, 0xF2, 0x2A, 0x49, 0x73, 0x9F, // M2
    0xC5, 0x66, 0xF2, 0x18, 0xFF, 0xBB, // S1
    0x33, 0xA7, 0x2D, 0xD3, 0xC7, 0x7D, // S2

    0xAE, 0x65, 0x07, 0xEE, 0x90, 0xB2, // M1
    0x27, 0xE0, 0x47, 0xEE, 0xB9, 0x8C, // M2
    0x74, 0x2B, 0x4A, 0xD7, 0xF1, 0x71, // S1
    0xEC, 0x87, 0xD8, 0x9B, 0xFB, 0x72, // S2

    0x36, 0x77, 0xA4, 0xBC, 0x69, 0x81, // M1
    0xC9, 0x71, 0xB2, 0x54, 0x63, 0x96, // M2
    0xFF, 0x52, 0x8F, 0x7A, 0x3A, 0xD0, // S1
    0x50, 0xFD, 0xEE, 0x46, 0xAC, 0x26, // S2

    0x44, 0xF8, 0xE4, 0xB5, 0x46, 0x26, // M1
    0xF6, 0xD0, 0xD2, 0xA5, 0xEA, 0xE1, // M2
    0x61, 0x27, 0x0F, 0x36, 0x42, 0xEB, // S1
    0x4A, 0xA9, 0xE1, 0x8A, 0xD8, 0x77, // S2

    0x9B, 0x3D, 0x50, 0xB3, 0x57, 0x0B, // M1
    0x98, 0x89, 0x80, 0xB3, 0x53, 0x8C, // M2
    0x6F, 0x3F, 0x9D, 0x1F, 0x2B, 0x2E, // S1
    0x99, 0x61, 0xBD, 0x37, 0x37, 0x80, // S2

    0x75, 0xDE, 0x26, 0x99, 0x88, 0x99, // M1
    0x99, 0xC7, 0xD1, 0x0E, 0xBE, 0xCA, // M2
    0x10, 0xD5, 0xA0, 0xA1, 0x3C, 0x29, // S1
    0x86, 0xFF, 0x34, 0x6A, 0x2B, 0xC2, // S2

    0x22, 0x6A, 0x1D, 0x5F, 0x21, 0x3E, // M1
    0x9E, 0x1E, 0x0C, 0xC6, 0xD4, 0xA3, // M2
    0x84, 0x76, 0x16, 0x87, 0xDF, 0x57, // S1
    0x98, 0x7B, 0xB5, 0x05, 0xFD, 0x75, // S2

    0x20, 0x0E, 0xB2, 0x46, 0x3D, 0x0C, // M1
    0x59, 0x87, 0x04, 0x7F, 0x56, 0x8A, // M2
    0x55, 0x9C, 0xD7, 0x6D, 0xA4, 0xC5, // S1
    0xCC, 0x75, 0x9C, 0x83, 0x28, 0x31, // S2

    0xCC, 0xA2, 0x7E, 0xB0, 0x4B, 0x67, // M1
    0xA5, 0x7B, 0x0A, 0x26, 0x03, 0xE1, // M2
    0x88, 0xA5, 0xE8, 0x1F, 0xA0, 0xB4, // S1
    0xBD, 0x3D, 0x5C, 0x86, 0x19, 0x81, // S2

    0x08, 0xC2, 0x8E, 0x78, 0x27, 0xFB, // M1
    0x33, 0xBA, 0x11, 0x36, 0x67, 0x65, // M2
    0xEC, 0x9F, 0x44, 0xEB, 0x45, 0xFE, // S1
    0x43, 0x54, 0xE4, 0xC6, 0xE3, 0xEF, // S2

    0xFA, 0xBC, 0x36, 0x0A, 0x3E, 0x25, // M1
    0x01, 0x2D, 0xF0, 0xF0, 0xC2, 0xD8, // M2
    0xC0, 0x0E, 0x7C, 0x31, 0x09, 0x9F, // S1
    0x66, 0x1F, 0x11, 0x82, 0x73, 0xB0, // S2

    0x44, 0xC7, 0x9C, 0x42, 0xB4, 0xD6, // M1
    0x12, 0xDC, 0xE9, 0x1A, 0x0C, 0xA4, // M2
    0x67, 0xE6, 0xF6, 0x66, 0x75, 0x02, // S1
    0xA7, 0xF0, 0xFC, 0xB6, 0x39, 0xEE, // S2

    0xD3, 0x82, 0x84, 0xF9, 0xEE, 0x6A, // M1
    0xF0, 0x32, 0xC0, 0xFF, 0xE6, 0x18, // M2
    0x39, 0x91, 0xAB, 0x76, 0x8C, 0x14, // S1
    0x59, 0x27, 0x2C, 0x6F, 0xFB, 0x5E, // S2

    0xE1, 0x9E, 0x69, 0xEE, 0x77, 0x55, // M1
    0xE0, 0x2C, 0x5F, 0x81, 0x56, 0xDB, // M2
    0x87, 0xC3, 0x93, 0xDD, 0x95, 0x3C, // S1
    0x1D, 0x91, 0x97, 0x9F, 0x9B, 0xF2, // S2

    0x29, 0x58, 0xED, 0x41, 0x10, 0xF6, // M1
    0x5E, 0x0D, 0xFE, 0x50, 0x18, 0x78, // M2
    0x7F, 0xCB, 0xF2, 0xCE, 0x35, 0xEE, // S1
    0xA4, 0x0C, 0xD8, 0x2D, 0xF6, 0x29, // S2

    0xBF, 0x12, 0xF4, 0x24, 0x03, 0x1F, // M1
    0x9E, 0xAA, 0x20, 0x49, 0x95, 0x5D, // M2
    0x4F, 0xD8, 0x44, 0xDC, 0x5E, 0x5C, // S1
    0x78, 0x75, 0xA4, 0xE1, 0xDF, 0x91, // S2

    0xAF, 0x62, 0xA6, 0x7A, 0x15, 0x23, // M1
    0x80, 0xB9, 0x4F, 0x86, 0x73, 0x8E, // M2
    0xC8, 0x1C, 0x7C, 0x72, 0x22, 0xBF, // S1
    0x28, 0x44, 0x64, 0x2D, 0x07, 0xDF, // S2

    0x35, 0xC4, 0x87, 0x85, 0xBE, 0x04, // M1
    0x81, 0x57, 0xC0, 0x11, 0xA0, 0x1F, // M2
    0x67, 0xC5, 0xFC, 0x4F, 0xC0, 0x33, // S1
    0xA6, 0x1F, 0x43, 0xC8, 0x24, 0x19, // S2

    0x49, 0xDF, 0x9E, 0xD2, 0x06, 0xC3, // M1
    0x9D, 0xDA, 0x46, 0xA0, 0x99, 0xC2, // M2
    0xA1, 0xBB, 0x57, 0xD3, 0xE0, 0xCE, // S1
    0x7C, 0x5D, 0xB7, 0xA2, 0xAA, 0x45, // S2
...
BYTE code tQC_DDITHER_CRCTABLE_5K3K_5[] =
{
    0xF2, 0x73, 0x45, 0x58, 0xAE, 0x14, // M1
    0x28, 0x76, 0x0C, 0xB7, 0xBE, 0x70, // M2
    0x96, 0x0D, 0x6C, 0xDE, 0xF1, 0xA8, // S1
    0xCA, 0x66, 0xAC, 0xB0, 0xCA, 0x07, // S2
    ...
    0xCA, 0xA6, 0xF5, 0x0D, 0xBF, 0x14, // M1
    0x8A, 0x6F, 0x0A, 0x03, 0x63, 0x72, // M2
    0xE9, 0xBC, 0xDD, 0x2A, 0xEB, 0xE8, // S1
    0xBE, 0xAF, 0xF3, 0x80, 0xFE, 0x96, // S2
...
BYTE code tQC_DDITHER_CRCTABLE_5K3K_6[] =
{
    0xBD, 0xF4, 0xB3, 0xEA, 0x38, 0x3A, // M1
    0xF7, 0x57, 0x97, 0xCF, 0x71, 0x4F, // M2
    0x2B, 0xDE, 0x81, 0xC5, 0x70, 0xE6, // S1
    0xFE, 0xEE, 0x38, 0xF4, 0xDD, 0x20, // S2
    ...
    0xF0, 0xBD, 0xEA, 0x72, 0xA5, 0x97, // M1
    0xA7, 0x45, 0x75, 0xDE, 0x4C, 0xCA, // M2
    0x7F, 0x89, 0xA1, 0x2C, 0x37, 0xC5, // S1
    0x56, 0x39, 0x2F, 0x0B, 0x3D, 0xE3, // S2
...
BYTE code tQC_DDITHER_CRCTABLE_5K3K_7[] =
{
    0xE7, 0xE6, 0x66, 0x9B, 0xBF, 0xDC, // M1
    0x7E, 0x77, 0x6F, 0xD9, 0x05, 0xA5, // M2
    0xD5, 0xD7, 0x6C, 0x9A, 0xF3, 0x58, // S1
    0x92, 0x06, 0xC2, 0xB3, 0xC0, 0x36, // S2
};
#endif
//--------------------------------------------------
...
#if(_QC_5K3K_MODE_ == _ON)
BYTE code tQC_5K3KRGBGAMMA_CRCTable_1[] =
{
    0xD0, 0xD0, 0xAF, 0xFC, 0x3D, 0x92, // M1
    0x6A, 0x62, 0xCF, 0x28, 0x22, 0xB4, // M2
    0xBE, 0xAF, 0x94, 0x20, 0x98, 0x5A, // S1
    0xB5, 0x78, 0x1D, 0x40, 0x4A, 0x37, // S2
};

BYTE code tQC_5K3KRGBGAMMA_CRCTable_2[] =
{
    0xC8, 0x55, 0x75, 0xD2, 0x74, 0xC1, // M1
    0xD5, 0x22, 0x47, 0x26, 0x4C, 0x2F, // M2
    0x4C, 0x68, 0x94, 0x30, 0x95, 0xB9, // S1
    0x17, 0x0A, 0x41, 0x43, 0x64, 0x40, // S2
};

BYTE code tQC_5K3KRGBGAMMA_CRCTable_3[] =
{
    0x79, 0xDA, 0x83, 0x0E, 0x89, 0x15, // M1
    0x1A, 0xD1, 0xBF, 0xEE, 0x86, 0x7C, // M2
    0xB5, 0xFC, 0x7A, 0x32, 0x2B, 0xC0, // S1
    0xAE, 0xCA, 0x85, 0x64, 0x61, 0x9D, // S2
};
#endif
...
#if(_QC_5K3K_MODE_ == _ON)
bit ScalerQC5K3KSHPTest(void);
bit ScalerQC5K3KDDomainColorConvTest(BYTE ucDispMode);
bit ScalerQC5K3KRGBGammaTest(void);
bit ScalerQC5K3KDDitherTest(void);
#endif
...
bit ScalerQCDDitherTest(void)
{
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DDITHER_CRCTABLE_0, sizeof(tQC_DDITHER_CRCTABLE_0) / 18) << 0);
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DDITHER_CRCTABLE_1, sizeof(tQC_DDITHER_CRCTABLE_1) / 18) << 1);
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DDITHER_CRCTABLE_2, sizeof(tQC_DDITHER_CRCTABLE_2) / 18) << 2);
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DDITHER_CRCTABLE_3, sizeof(tQC_DDITHER_CRCTABLE_3) / 18) << 3);
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DDITHER_CRCTABLE_4, sizeof(tQC_DDITHER_CRCTABLE_4) / 18) << 4);
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DDITHER_CRCTABLE_5, sizeof(tQC_DDITHER_CRCTABLE_5) / 18) << 5);
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DDITHER_CRCTABLE_6, sizeof(tQC_DDITHER_CRCTABLE_6) / 18) << 6);
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DDITHER_CRCTABLE_7, sizeof(tQC_DDITHER_CRCTABLE_7) / 18) << 7);
...
bit ScalerQC5K3KSHPTest(void)
{
    ...
    DebugMessageQC("5. 5k3k 1P SHP Start", 0x00);
    ScalerQCDDomainRandomGenOn(_MASS, _BIT_MODE_10);
    ...
    //0.SHP HLW off
    DebugMessageQC("5. Mode_0", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_BEFORE_PIPBLENDING, _M1 | _M2 | _S1 | _S2, tSHP_5K3K1P_Table0, 1) << 0);
    ...
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_12_HLW_SETSEL1 , ~(_BIT1 | _BIT0), _BIT1);
    DebugMessageQC("5. Mode_1", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_BEFORE_PIPBLENDING, _M1 | _M2 | _S1 | _S2, tSHP_5K3K1P_Table1, 1) << 1);
    ...
    DebugMessageQC("5. 5k3k 1P SHP End", 0x00);

    if(ucData == _TEST_PASS)
    {
        DebugMessageQC("6.====D Random 5k3k 1P SHP PASS====", 0x00);
        return _TEST_PASS;
    }
    else
    {
        DebugMessageQC("6.====D Random 5k3k 1P SHP Fail====", 0x00);
        return _TEST_FAIL;
    }
}

//--------------------------------------------------
// Description  : Color Conversion Test Test 5K3K Case
// Input Value  : None
// Output Value : _TEST_PASS or _TEST_FAIL
//--------------------------------------------------
bit ScalerQC5K3KDDomainColorConvTest(BYTE ucDispMode)
{
    ...
    // YCbCr -> RGB                                                   //
    ////////////////////////////////////////////////////////////////////
    DebugMessageQC("5. D-Domain Color Conversion 5K3K Start", ucDispMode);
    ...
    //////////////////////////////////////////////////////////////////
    // case 0: YUV->RGB, ITU601
    ScalerBurstWrite(tQC_CONV_YUV2RGB_ITU601, sizeof(tQC_CONV_YUV2RGB_ITU601), GET_CURRENT_BANK_NUMBER(), P14_A2_SR_YCC2RGB_COEF_K11_MSB, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerBurstWrite(tQC_CONV_YUV2RGB_ITU601, sizeof(tQC_CONV_YUV2RGB_ITU601), GET_CURRENT_BANK_NUMBER(), P94_A2_SR_YCC2RGB_COEF_K11_MSB_S1, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerSetBit(P14_A1_SR_YCC2RGB_CTRL, ~(_BIT5 | _BIT4 | _BIT2 | _BIT1), (_BIT2 | _BIT1));
    ScalerSetBit(P94_A1_SR_YCC2RGB_CTRL_S1, ~(_BIT5 | _BIT4 | _BIT2 | _BIT1), (_BIT2 | _BIT1));

    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);

    DebugMessageQC("5. 5K3K Color Conv case", 0x02);
    ucResult = ucResult | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1|_M2|_S1|_S2, &tDCOLORCONV_CRC_TABLE_0_5K3K[ucShift], 1) << 2);

    //////////////////////////////////////////////////////////////////
    // case 1: YUV->RGB, ITU709
    ScalerBurstWrite(tQC_CONV_YUV2RGB_ITU709, sizeof(tQC_CONV_YUV2RGB_ITU709), GET_CURRENT_BANK_NUMBER(), P14_A2_SR_YCC2RGB_COEF_K11_MSB, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerBurstWrite(tQC_CONV_YUV2RGB_ITU709, sizeof(tQC_CONV_YUV2RGB_ITU709), GET_CURRENT_BANK_NUMBER(), P94_A2_SR_YCC2RGB_COEF_K11_MSB_S1, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerSetBit(P14_A1_SR_YCC2RGB_CTRL, ~(_BIT5 | _BIT4 | _BIT2 | _BIT1), (_BIT2 | _BIT1));
    ScalerSetBit(P94_A1_SR_YCC2RGB_CTRL_S1, ~(_BIT5 | _BIT4 | _BIT2 | _BIT1), (_BIT2 | _BIT1));
    ...
    DebugMessageQC("5. 5K3K Color Conv case", 0x03);
    ucResult = ucResult | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1|_M2|_S1|_S2, &tDCOLORCONV_CRC_TABLE_1_5K3K[ucShift], 1) << 3);

    //////////////////////////////////////////////////////////////////
    // case 2: YUV->RGB, ITU709_RGBLIMIT
    ScalerBurstWrite(tQC_CONV_YUV2RGB_ITU709_RGBLIMIT, sizeof(tQC_CONV_YUV2RGB_ITU709_RGBLIMIT), GET_CURRENT_BANK_NUMBER(), P14_A2_SR_YCC2RGB_COEF_K11_MSB, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerBurstWrite(tQC_CONV_YUV2RGB_ITU709_RGBLIMIT, sizeof(tQC_CONV_YUV2RGB_ITU709_RGBLIMIT), GET_CURRENT_BANK_NUMBER(), P94_A2_SR_YCC2RGB_COEF_K11_MSB_S1, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerSetBit(P14_A1_SR_YCC2RGB_CTRL, ~(_BIT5 | _BIT4 | _BIT2 | _BIT1), (_BIT2 | _BIT1));
    ScalerSetBit(P94_A1_SR_YCC2RGB_CTRL_S1, ~(_BIT5 | _BIT4 | _BIT2 | _BIT1), (_BIT2 | _BIT1));
    ...
    DebugMessageQC("5. 5K3K Color Conv case", 0x04);
    ucResult = ucResult | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1|_M2|_S1|_S2, &tDCOLORCONV_CRC_TABLE_2_5K3K[ucShift], 1) << 4);

    //////////////////////////////////////////////////////////////////
    // case 3: YUV->RGB, ITU601_YUVFULL
    ScalerBurstWrite(tQC_CONV_YUV2RGB_ITU601_YUVFULL, sizeof(tQC_CONV_YUV2RGB_ITU601_YUVFULL), GET_CURRENT_BANK_NUMBER(), P14_A2_SR_YCC2RGB_COEF_K11_MSB, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerBurstWrite(tQC_CONV_YUV2RGB_ITU601_YUVFULL, sizeof(tQC_CONV_YUV2RGB_ITU601_YUVFULL), GET_CURRENT_BANK_NUMBER(), P94_A2_SR_YCC2RGB_COEF_K11_MSB_S1, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerSetBit(P14_A1_SR_YCC2RGB_CTRL, ~(_BIT5 | _BIT4 | _BIT2 | _BIT1), _BIT2);
    ScalerSetBit(P94_A1_SR_YCC2RGB_CTRL_S1, ~(_BIT5 | _BIT4 | _BIT2 | _BIT1), _BIT2);

    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);

    DebugMessageQC("5. 5K3K Color Conv case", 0x05);
    ucResult = ucResult | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1|_M2|_S1|_S2, &tDCOLORCONV_CRC_TABLE_3_5K3K[ucShift], 1) << 5);

    //////////////////////////////////////////////////////////////////
    // case 4: YUV->RGB, ITU709_YUVFULL
    ScalerBurstWrite(tQC_CONV_YUV2RGB_ITU709_YUVFULL, sizeof(tQC_CONV_YUV2RGB_ITU709_YUVFULL), GET_CURRENT_BANK_NUMBER(), P14_A2_SR_YCC2RGB_COEF_K11_MSB, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerBurstWrite(tQC_CONV_YUV2RGB_ITU709_YUVFULL, sizeof(tQC_CONV_YUV2RGB_ITU709_YUVFULL), GET_CURRENT_BANK_NUMBER(), P94_A2_SR_YCC2RGB_COEF_K11_MSB_S1, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerSetBit(P14_A1_SR_YCC2RGB_CTRL, ~(_BIT5 | _BIT4 | _BIT2 | _BIT1), _BIT2);
    ScalerSetBit(P94_A1_SR_YCC2RGB_CTRL_S1, ~(_BIT5 | _BIT4 | _BIT2 | _BIT1), _BIT2);
    ...
    DebugMessageQC("5. 5K3K Color Conv case", 0x06);
    ucResult = ucResult | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1|_M2|_S1|_S2, &tDCOLORCONV_CRC_TABLE_4_5K3K[ucShift], 1) << 6);

    //////////////////////////////////////////////////////////////////
    // case 5: YUV->RGB, bypass
    ScalerBurstWrite(tQC_CONV_YUV2RGB_ITU709_YUVFULL, sizeof(tQC_CONV_YUV2RGB_ITU709_YUVFULL), GET_CURRENT_BANK_NUMBER(), P14_A2_SR_YCC2RGB_COEF_K11_MSB, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerBurstWrite(tQC_CONV_YUV2RGB_ITU709_YUVFULL, sizeof(tQC_CONV_YUV2RGB_ITU709_YUVFULL), GET_CURRENT_BANK_NUMBER(), P94_A2_SR_YCC2RGB_COEF_K11_MSB_S1, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerSetBit(P14_A1_SR_YCC2RGB_CTRL, ~(_BIT5 | _BIT4 | _BIT2 | _BIT1), (_BIT4));
    ScalerSetBit(P94_A1_SR_YCC2RGB_CTRL_S1, ~(_BIT5 | _BIT4 | _BIT2 | _BIT1), (_BIT4));

    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);

    DebugMessageQC("5. 5K3K Color Conv case", 0x07);
    ucResult = ucResult | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1|_M2|_S1|_S2, &tDCOLORCONV_CRC_TABLE_5_5K3K[ucShift], 1) << 7);

    //////////////////////////////////////////////////////////////////
    // case 6: YUV->RGB, BT2020 Non-Constant
    ScalerBurstWrite(tQC_CONV_YUV2RGB_ITUBT2020_NON_CONSTANT, sizeof(tQC_CONV_YUV2RGB_ITUBT2020_NON_CONSTANT), GET_CURRENT_BANK_NUMBER(), P14_A2_SR_YCC2RGB_COEF_K11_MSB, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerBurstWrite(tQC_CONV_YUV2RGB_ITUBT2020_NON_CONSTANT, sizeof(tQC_CONV_YUV2RGB_ITUBT2020_NON_CONSTANT), GET_CURRENT_BANK_NUMBER(), P94_A2_SR_YCC2RGB_COEF_K11_MSB_S1, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerSetBit(P14_A1_SR_YCC2RGB_CTRL, ~(_BIT5 | _BIT4 | _BIT2 | _BIT1), (_BIT2 | _BIT1));
    ScalerSetBit(P94_A1_SR_YCC2RGB_CTRL_S1, ~(_BIT5 | _BIT4 | _BIT2 | _BIT1), (_BIT2 | _BIT1));
    ...
    DebugMessageQC("5. 5K3K Color Conv case", 0x07);
    ucResult = ucResult | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1|_M2|_S1|_S2, &tDCOLORCONV_CRC_TABLE_6_5K3K[ucShift], 1) << 7);

    //////////////////////////////////////////////////////////////////
    // case 7: YUV->RGB, BT2020 Constant
    ScalerBurstWrite(tQC_CONV_YUV2RGB_ITUBT2020_CONSTANT, sizeof(tQC_CONV_YUV2RGB_ITUBT2020_CONSTANT), GET_CURRENT_BANK_NUMBER(), P14_A2_SR_YCC2RGB_COEF_K11_MSB, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerBurstWrite(tQC_CONV_YUV2RGB_ITUBT2020_CONSTANT, sizeof(tQC_CONV_YUV2RGB_ITUBT2020_CONSTANT), GET_CURRENT_BANK_NUMBER(), P94_A2_SR_YCC2RGB_COEF_K11_MSB_S1, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerSetBit(P14_A1_SR_YCC2RGB_CTRL, ~(_BIT5 | _BIT4 | _BIT2 | _BIT1), (_BIT5 | _BIT2 | _BIT1));
    ScalerSetBit(P94_A1_SR_YCC2RGB_CTRL_S1, ~(_BIT5 | _BIT4 | _BIT2 | _BIT1), (_BIT5 | _BIT2 | _BIT1));

    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);

    DebugMessageQC("5. 5K3K Color Conv case", 0x07);
    ucResult = ucResult | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1|_M2|_S1|_S2, &tDCOLORCONV_CRC_TABLE_7_5K3K[ucShift], 1) << 7);

    ScalerQCDDomainPatternGenOff();

 // Disable YUV2RGB conversion
    ScalerSetByte(P14_A1_SR_YCC2RGB_CTRL, 0x00);
    ScalerSetByte(P94_A1_SR_YCC2RGB_CTRL_S1, 0x00);

    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);

    DebugMessageQC("5. 5K3K D-Domain Color Conversion End", ucDispMode);

    if(ucResult == 0)
    {
        DebugMessageQC("6. 5K3K D-Domain Color Conversion PASS", 0x00);
        return _TEST_PASS;
    }
    else
    {
        DebugMessageQC("6. 5K3K Fail Mode", ucResult);
        DebugMessageQC("6. D-Domain Color Conversion 5K3K FAIL", 0x00);
        return _TEST_FAIL;
    }
...
//--------------------------------------------------
// Description  : 5K3K RGB Gamma Test
// Input Value  : None
// Output Value : _TEST_PASS or _TEST_FAIL
//--------------------------------------------------
bit ScalerQC5K3KRGBGammaTest(void)
{
    ...
    DebugMessageQC("5. 5K3K RGB Gamma Start", 0x00);
    ...
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_0E_HLW_CONTROL0, ~(_BIT5|_BIT4), 0x00); // All
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_11_HLW_SETSEL0, ~(_BIT1|_BIT0), 0x00);  // Inside A, Outside A
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_5K3KRGBGAMMA_CRCTable_1, 1) << 0);

    // Case 2 : IDomainRandomGen(_MASS) + RGB Gamma + D_Domain_CRC + HLW(Inside A, Outside B)
    DebugMessageQC("5. Mode_1", 0x00);
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_11_HLW_SETSEL0, ~(_BIT1|_BIT0), _BIT0); // Inside A, Outside B
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_5K3KRGBGAMMA_CRCTable_2, 1) << 1);

    // Case 3 : IDomainRandomGen(_MASS) + RGB Gamma + D_Domain_CRC + HLW(Inside A, Outside Bypass)
    DebugMessageQC("5. Mode_2", 0x00);
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_0E_HLW_CONTROL0, ~(_BIT5|_BIT4), _BIT4);    // Inside
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_11_HLW_SETSEL0, ~(_BIT1|_BIT0), 0x00);      // Inside A, Outside Bypass
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_5K3KRGBGAMMA_CRCTable_3, 1) << 2);
    ...
    DebugMessageQC("5. 5K3K RGB Gamma End", 0x00);

    if(ucData == 0x00)
    {
        DebugMessageQC("6. 5K3K RGB Gamma PASS", 0x00);
        return _TEST_PASS;
    }
    else
    {
        DebugMessageQC("6. Fail Mode", ucData);
        DebugMessageQC("6. 5K3K RGB Gamma FAIL", 0x00);
        return _TEST_FAIL;
    }
}
...
bit ScalerQC5K3KDDitherTest(void)
{
    ...
    DebugMessageQC("5. 5K3K D Dither Start", 0x00);
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DDITHER_CRCTABLE_5K3K_0, sizeof(tQC_DDITHER_CRCTABLE_5K3K_0) / 24) << 0);
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DDITHER_CRCTABLE_5K3K_1, sizeof(tQC_DDITHER_CRCTABLE_5K3K_1) / 24) << 1);
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DDITHER_CRCTABLE_5K3K_2, sizeof(tQC_DDITHER_CRCTABLE_5K3K_2) / 24) << 2);
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DDITHER_CRCTABLE_5K3K_3, sizeof(tQC_DDITHER_CRCTABLE_5K3K_3) / 24) << 3);
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DDITHER_CRCTABLE_5K3K_4, sizeof(tQC_DDITHER_CRCTABLE_5K3K_4) / 24) << 4);
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DDITHER_CRCTABLE_5K3K_5, sizeof(tQC_DDITHER_CRCTABLE_5K3K_5) / 24) << 5);
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DDITHER_CRCTABLE_5K3K_6, sizeof(tQC_DDITHER_CRCTABLE_5K3K_6) / 24) << 6);
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tQC_DDITHER_CRCTABLE_5K3K_7, sizeof(tQC_DDITHER_CRCTABLE_5K3K_7) / 24) << 7);

    ScalerSetByte(P0_6A_D_DITHER_COMMON_CTRL1, 0x00);
    ScalerQCDDomainPatternGenOff();
    ScalerQCHighlightWindowOff();   // Disable HLW

    DebugMessageQC("5. 5K3K D Dither End", 0x00);

    if(ucData == 0x00)
    {
        DebugMessageQC("6. 5K3K D Dither PASS", 0x00);
        return _TEST_PASS;
    }
    else
    {
        DebugMessageQC("6. Fail Mode", ucData);
        DebugMessageQC("6. 5K3K D Dither FAIL", 0x00);
        return _TEST_FAIL;
    }
}
