...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6410_Series_QC_DSPC.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6410_SERIES_QC_DSPC__
...
4,	_AUTOINC,	0x9F,   0x38,
4,	_AUTOINC,	0x00,   0x10,	//digital phy normal
4,	_AUTOINC,	0x81,   0x32,
4,	_AUTOINC,	0x82,   0x10,
4,	_AUTOINC,	0x83,   0x76,
4,	_AUTOINC,	0x84,   0x54,
4,	_AUTOINC,	0x85,   0xC2,

4,	_AUTOINC,	0x86,   0x98,
4,	_AUTOINC,	0x87,   0x29,
4,	_AUTOINC,	0x88,   0x86,
4,	_AUTOINC,	0x89,   0x62,	//eDP selection not Vby1
/*
// Idle Pattern
...
BYTE code tQCVBY1TX_HBR2_30_FT[] =
{
   //////////////////////////////////////////
    // Enable ADC Bandgap (0x00C6[3])
    //////////////////////////////////////////
...
4,	_AUTOINC,	0xB8,   0xDD,// POST0
4,	_AUTOINC,	0xB9,   0xDD,// POST0
4,	_AUTOINC,	0xBA,   0xDD,// POST0
4,	_AUTOINC,	0xBB,   0xDD,// POST0
...
bit ScalerQCVBY1TXTest2(void);  //FRED ADD
//****************************************************************************
    ...
    else
    {
        ...
        GPIO_RESULT_VBY1_B = 0x00  | ((BYTE)(MCU_FE4D_PORTD5_PIN_REG) << 1) | ((BYTE)(MCU_FE21_PORT81_PIN_REG));   // Pin37,Pin42
         ...
         else
         {
            ...
            DebugMessageQC("Vby1_B HBR2___TEST 3", 0);
            ...
            ScalerBurstWrite(tQCVBY1TX_HBR2_30_FT, sizeof(tQCVBY1TX_HBR2_30_FT), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
            ...
            if(GET_GPIO_RESULT_VBY1_B() == 0x00)
            {
                DebugMessageQC("Vby1_B HBR2___PASS----3", 0);
            }
            else
            {
    ...
    else
    {
        ...
        GPIO_RESULT_VBY1_A = 0x00  | ((BYTE)(MCU_FE1B_PORT73_PIN_REG) << 1) | ((BYTE)(MCU_FE47_PORTC7_PIN_REG));   // Pin37,Pin42
         ...
         else
         {
            ...
            DebugMessageQC("Vby1_A HBR2___TEST 3", 0);
            ...
            if(GET_GPIO_RESULT_VBY1_A() == 0x00)
            {
                DebugMessageQC("Vby1_A HBR2___PASS----3", 0);
            }
            else
            {
