...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6410_Series_QC_Color_DDomain.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6410_SERIES_QC_COLOR_DDOMAIN__
...
BYTE code tDPG_CRC_TABLE_12BIT_5K3K[] = {
    0x28, 0x45, 0x8B, 0xFD, 0x89, 0x7A, // M1
    0x28, 0x45, 0x8B, 0xFD, 0x89, 0x7A, // M2
    0x44, 0xB8, 0xD0, 0xB2, 0x10, 0x19, // S1
    0x44, 0xB8, 0xD0, 0xB2, 0x10, 0x19, // S2
};

BYTE code tDPG_CRC_TABLE_10BIT_5K3K[] = {
    0x28, 0x45, 0x8B, 0x46, 0x96, 0xC1, // M1
    0x28, 0x45, 0x8B, 0x46, 0x96, 0xC1, // M2
    0x44, 0xB8, 0xD0, 0x09, 0x0F, 0xA2, // S1
    0x44, 0xB8, 0xD0, 0x09, 0x0F, 0xA2, // S2
};

BYTE code tDPG_RANDOM_MASS_CRC_TABLE_12BIT_5K3K[] = {
...
BYTE code tDPG_RANDOM_MASS_CRC_TABLE_10BIT_5K3K[] = {
    0xDF, 0x90, 0x0D, 0xD1, 0x47, 0x1B, // M1
    0x35, 0x5B, 0xEA, 0xAA, 0xD0, 0xE9, // M2
    0x4C, 0x3D, 0xF7, 0xA6, 0xD2, 0x3F, // S1
    0x8A, 0x2D, 0x99, 0x6F, 0x4B, 0xC9, // S2
};

BYTE code tDPG_RANDOM_GRAY_CRC_TABLE_12BIT_5K3K[] = {
    0x0E, 0x71, 0xAE, 0x03, 0x16, 0x5E, // M1
    0xEE, 0xA2, 0x40, 0x2C, 0xC8, 0x3B, // M2
    0xB8, 0x3B, 0x86, 0xC8, 0x6A, 0x20, // S1
    0x52, 0x5D, 0x09, 0xD9, 0x8F, 0xAF, // S2
};

BYTE code tDPG_RANDOM_GRAY_CRC_TABLE_10BIT_5K3K[] = {
    0xD1, 0xF9, 0x87, 0x18, 0x4D, 0x87, // M1
    0x9C, 0x16, 0x20, 0x21, 0x69, 0x03, // M2
    0x6E, 0x3D, 0x2E, 0x20, 0x61, 0xD8, // S1
    0xC0, 0x06, 0x61, 0xC1, 0xDC, 0xAB, // S2
};
#endif
...
BYTE code tPCM_5K3K_CRC_MODE0[] =
{
    0x69, 0x41, 0x6C, 0xAA, 0xC7, 0x81, // M1
    0x5C, 0xE6, 0xFE, 0x3D, 0xB6, 0xE6, // M2
    0xF4, 0xB6, 0x1B, 0x27, 0x2A, 0x4E, // S1
    0xBA, 0xE1, 0x87, 0x37, 0x29, 0x2A, // S2
    _END
};

BYTE code tPCM_5K3K_CRC_MODE1[] =
{
    0x72, 0xD0, 0x05, 0xC1, 0x12, 0x4B, // M1
    0x9B, 0x9E, 0x04, 0x74, 0x04, 0x90, // M2
    0x96, 0xDC, 0x2B, 0x88, 0x96, 0x2D, // S1
    0xE1, 0x89, 0x26, 0x80, 0xED, 0x20, // S2
    _END
};
#endif
...
#if(_QC_5K3K_MODE_ == _ON)
bit ScalerQC5K3KDPGTest(void);
bit ScalerQC5K3KDPGRandomTest(void);
bit ScalerQC5K3KPCMTest(void);
#endif
...
bit ScalerQCDPGTest(void)
{
    ...
    ucFlag = ucFlag | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1|_M2|_S1, tDPG_CRC_TABLE, 1) << 0);
...
bit ScalerQCDPGRandomTest(void)
{
    ...
    ucFlag = ucFlag | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1|_M2|_S1, tDPG_RANDOM_CRC_TABLE, 1) << 0);
...
void ScalerQCDDomainPatternGenOn(bit bModeSel)
{
    ...
    ScalerSetByte(P87_FE_DISP_PG_DELTA_L_SUB, 0x00);
...
bit ScalerQC2PDPGTest(void)
{
    ...
    ScalerQCDDomainPatternGenOn(_BIT_MODE_12);
    ucFlag = ucFlag | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1|_M2|_S1, tDPG_CRC_TABLE_12BIT, 1) << 0);

    ScalerQCDDomainPatternGenOn(_BIT_MODE_10);
    ucFlag = ucFlag | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1|_M2|_S1, tDPG_CRC_TABLE_10BIT, 1) << 0);
...
bit ScalerQC2PDPGRandomTest(void)
{
    ...
    ScalerQCDDomainRandomGenOn(_MASS, _BIT_MODE_12);
    ucFlag = ucFlag | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1, tDPG_RANDOM_MASS_CRC_TABLE_12BIT, 1) << 0);

    ScalerQCDDomainRandomGenOn(_GRAY, _BIT_MODE_12);
    ucFlag = ucFlag | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1, tDPG_RANDOM_GRAY_CRC_TABLE_12BIT, 1) << 0);

    ScalerQCDDomainRandomGenOn(_MASS, _BIT_MODE_10);
    ucFlag = ucFlag | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1, tDPG_RANDOM_MASS_CRC_TABLE_10BIT, 1) << 0);

    ScalerQCDDomainRandomGenOn(_GRAY, _BIT_MODE_10);
    ucFlag = ucFlag | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1, tDPG_RANDOM_GRAY_CRC_TABLE_10BIT, 1) << 0);
...
#if(_QC_5K3K_MODE_ == _ON)
//--------------------------------------------------
// Description  : Test D-Domain Pattern Generator 5K3K Case
// Input Value  : None
// Output Value : _TEST_PASS or _TEST_FAIL
//--------------------------------------------------
bit ScalerQC5K3KDPGTest(void)
{
    BYTE ucFlag = 0;
    DebugMessageQC("5. DPG 5K3K Start", 0x00);

    ScalerDDomainBackgroundEnable(_DISABLE);

    ScalerQCDDomainPatternGenOn(_BIT_MODE_12);
    ucFlag = ucFlag | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tDPG_CRC_TABLE_12BIT_5K3K, 1) << 0);

    ScalerQCDDomainPatternGenOn(_BIT_MODE_10);
    ucFlag = ucFlag | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tDPG_CRC_TABLE_10BIT_5K3K, 1) << 1);

    DebugMessageQC("5. DPG 5K3K End", 0x00);

    ScalerQCDDomainPatternGenOff();

    if(ucFlag == _TEST_PASS)
    {
        DebugMessageQC("6.====DPG 5K3K PASS====", 0x00);
        return _TEST_PASS;
    }
    else
    {
        DebugMessageQC("6. Fail Mode", ucFlag);
        DebugMessageQC("6.====DPG 5K3K Fail====", 0x00);
        return _TEST_FAIL;
    }
}

//--------------------------------------------------
// Description  : Test D-Domain Random Generator 5K3K Case
// Input Value  : None
// Output Value : _TEST_PASS or _TEST_FAIL
//--------------------------------------------------
bit ScalerQC5K3KDPGRandomTest(void)
{
    BYTE ucFlag = 0;
    DebugMessageQC("5. D Random PG 5K3K Start", 0x00);

    ScalerDDomainBackgroundEnable(_DISABLE);

    ScalerQCDDomainRandomGenOn(_MASS, _BIT_MODE_12);
    ucFlag = ucFlag | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tDPG_RANDOM_MASS_CRC_TABLE_12BIT_5K3K, 1) << 0);

    ScalerQCDDomainRandomGenOn(_GRAY, _BIT_MODE_12);
    ucFlag = ucFlag | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tDPG_RANDOM_GRAY_CRC_TABLE_12BIT_5K3K, 1) << 1);

    ScalerQCDDomainRandomGenOn(_MASS, _BIT_MODE_10);
    ucFlag = ucFlag | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tDPG_RANDOM_MASS_CRC_TABLE_10BIT_5K3K, 1) << 2);

    ScalerQCDDomainRandomGenOn(_GRAY, _BIT_MODE_10);
    ucFlag = ucFlag | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tDPG_RANDOM_GRAY_CRC_TABLE_10BIT_5K3K, 1) << 3);

    DebugMessageQC("5. D Random PG 5K3K End", 0x00);

    ScalerQCDDomainPatternGenOff();

    if(ucFlag == _TEST_PASS)
    {
        DebugMessageQC("6.====D Random PG 5K3K PASS====", 0x00);
        return _TEST_PASS;
    }
    else
    {
        DebugMessageQC("6. Fail Mode", ucFlag);
        DebugMessageQC("6.====D Random PG 5K3K Fail====", 0x00);
        return _TEST_FAIL;
    }
}

//--------------------------------------------------
// Description  : 5K3K PCM TEST
// Input Value  : None
// return Value : _TEST_PASS or _TEST_FAIL
//--------------------------------------------------
bit ScalerQC5K3KPCMTest(void)
{
    ...
    DebugMessageQC("5. 5K3K PCM Start", 0x00);
    ScalerBurstWrite(tPCM_TEST_SETA, sizeof(tPCM_TEST_SETA), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerBurstWrite(tSRGB_TEST_SETB, sizeof(tSRGB_TEST_SETB), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerBurstWrite(tOG_TEST_SETB, sizeof(tOG_TEST_SETB), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerQCDDomainRandomGenOn(_MASS, _BIT_MODE_12);
    ...
    // 0. HLW, Inside Window, PCM Inside A, outside SRGB Set B, OG Set B
    DebugMessageQC("5. Mode_0", 0x00);
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_10_HLW_CONTROL3, ~(_BIT3|_BIT2), 0x00);     //PCM  Sel
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_11_HLW_SETSEL0, ~(_BIT7|_BIT6), _BIT6);     //sRGB Inside A Outside B
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_11_HLW_SETSEL0, ~(_BIT1|_BIT0), _BIT0);     //OG Inside A Outside B
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_13_HLW_SETSEL2, ~(_BIT7|_BIT6), _BIT6);     //PCM Inside A Outside B
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_0D_HLW_CONTROL1, ~(_BIT7|_BIT6), 0x00);
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_0E_HLW_CONTROL0, ~(_BIT5|_BIT4), 0x00);
    usData = usData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tPCM_5K3K_CRC_MODE0, 1) << 0);

    // 1. HLW, Inside A, outside B
    DebugMessageQC("5. Mode_1", 0x00);
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_10_HLW_CONTROL3, ~(_BIT3|_BIT2), _BIT2);     //PCM  Sel Inside
    ScalerBurstWrite(tPCM_TEST_NEWIG, sizeof(tPCM_TEST_NEWIG), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    ScalerBurstWrite(tPCM_TEST_SETB, sizeof(tPCM_TEST_SETB), GET_CURRENT_BANK_NUMBER(), 0, _BURSTWRITE_COMMAND, _BURSTWRITE_FROM_FLASH);
    usData = usData | ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_DDITHER, _M1 | _M2 | _S1 | _S2, tPCM_5K3K_CRC_MODE1, 1) << 1);

    ScalerQCHighlightWindowOff();
    ScalerQCDDomainPatternGenOff();
    ScalerQCPCMOff();

    DebugMessageQC("5. 5K3K PCM End", 0x00);
    if(usData == 0x00)
    {
        DebugMessageQC("6. 5K3K PCM PASS", 0x00);
        return _TEST_PASS;
    }
    else
    {
        DebugMessageQC("6. Fail Mode", usData);
        DebugMessageQC("6. 5K3K PCM FAIL", 0x00);
        return _TEST_FAIL;
    }
}
#endif
