...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6410_Series_Scaling.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
void ScalerScalingSetScalingDown(const StructSDRAMDataInfo *pstFIFOScaling)
{
    ...
    if((GET_FREESYNC_ENABLED() == _ENABLE) && (ScalerGlobalGetDBStatus() == _FALSE))
    {
        ...
        // M2
        ScalerSetBit(P40_23_SCALE_DOWN_CTRL_M2, ~(_BIT3 | _BIT2 | _BIT1), 0x00);
    }
    else
#endif
    {
    ...
    if(g_stMDomainInputData.usHWidth > pstFIFOScaling->usInputHWidth)
    {
        ...
        // M2
        ScalerSetDataPortByte(P40_24_SD_ADDRESS_PORT_M2, _P40_25_PT_05_H_SD_FACTOR_H_M2, ((PDATA_DWORD(0) >> 16) & 0xFF));
        ScalerSetDataPortByte(P40_24_SD_ADDRESS_PORT_M2, _P40_25_PT_06_H_SD_FACTOR_M_M2, ((PDATA_DWORD(0) >> 8) & 0xFF));
        ScalerSetDataPortByte(P40_24_SD_ADDRESS_PORT_M2, _P40_25_PT_07_H_SD_FACTOR_L_M2, (PDATA_DWORD(0) & 0xFF));
        ...
        // M2
        ScalerSetDataPortByte(P40_24_SD_ADDRESS_PORT_M2, _P40_25_PT_04_H_SD_INIT_M2, PDATA_DWORD(0));
    }
    else
    {
        // M1
        ...
        // M2
        ScalerSetDataPortByte(P40_24_SD_ADDRESS_PORT_M2, _P40_25_PT_04_H_SD_INIT_M2, 0x00);
        ScalerSetDataPortByte(P40_24_SD_ADDRESS_PORT_M2, _P40_25_PT_05_H_SD_FACTOR_H_M2, 0x10);
        ScalerSetDataPortByte(P40_24_SD_ADDRESS_PORT_M2, _P40_25_PT_06_H_SD_FACTOR_M_M2, 0x00);
        ScalerSetDataPortByte(P40_24_SD_ADDRESS_PORT_M2, _P40_25_PT_07_H_SD_FACTOR_L_M2, 0x00);
    }
    ...
    if((g_stMDomainInputData.usVHeight) > pstFIFOScaling->usInputVHeight)
    {
        ...
        // M2
        ScalerSetDataPortByte(P40_24_SD_ADDRESS_PORT_M2, _P40_25_PT_01_V_SD_FACTOR_H_M2, ((PDATA_DWORD(0) >> 19) & 0x0F));
        ScalerSetDataPortByte(P40_24_SD_ADDRESS_PORT_M2, _P40_25_PT_02_V_SD_FACTOR_M_M2, ((PDATA_DWORD(0) >> 11) & 0xFF));
        ScalerSetDataPortByte(P40_24_SD_ADDRESS_PORT_M2, _P40_25_PT_03_V_SD_FACTOR_L_M2, ((PDATA_DWORD(0) >> 3) & 0xFF));
        ScalerSetDataPortByte(P40_24_SD_ADDRESS_PORT_M2, _P40_25_PT_42_V_SD_FACTOR_L1_M2, (((PDATA_DWORD(0) & 0x07) << 5) & 0xE0));
        ...
        // M2
        ScalerSetDataPortByte(P40_24_SD_ADDRESS_PORT_M2, _P40_25_PT_00_V_SD_INIT_M2, PDATA_DWORD(0));
    }
    else
    {
        // M1
        ...
        // M2
        ScalerSetDataPortByte(P40_24_SD_ADDRESS_PORT_M2, _P40_25_PT_00_V_SD_INIT_M2, 0x00);
        ScalerSetDataPortByte(P40_24_SD_ADDRESS_PORT_M2, _P40_25_PT_01_V_SD_FACTOR_H_M2, 0x02);
    ...
    {
        PDATA_WORD(0) = pstFIFOScaling->usInputVHeight >> 1;
    }
    else
    {
    ...
    // M2
    ScalerSetDataPortByte(P40_24_SD_ADDRESS_PORT_M2, _P40_25_PT_36_SD_OUT_WID_M_M2, ((pstFIFOScaling->usInputHWidth >> 8) & 0x0F));
    ScalerSetDataPortByte(P40_24_SD_ADDRESS_PORT_M2, _P40_25_PT_37_SD_OUT_WID_L_M2, pstFIFOScaling->usInputHWidth);

    ScalerSetDataPortByte(P40_24_SD_ADDRESS_PORT_M2, _P40_25_PT_38_SD_OUT_LEN_M_M2, (pData[0] & 0x0F));
    ScalerSetDataPortByte(P40_24_SD_ADDRESS_PORT_M2, _P40_25_PT_39_SD_OUT_LEN_L_M2, pData[1]);
...
void ScalerScalingUpdateFIFOScalingSize(StructSDRAMDataInfo *pstData)
{
...
#if(_DISPLAY_ROTATION_SUPPORT == _ON)
    if((ScalerFmtCnvFtoPGetStatus() == _TRUE) && ((GET_ROT_TYPE() == _ROT_CW90) || (GET_ROT_TYPE() == _ROT_CW270)))
    {
    ...
    if((ScalerFmtCnvFtoPGetStatus() == _TRUE) && ((GET_ROT_TYPE() == _ROT_CW90) || (GET_ROT_TYPE() == _ROT_CW270)))
    {
        if(pstData->usInputHWidth > _ROTATION_LINE_BUFFER)
        {
            pstData->usInputHWidth = _ROTATION_LINE_BUFFER;
        }
...
void ScalerScalingGetFIFOScalingSize(StructSDRAMDataInfo *pstData)
{
    ...
    if(((g_stMDomainInputData.usHWidth > pstData->usInputHWidth) &&
       ...
       (g_stDVCustomizedFreq.b1FORCETOFRC8BIT == _ENABLE))
    {
