...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6410_Series_QC_OD_FRC.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6410_SERIES_QC__
...
BYTE code tFRC_CRCTable_4P_2[] = {
    0x8B, 0x25, 0x3D, 0x00, 0x00, 0x00, // M1
    0x8B, 0x25, 0x3D, 0x00, 0x00, 0x00, // M2
...
BYTE code tFRC_CRCTable_5K3K_1P[] = {
    0x87, 0x79, 0x3F, 0x00, 0x00, 0x00, // M1
    0x87, 0x79, 0x3F, 0x00, 0x00, 0x00, // M2
    0x87, 0x79, 0x3F, 0x00, 0x00, 0x00, // S1
    0x87, 0x79, 0x3F, 0x00, 0x00, 0x00, // S2
};

BYTE code tFRC_CRCTable_5K3K_PBP[] = {
    0x50, 0x57, 0x30, 0x00, 0x00, 0x00, // M1
    0x0B, 0x6A, 0x23, 0x00, 0x00, 0x00, // M2
    0x50, 0x57, 0x30, 0x00, 0x00, 0x00, // S1
    0x0B, 0x6A, 0x23, 0x00, 0x00, 0x00, // S2
};
#endif
...
#if(_QC_5K3K_MODE_ == _ON)
BYTE code tQC_5K3K_OD_CRC_TABLE_0[] =
{
    0x8C, 0x6B, 0x75, 0xFB, 0xDF, 0xAB, // M1
    0x28, 0x9C, 0x42, 0x14, 0x8D, 0x79, // M2
    0x7D, 0xFC, 0xC6, 0x0E, 0x87, 0x22, // S1
    0xE6, 0xE2, 0x63, 0xBB, 0x55, 0x67, // S2

    0xE4, 0x25, 0x1D, 0xED, 0x4D, 0x2D, // M1
    0x76, 0xE1, 0x4E, 0x36, 0x76, 0x05, // M2
    0xDC, 0x0A, 0x86, 0xA0, 0xEA, 0xAE, // S1
    0xC1, 0x24, 0xC6, 0x85, 0xA4, 0x14, // S2

    0xB4, 0x47, 0xD9, 0xA4, 0x9D, 0x9C, // M1
    0x12, 0x1A, 0x65, 0x20, 0x80, 0xB5, // M2
    0xE3, 0xAE, 0xBC, 0xDF, 0xB5, 0x1F, // S1
    0x06, 0x94, 0xEF, 0xB5, 0x49, 0x01, // S2
};

BYTE code tQC_5K3K_OD_CRC_TABLE_1[] =
{
    0x8C, 0x6B, 0x75, 0xFB, 0xDF, 0xAB, // M1
    0x28, 0x9C, 0x42, 0x14, 0x8D, 0x79, // M2
    0x7D, 0xFC, 0xC6, 0x0E, 0x87, 0x22, // S1
    ...
    0x7A, 0xF3, 0x5B, 0x60, 0x83, 0x6A, // M1
    0x75, 0x9A, 0xCC, 0x79, 0x3D, 0x72, // M2
    0x71, 0x74, 0x0D, 0xF4, 0x7E, 0x71, // S1
    0x1B, 0xF4, 0x82, 0xA8, 0x7C, 0x7B, // S2

    0xCA, 0x87, 0xEB, 0x3A, 0x1E, 0x98, // M1
    0xDC, 0x5B, 0x4D, 0x0D, 0x77, 0x05, // M2
    0xA6, 0xDA, 0xB5, 0x99, 0x81, 0x7F, // S1
    0x62, 0x01, 0x1A, 0x66, 0x18, 0x24, // S2
};

BYTE code tQC_5K3K_OD_CRC_TABLE_2[] =
{
    0x8C, 0x6B, 0x75, 0xFB, 0xDF, 0xAB, // M1
    0x28, 0x9C, 0x42, 0x14, 0x8D, 0x79, // M2
    0x7D, 0xFC, 0xC6, 0x0E, 0x87, 0x22, // S1
    ...
    0x12, 0xDE, 0x92, 0xD1, 0xBB, 0x31, // M1
    0x2C, 0x6B, 0x27, 0xC6, 0x0F, 0x5F, // M2
    0xA4, 0x9F, 0x31, 0x77, 0x56, 0x4E, // S1
    0x0A, 0x2A, 0x2C, 0x3B, 0x00, 0xA5, // S2

    0x0E, 0x9C, 0x4F, 0x9A, 0x6B, 0x79, // M1
    0xEC, 0x59, 0x22, 0x1F, 0x4F, 0x5C, // M2
    0x70, 0x87, 0x40, 0x31, 0x58, 0x07, // S1
    0xD5, 0xA1, 0x3F, 0x4C, 0xFB, 0xFF, // S2
};

BYTE code tQC_5K3K_OD_CRC_TABLE_3[] =
{
    0x8C, 0x6B, 0x75, 0xFB, 0xDF, 0xAB, // M1
    0x28, 0x9C, 0x42, 0x14, 0x8D, 0x79, // M2
    0x7D, 0xFC, 0xC6, 0x0E, 0x87, 0x22, // S1
    ...
    0xE7, 0xEE, 0x33, 0xD2, 0x5A, 0xF1, // M1
    0xBC, 0xC5, 0xFF, 0x77, 0x16, 0x7A, // M2
    0x7E, 0x74, 0xE5, 0x61, 0x5C, 0x77, // S1
    0x0F, 0xB8, 0x20, 0x4E, 0xA5, 0xB3, // S2

    0x68, 0x94, 0x88, 0x03, 0x62, 0x51, // M1
    0xDE, 0x32, 0x84, 0x2E, 0x3E, 0x39, // M2
    0x3B, 0x92, 0x69, 0xB0, 0xD1, 0x07, // S1
    0x04, 0x5D, 0x13, 0x19, 0x18, 0x2C, // S2
};

BYTE code tQC_5K3K_OD_CRC_TABLE_4[] =
{
    0x8C, 0x6B, 0x75, 0xFB, 0xDF, 0xAB, // M1
    0x28, 0x9C, 0x42, 0x14, 0x8D, 0x79, // M2
    0x7D, 0xFC, 0xC6, 0x0E, 0x87, 0x22, // S1
    ...
    0x82, 0x3A, 0x22, 0xD8, 0x83, 0x6E, // M1
    0x32, 0x22, 0x08, 0xAB, 0xD4, 0x91, // M2
    0x1C, 0x32, 0xEF, 0xF1, 0x19, 0x12, // S1
    0xC0, 0x6D, 0x67, 0x09, 0x26, 0x1B, // S2

    0x7B, 0x76, 0x67, 0x07, 0xF5, 0x64, // M1
    0x3D, 0x95, 0xB3, 0xD9, 0xD0, 0xC3, // M2
    0x3C, 0xF8, 0xF5, 0xDA, 0xF3, 0x0F, // S1
    0x84, 0x96, 0x79, 0x6B, 0x00, 0xB3, // S2
};

BYTE code tQC_5K3K_OD_CRC_TABLE_5[] =
{
    0x8C, 0x6B, 0x75, 0xFB, 0xDF, 0xAB, // M1
    0x28, 0x9C, 0x42, 0x14, 0x8D, 0x79, // M2
    0x7D, 0xFC, 0xC6, 0x0E, 0x87, 0x22, // S1
    ...
    0xB6, 0xAF, 0x71, 0x60, 0x50, 0xF5, // M1
    0x5A, 0x34, 0xC7, 0xB2, 0xB4, 0xCC, // M2
    0x65, 0x4D, 0x0C, 0x51, 0x09, 0x88, // S1
    0x4B, 0xA1, 0x7D, 0x0D, 0x61, 0x5B, // S2

    0x59, 0xE4, 0x0B, 0x74, 0xDA, 0x7F, // M1
    0x12, 0x41, 0xF5, 0x63, 0x08, 0x97, // M2
    0xB0, 0x4D, 0x5D, 0x7B, 0xA1, 0xF9, // S1
    0x68, 0x21, 0x55, 0x5E, 0x5B, 0x4D, // S2
};

BYTE code tQC_5K3K_OD_CRC_TABLE_6[] =
{
    0x8C, 0x6B, 0x75, 0xFB, 0xDF, 0xAB, // M1
    0x28, 0x9C, 0x42, 0x14, 0x8D, 0x79, // M2
    0x7D, 0xFC, 0xC6, 0x0E, 0x87, 0x22, // S1
    ...
    0x45, 0x6F, 0x6A, 0x09, 0x17, 0x73, // M1
    0xE5, 0x46, 0x8A, 0xC1, 0x15, 0x26, // M2
    0xFD, 0x0C, 0x13, 0xC4, 0xA7, 0x38, // S1
    0xFB, 0x3C, 0x63, 0xB9, 0x6E, 0x03, // S2

    0xB0, 0x4B, 0xE8, 0xDB, 0x2F, 0x55, // M1
    0xEC, 0xCF, 0x4B, 0xE4, 0x6A, 0x7F, // M2
    0x01, 0x8A, 0x2E, 0x2B, 0xFB, 0x0A, // S1
    0x8C, 0x9E, 0x54, 0x9D, 0xA7, 0x2E, // S2
};

BYTE code tQC_5K3K_OD_CRC_TABLE_7[] =
{
    0x8C, 0x6B, 0x75, 0xFB, 0xDF, 0xAB, // M1
    0x28, 0x9C, 0x42, 0x14, 0x8D, 0x79, // M2
    0x7D, 0xFC, 0xC6, 0x0E, 0x87, 0x22, // S1
    ...
    0xA2, 0x7C, 0x1B, 0xD4, 0xEC, 0x5A, // M1
    0x2B, 0xAA, 0xEA, 0x8E, 0xBC, 0x38, // M2
    0x08, 0x6D, 0x78, 0x04, 0x76, 0x7D, // S1
    0x5E, 0x79, 0x5E, 0x6D, 0xB3, 0x93, // S2

    0xEE, 0x51, 0xC4, 0x18, 0xCC, 0x7D, // M1
    0xE5, 0x50, 0x79, 0xF0, 0x79, 0xB6, // M2
    0x28, 0xD4, 0x4E, 0x0A, 0x2D, 0x78, // S1
    0x30, 0xA1, 0x1A, 0xE5, 0xDF, 0xA1, // S2
};
...
//--------------------------------------------------
#if(_MEMORY_SIZE_CONFIG == _1G_16BIT_DDR3_2PCS)
#define _OD_M1_MEM_START_ADDR           ((DWORD)7680 << 12) // 0x1E0 0000
#define _OD_M2_MEM_START_ADDR           ((DWORD)7168 << 12) // 0x1C0 0000
#define _OD_S1_MEM_START_ADDR           ((DWORD)6656 << 12) // 0x1A0 0000
#define _OD_S2_MEM_START_ADDR           ((DWORD)6144 << 12) // 0x180 0000
#elif(_MEMORY_SIZE_CONFIG == _1G_16BIT_DDR3_1PC)
#define _OD_M1_MEM_START_ADDR           ((DWORD)7168 << 11) // 0x0E0 0000
#define _OD_M2_MEM_START_ADDR           ((DWORD)6144 << 11) // 0x0C0 0000
#define _OD_S1_MEM_START_ADDR           ((DWORD)5120 << 11) // 0x0A0 0000
#define _OD_S2_MEM_START_ADDR           ((DWORD)4096 << 11) // 0x080 0000
#endif
...
void ScalerQCFRCInitial(EnumInputDataPath enumInputPath, BYTE ucDispMode);
void ScalerQCFRCInputCtrl(WORD usHorSize, WORD usVerSize, EnumInputDataPath enumInputPath, BYTE ucDispMode);
void ScalerQCFRCDisplayCtrl(WORD usHorSize, WORD usVerSize, EnumInputDataPath enumInputPath, BYTE ucDispMode);
void ScalerQCFRCCompareIHFandDHF(BYTE ucDispMode);
void ScalerQCFRCControl(EnumInputDataPath enumInputPath, BYTE ucDispMode);
void ScalerQCFRC(BYTE ucDispMode);
#endif

#if(_QC_5K3K_MODE_ == _ON)
bit ScalerQC5K3KODTest(void);
#endif
...
void ScalerQCMemorySetFifoCapture(EnumInputDataPath enumInputDataPath, WORD usHWidth, WORD usVHeight, BYTE ucDispMode)
{
    ...
    for(ucIdx = 0; ucIdx < 4; ucIdx++)
    {
        if((enumInputDataPath & ((BYTE)_INPUT_PATH_M1 << ucIdx)) == ((BYTE)_INPUT_PATH_M1 << ucIdx))
        {
            ...
            if(ucDispMode == _5k3k_1P)
            {
                PDATA_WORD(0) = (usHWidth >> 1) + _EXTENSION_PIXEL;

                // FIFOWin Extension
                ScalerSetDataPortBit(P0_30_FIFO_WINDOW_ADDR_PORT, _P0_31_PT_08_DISPLAY_READ_EXTENSION_MAIN, ~0x1F, (_EXTENSION_PIXEL & 0x1F));
                ScalerSetDataPortBit(P80_30_FIFO_WINDOW_ADDR_PORT_S, _P80_31_PT_08_DISPLAY_READ_EXTENSION_SUB, ~0x1F, (_EXTENSION_PIXEL & 0x1F));
            }
            else
            {
...
void ScalerQCFRCInitial(EnumInputDataPath enumInputPath, BYTE ucDispMode)
{
    ...
    for(ucIdx = 0; ucIdx < ucPathCount; ucIdx++)
    {
        // Capture 4 Channel Manual Mode
        ScalerSetBit(P5_44_CAP_M1_4CH_CTRL2 + usPageSelect, ~_BIT7, 0x00);
        ScalerSetBit(P5_DD_DISP_M1_4CH_CTRL2 + usPageSelect, ~_BIT7, 0x00);

        // Disable 4 Channel Mode
        ScalerSetBit(P5_43_CAP_M1_4CH_CTRL1 + usPageSelect, ~_BIT1, 0x00);
        ScalerSetBit(P5_DC_DISP_M1_4CH_CTRL1 + usPageSelect, ~_BIT1, 0x00);

        if((ucDispMode == _5k3k_1P) || (ucDispMode == _5k3k_PBP))
        {
            if(usPageSelect == _REG_MAIN1_PAGE)
            {
                PDATA_DWORD(0) = _FRC_CAP_M1_1ST_BLOCK_STA_ADDR_FB;
                PDATA_DWORD(1) = _FRC_CAP_M1_2ND_BLOCK_STA_ADDR_FB;
                PDATA_DWORD(2) = 0x00000000;
            }
            else if(usPageSelect == _REG_MAIN2_PAGE)
            {
                PDATA_DWORD(0) = _FRC_CAP_M2_1ST_BLOCK_STA_ADDR_FB;
                PDATA_DWORD(1) = _FRC_CAP_M2_2ND_BLOCK_STA_ADDR_FB;
                PDATA_DWORD(2) = 0x00000000;
            }
            else if(usPageSelect == _REG_SUB1_PAGE)
            {
                PDATA_DWORD(0) = _FRC_CAP_S1_1ST_BLOCK_STA_ADDR_FB;
                PDATA_DWORD(1) = _FRC_CAP_S1_2ND_BLOCK_STA_ADDR_FB;
                PDATA_DWORD(2) = 0x00000000;
            }
            else // if(usPageSelect == _REG_SUB2_PAGE)
            {
                PDATA_DWORD(0) = _FRC_CAP_S2_1ST_BLOCK_STA_ADDR_FB;
                PDATA_DWORD(1) = _FRC_CAP_S2_2ND_BLOCK_STA_ADDR_FB;
                PDATA_DWORD(2) = 0x00000000;
            }
        }
        else
    ...
    ScalerSetBit(P5_43_CAP_M1_4CH_CTRL1, ~(_BIT5 | _BIT4), 0x00);

    if(ucDispMode == _5k3k_1P)
    {
        // ENABLE : In 5K3K display, M1, M2, S1 and S2 field signal are from cap_source_sel[1:0] slection under front/back mode
        ScalerSetBit(P5_44_CAP_M1_4CH_CTRL2, ~_BIT0, _BIT0);

        // DISABLE: In 4K2K display, M1 and M2 field signal are both from M1 (S1 and S2 field signal are both from S1) under even/odd mode.
        ScalerSetBit(P5_44_CAP_M1_4CH_CTRL2, ~_BIT1, 0x00);
    }
    else
    {
        // DISABLE : In 5K3K display, M1, M2, S1 and S2 field signal are from cap_source_sel[1:0] slection under front/back mode
        ScalerSetBit(P5_44_CAP_M1_4CH_CTRL2, ~_BIT0, 0x00);

        // ENABLE: In 4K2K display, M1 and M2 field signal are both from M1 (S1 and S2 field signal are both from S1) under even/odd mode.
        ScalerSetBit(P5_44_CAP_M1_4CH_CTRL2, ~_BIT1, _BIT1);
    }
    ...
    else
    {
        ...
        switch(ucDispMode)
        {
            ...
            case _5k3k_PBP:
                ...
                ScalerSetByte(P85_A6_DISP_S1_PRRD_VST_H, 0x00);
                ScalerSetByte(P85_A7_DISP_S1_PRRD_VST_L, 0x03);
                ScalerSetByte(PC5_A6_DISP_S2_PRRD_VST_H, 0x00);
                ScalerSetByte(PC5_A7_DISP_S2_PRRD_VST_L, 0x03);
                break;
        }
...
void ScalerQCFRCInputCtrl(WORD usHorSize, WORD usVerSize, EnumInputDataPath enumInputPath, BYTE ucDispMode)
{
    ...
    if((ucDispMode == _PBP_LR) || (ucDispMode == _5k3k_PBP))
    {
            // E/O Mode
    ...
    for(ucIdx = 0; ucIdx < ucPathCount; ucIdx++)
    {
        ...
        if((enumInputPath == _INPUT_PATH_S1_S2) & (ucDispMode == _PBP_LR))
        {
...
void ScalerQCFRCControl(EnumInputDataPath enumInputPath, BYTE ucDispMode)
{
    ...
    switch(ucDispMode)
    {
        default:
        case _5k3k_1P:
            usHWidth = 2048 + _EXTENSION_PIXEL;
            usVHeight = 1080;

            // Set FIFO Capture Size
            ScalerQCMemorySetFifoCapture(enumInputPath, GET_MDOMAIN_INPUT_HWIDTH(), GET_MDOMAIN_INPUT_VHEIGHT(), ucDispMode);
            break;

        case _5k3k_PBP:
            usHWidth = 2560; // Display Active Window 2560x1440
            usVHeight = 1440;

            // Set FIFO Capture Size
            ScalerQCMemorySetFifoCapture(enumInputPath, usHWidth, usVHeight, ucDispMode);
            break;
    ...
    // Set FRC Initial
    ScalerQCFRCInitial(enumInputPath, ucDispMode);

    // Set FRC IVS2DVSDelay
    ScalerFRCAdjustIVS2DVSDelay(usVHeight);

    // Consider Input Faster Or Slower
    ScalerQCFRCCompareIHFandDHF(ucDispMode);

    // Set Up FRC Capture
    ScalerQCFRCInputCtrl(usHWidth, usVHeight, enumInputPath, ucDispMode);

    // Set Up FRC Display
    ScalerQCFRCDisplayCtrl(usHWidth, usVHeight, enumInputPath, ucDispMode);

    if(ucDispMode == _5k3k_1P)
    {
        PDATA_WORD(0) = 0x00;
        for(pData[3] = 0; pData[3] < 4; pData[3] ++)
        {
            // Capture 4 channel auto mode
            ScalerSetBit(P5_44_CAP_M1_4CH_CTRL2 + PDATA_WORD(0), ~_BIT7, _BIT7);
            ScalerSetBit(P5_DD_DISP_M1_4CH_CTRL2 + PDATA_WORD(0), ~_BIT7, _BIT7);

            // Set 4 Channel Mode
            ScalerSetBit(P5_43_CAP_M1_4CH_CTRL1 + PDATA_WORD(0), ~_BIT1, _BIT1);
            ScalerSetBit(P5_DC_DISP_M1_4CH_CTRL1 + PDATA_WORD(0), ~_BIT1, _BIT1);

            // Enable FRC Display Double buffer
            ScalerSetBit(P5_AD_DISP_STATUS + PDATA_WORD(0), ~(_BIT4), _BIT4);

            PDATA_WORD(0) += _REG_PAGE_OFFSET;
        }
    }
...
void ScalerQCFRC(BYTE ucDispMode)
{
    ...
    switch(ucDispMode)
    {
        default:
        case _5k3k_1P:
            ScalerQCFRCControl(_INPUT_PATH_ALL, _5k3k_1P);
            break;

        case _5k3k_PBP:
            ScalerQCFRCControl(_INPUT_PATH_M1_M2, _5k3k_PBP);
            ScalerQCFRCControl(_INPUT_PATH_S1_S2, _5k3k_PBP);
            break;
...
bit ScalerQCFRC4PTest(BYTE ucDispMode)
{
    ...
    switch(ucDispMode)
    {
#if(_QC_5K3K_MODE_ == _ON)
        case _5k3k_1P:
            ucData = (ucData | (BYTE)ScalerQCCRCCompare(_M_DOMAIN_CRC, _M_CRC_AFTER_FIFO, (_M1 | _M2 | _S1 | _S2), tFRC_CRCTable_5K3K_1P, 1));
            break;

        case _5k3k_PBP:
            ucData = (ucData | (BYTE)ScalerQCCRCCompare(_M_DOMAIN_CRC, _M_CRC_AFTER_FIFO, (_M1 | _M2 | _S1 | _S2), tFRC_CRCTable_5K3K_PBP, 1));
            break;
#endif
        ...
        case _4P:
            if(GET_MDOMAIN_INPUT_HWIDTH() == 1280)
            {
                ucData = (ucData | (BYTE)ScalerQCCRCCompare(_M_DOMAIN_CRC, _M_CRC_AFTER_FIFO, (_M1 | _M2 | _S1 | _S2), tFRC_CRCTable_4P_1, 1));
            }
            else
            {
                ucData = (ucData | (BYTE)ScalerQCCRCCompare(_M_DOMAIN_CRC, _M_CRC_AFTER_FIFO, (_M1 | _M2 | _S1 | _S2), tFRC_CRCTable_4P_2, 1));
            }
            break;

        default:
        case _PBP_LR:
            ucData = (ucData | (BYTE)ScalerQCCRCCompare(_M_DOMAIN_CRC, _M_CRC_AFTER_FIFO, (_M1 | _M2 | _S1), tFRC_CRCTable_PBP_LR, 1));
            break;
    }
...
bit ScalerQC5K3KODTest(void)
{
    ...
    DebugMessageQC("5. 5K3K OD Start", 0x00);

    //==================================================
    // Disable FRC Cap/Disp Clients for Memory BW Saving
    //==================================================
    // Disable FRC Capture Clients
    ...
    // OD S1
    PDATA_DWORD(0) = _OD_S1_MEM_START_ADDR;
    ...
    // OD S2
    PDATA_DWORD(0) = _OD_S2_MEM_START_ADDR;
    ...
    {
        DebugMessageQC("5. 5K3K OD Write 8-bit LUT Fail", 0x00);
    }
    ...
    ScalerSetByte(P43_D5_LS_DDR_FIFO_RW_NUM_L, 0xBF);
    ...
    ScalerTimerWaitForEvent(_EVENT_DEN_START);
    // Set DPG pattern reset frame num = 9
    ScalerSetByte(P7_FF_D_PATTERN_RESET, 0x08);
    ScalerSetByte(P87_FF_D_PATTERN_RESET_SUB, 0x08);

    ScalerTimerWaitForEvent(_EVENT_DEN_START);
    // Enable OD (DB effective when DVS falling occurs)
    ScalerSetBit(P3_A1_LS_CTRL0, ~(_BIT7 | _BIT6), (_BIT7 | _BIT6));
    ucData |= ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, (_M1 | _M2 | _S1 | _S2), tQC_5K3K_OD_CRC_TABLE_0, 3) << 0);

    // Set DPG pattern reset frame num = 1
    ScalerSetByte(P7_FF_D_PATTERN_RESET, 0x00);
    ScalerSetByte(P87_FF_D_PATTERN_RESET_SUB, 0x00);
    // Disable OD
    ...
    // Enable OD (DB effective when DVS falling occurs)
    ScalerSetBit(P3_A1_LS_CTRL0, ~(_BIT7 | _BIT6), (_BIT7 | _BIT6));
    ucData |= ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, (_M1 | _M2 | _S1 | _S2), tQC_5K3K_OD_CRC_TABLE_1, 3) << 1);
    ...
    // OD M2/S2
    ScalerSetByte(P43_D4_LS_DDR_FIFO_RW_NUM_H, 0x15);
    ScalerSetByte(P43_D5_LS_DDR_FIFO_RW_NUM_L, 0xAD);
    ScalerSetByte(P43_D8_LS_DDR_FIFO_RW_REMAIN_H, 0x00);
    ScalerSetByte(P43_D9_LS_DDR_FIFO_RW_REMAIN_L, 0x60);
    // OD Setting
    ...
    // Enable OD (DB effective when DVS falling occurs)
    ScalerSetBit(P3_A1_LS_CTRL0, ~(_BIT7 | _BIT6), (_BIT7 | _BIT6));
    ucData |= ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, (_M1 | _M2 | _S1 | _S2), tQC_5K3K_OD_CRC_TABLE_2, 3) << 2);
    ...
    ScalerSetByte(P3_D9_LS_DDR_FIFO_RW_REMAIN_L, 0x60);
    // OD M2/S2
    ScalerSetByte(P43_D4_LS_DDR_FIFO_RW_NUM_H, 0x16);
    ScalerSetByte(P43_D5_LS_DDR_FIFO_RW_NUM_L, 0x43);
    ScalerSetByte(P43_D8_LS_DDR_FIFO_RW_REMAIN_H, 0x00);
    ScalerSetByte(P43_D9_LS_DDR_FIFO_RW_REMAIN_L, 0x60);
    // OD Setting
    ScalerSetBit(P3_A1_LS_CTRL0, 0x00, (_BIT5 | _BIT3 | _BIT0));
    ...
    // Enable OD (DB effective when DVS falling occurs)
    ScalerSetBit(P3_A1_LS_CTRL0, ~(_BIT7 | _BIT6), (_BIT7 | _BIT6));
    ucData |= ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, (_M1 | _M2 | _S1 | _S2), tQC_5K3K_OD_CRC_TABLE_3, 3) << 3);
    ...
    if(ScalerGetBit(P3_BF_LS_LUT_CTRL, _BIT1) != 0x00)
    {
        DebugMessageQC("5. 5K3K OD Write 10-bit LUT Fail", 0x00);
    }
    ...
    // Enable OD (DB effective when DVS falling occurs)
    ScalerSetBit(P3_A1_LS_CTRL0, ~(_BIT7 | _BIT6), (_BIT7 | _BIT6));
    ucData |= ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, (_M1 | _M2 | _S1 | _S2), tQC_5K3K_OD_CRC_TABLE_4, 3) << 4);
    ...
    ScalerSetByte(P3_D9_LS_DDR_FIFO_RW_REMAIN_L, 0x60);
    // OD M2/S2
    ScalerSetByte(P43_D4_LS_DDR_FIFO_RW_NUM_H, 0x10);
    ScalerSetByte(P43_D5_LS_DDR_FIFO_RW_NUM_L, 0x67);
    ScalerSetByte(P43_D8_LS_DDR_FIFO_RW_REMAIN_H, 0x00);
    ScalerSetByte(P43_D9_LS_DDR_FIFO_RW_REMAIN_L, 0x60);
    // OD Setting
    ...
    // Enable OD (DB effective when DVS falling occurs)
    ScalerSetBit(P3_A1_LS_CTRL0, ~(_BIT7 | _BIT6), (_BIT7 | _BIT6));
    ucData |= ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, (_M1 | _M2 | _S1 | _S2), tQC_5K3K_OD_CRC_TABLE_5, 3) << 5);
    ...
    ScalerSetByte(P3_D9_LS_DDR_FIFO_RW_REMAIN_L, 0x60);
    // OD M2/S2
    ScalerSetByte(P43_D4_LS_DDR_FIFO_RW_NUM_H, 0x0E);
    ScalerSetByte(P43_D5_LS_DDR_FIFO_RW_NUM_L, 0x0F);
    ScalerSetByte(P43_D8_LS_DDR_FIFO_RW_REMAIN_H, 0x00);
    ScalerSetByte(P43_D9_LS_DDR_FIFO_RW_REMAIN_L, 0x60);
    // OD Setting
    ...
    // Enable OD (DB effective when DVS falling occurs)
    ScalerSetBit(P3_A1_LS_CTRL0, ~(_BIT7 | _BIT6), (_BIT7 | _BIT6));
    ucData |= ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, (_M1 | _M2 | _S1 | _S2), tQC_5K3K_OD_CRC_TABLE_6, 3) << 6);
    ...
    // Enable OD (DB effective when DVS falling occurs)
    ScalerSetBit(P3_A1_LS_CTRL0, ~(_BIT7 | _BIT6), (_BIT7 | _BIT6));
    ucData |= ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, (_M1 | _M2 | _S1 | _S2), tQC_5K3K_OD_CRC_TABLE_7, 3) << 7);
    ...
    //==================================================
    // Resume FRC Cap/Disp Clients
    //==================================================
    // Enable FRC Capture Clients
    ScalerTimerWaitForEvent(_EVENT_IEN_STOP);
    ...
    // Test Result
    //==================================================
    DebugMessageQC("5. 5K3K OD End", 0x00);
    if(ucData == 0x00)
    {
        DebugMessageQC("6. 5K3K OD PASS", 0x00);
        return _TEST_PASS;
    }
    else
    {
        DebugMessageQC("6. Fail Mode", ucData);
        DebugMessageQC("6. 5K3K OD FAIL", 0x00);
        return _TEST_FAIL;
    }
}
#endif
...
bit ScalerQCFRCTest(void)
{
    ...
    ucData = (ucData | (BYTE)ScalerQCCRCCompare(_M_DOMAIN_CRC, _M_CRC_AFTER_FIFO, _M1 | _M2, tFRC_CRCTable, 1));
...
bit ScalerQCODTest(void)
{
    ...
    ucData |= ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OD_CRC_TABLE_0, 2) << 0);
    ...
    ScalerTimerWaitForEvent(_EVENT_DVS);
    ScalerQCODDDomainPattern2();
    ucData |= ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OD_CRC_TABLE_1, 2) << 1);
    ...
    ScalerTimerWaitForEvent(_EVENT_DVS);
    ScalerQCODDDomainPattern2();
    ucData |= ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OD_CRC_TABLE_2, 2) << 2);
    ...
    ScalerTimerWaitForEvent(_EVENT_DVS);
    ScalerQCODDDomainPattern2();
    ucData |= ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OD_CRC_TABLE_3, 2) << 3);
    ...
    ScalerTimerWaitForEvent(_EVENT_DVS);
    ScalerQCODDDomainPattern2();
    ucData |= ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OD_CRC_TABLE_4, 2) << 4);
    ...
    ScalerTimerWaitForEvent(_EVENT_DVS);
    ScalerQCODDDomainPattern2();
    ucData |= ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OD_CRC_TABLE_5, 2) << 5);
    ...
    ScalerTimerWaitForEvent(_EVENT_DVS);
    ScalerQCODDDomainPattern2();
    ucData |= ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OD_CRC_TABLE_6, 2) << 6);
    ...
    ScalerTimerWaitForEvent(_EVENT_DVS);
    ScalerQCODDDomainPattern2();
    ucData |= ((BYTE)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OD_CRC_TABLE_7, 2) << 7);
