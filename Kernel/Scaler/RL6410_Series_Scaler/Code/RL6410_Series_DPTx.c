...
void ScalerDpTxSSTAudioPlaySetting(EnumDPTxAudioPlayState enumPlayState)
{
    ...
    switch(enumPlayState)
    {
        case _DP_TX_AUDIO_OFF:
            ...
            // Disable DP TX Audio, Audio Timestamp and Audio Infoframe
            ScalerSetBit(PBC_00_SEC_FUNCTION_CTRL, ~(_BIT3 | _BIT1 | _BIT0), 0x00);
        ...
        case _DP_TX_AUDIO_ON:
            ...
            // Set Audio Infoframe
            ScalerDpTxAudioSetAudioInfoFrame();

            // DP Audio, Audio Timestamp and Audio Infoframe enable
            ScalerSetBit(PBC_00_SEC_FUNCTION_CTRL, ~(_BIT3 | _BIT1 | _BIT0), (_BIT3 | _BIT1 | _BIT0));
