...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6410_Series_QC_OSD.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6410_SERIES_QC_OSD__
...
#define _SRAM_SIZE_FONT_BASE_ADDRESS                    (21888 - (_SRAM_SIZE_4BIT_OFFSET * 4 * _ONE_1BIT_ADDRESS_SIZE) - (_SRAM_SIZE_4BIT_SIZE * 4 * _ONE_1BIT_ADDRESS_SIZE))  // max SRAM size

#define _QC_OSD_POSITION_OFFSET_H                       0x40
#define _QC_OSD_POSITION_OFFSET_V                       0x04

#define _QC_OSD_DOUBLE_POSITION_OFFSET_H                0x2C
...
enum OSDQCFrameDef
{
    ...
    _OSD_FRAME_21, _OSD_FRAME_21_1, _OSD_FRAME_21_2,
#endif
    _OSD_FRAME_END,
};
...
#if(_QC_5K3K_MODE_ == _ON)
BYTE code tQC_OSD_CRC_TABLE_21[] =
{
    0x00, 0x00, 0x00, 0xF1, 0xB2, 0x5D, // M1
    0x00, 0x00, 0x00, 0xF1, 0xB2, 0x5D, // M2
    0x6C, 0x59, 0x49, 0x63, 0xBE, 0x6B, // S1
    0xB3, 0x33, 0x17, 0x0C, 0xE9, 0x3D, // S2
};
#if 0
BYTE code tQC_OSD_CRC_TABLE_21_1_1[] =
{
    0x00, 0x00, 0x00, 0xF1, 0xB2, 0x5D, // M1
    0x00, 0x00, 0x00, 0xF1, 0xB2, 0x5D, // M2
    0xFF, 0x9D, 0x6D, 0x60, 0xEF, 0x42, // S1
    0x86, 0xDA, 0xB3, 0x06, 0x64, 0xDB, // S2
};
#endif
BYTE code tQC_OSD_CRC_TABLE_21_1[] =
{
    0x4F, 0x15, 0x1F, 0xC6, 0x5A, 0x8F, // M1
    0x4F, 0x15, 0x1F, 0xC6, 0x5A, 0x8F, // M2
    0x18, 0x5B, 0x84, 0xC6, 0x5A, 0x7F, // S1
    0x97, 0x18, 0x5C, 0x30, 0x65, 0xEC, // S2
};

#if 0
BYTE code tQC_OSD_CRC_TABLE_21_2_1[] =
{
    0xA4, 0x7D, 0x92, 0x38, 0xBC, 0x93, // M1
    0x2E, 0x19, 0xA8, 0x45, 0x4F, 0x15, // M2
    0xFD, 0xE3, 0x73, 0xC2, 0x98, 0x1B, // S1
    0x31, 0x04, 0x22, 0x0C, 0xCE, 0x35, // S2
};
#endif

BYTE code tQC_OSD_CRC_TABLE_21_2[] =
{
    0xCA, 0x63, 0x3D, 0x71, 0xC7, 0x33, // M1
    0x1A, 0x26, 0x2F, 0xA5, 0x7B, 0x10, // M2
    0xFA, 0xEE, 0x8B, 0x12, 0x84, 0xF6, // S1
    0xC4, 0xE3, 0x58, 0xBA, 0x59, 0x41, // S2
};
#endif
...
void ScalerQC_OSDFontScaleUp(bit bEnable, BYTE ucTpye, BYTE ucType2);
...
bit ScalerQC_OSDTestProc(BYTE ucShiftModeEn);
bit ScalerQCOSDTest(BYTE ucShiftModeEn);
...
void ScalerQC_OSDFontScaleUp(bit bEnable, BYTE ucTpye, BYTE ucType2)
{
    ...
    ScalerOsdFontScalingUpOnOff(bEnable);
    ScalerOsdFontScalingUpRatio(ucTpye);
    ScalerOsdFontScalingUpBoundaryCodition(ucType2);
}
...
void ScalerQC_OSDFuncFrame(BYTE ucFrameStatus)
{
    ...
    switch(ucFrameStatus)
    {
        ...
        case _OSD_FRAME_4:
            ...
            ScalerOsdVerticalBoundary(_ENABLE); // manual test for Boundary[11]
        ...
        case _OSD_FRAME_8:
            ScalerOsd2FontFunction(_DISABLE);
            ScalerQC_OSDFontScaleUp(_ENABLE, _OSD_FONT_SCALING_RATIO_150, _OSD_FONT_SCALING_BOUNDARY_NEIGHTBOOR);
        ...
        case _OSD_FRAME_10:
            ...
            ScalerSetBit(P3A_1E_FRAME_CTRL_1E, ~(_BIT7 | _BIT3), _BIT3);
            ScalerSetByte(P3A_2C_FRAME_CTRL_2C, _QC_OSD_DOUBLE_POSITION_OFFSET_V);
            ScalerSetByte(P3A_2F_FRAME_CTRL_2F, _QC_OSD_DOUBLE_POSITION_OFFSET_H);
        ...
        case _OSD_FRAME_17:
            ScalerOsd2FontFunction(_DISABLE);
            ScalerQC_OSDFontScaleUp(_ENABLE, _OSD_FONT_SCALING_RATIO_200, _OSD_FONT_SCALING_BOUNDARY_THIN);
        ...
        case _OSD_FRAME_18:
            ScalerOsd2FontFunction(_DISABLE);
            ScalerQC_OSDFontScaleUp(_ENABLE, _OSD_FONT_SCALING_RATIO_250, _OSD_FONT_SCALING_BOUNDARY_FAT);
        ...
        //----------------------------
        case _OSD_FRAME_20:
            ScalerQC_OSDFontScaleUp(_ENABLE, _OSD_FONT_SCALING_RATIO_300, _OSD_FONT_SCALING_BOUNDARY_NEIGHTBOOR);
           break;
        ...
        //----------------------------
        case _OSD_FRAME_21:
            ScalerSetByte(P87_F0_DISP_PG_R_CTRL_SUB, 0x80);
            ScalerSetByte(P87_F1_DISP_PG_G_CTRL_SUB, 0x00);
            ScalerSetByte(P87_F2_DISP_PG_B_CTRL_SUB, 0x00);
            ...
            ScalerGetDataPortByte(P0_2A_DISPLAY_FORMAT_ADDR_PORT, _P0_2B_PT_1F_DISPLAY_EXTENSION_FB_MAIN, 1, &ucExtension, _NON_AUTOINC);
            ScalerSetByte(P3A_2C_FRAME_CTRL_2C, (_QC_OSD_POSITION_OFFSET_V + 2));
            ScalerSetByte(P3A_2F_FRAME_CTRL_2F, (0x44 + ucExtension));
            ...
            SET_OSD_WINDOW_COLOR(5);
            SET_OSD_WINDOW_ENABLE(_ENABLE);
            ScalerOsdDrawWindow(X_START(0), Y_START(0), X_END(1), Y_END(1440));

            SET_OSD_WINDOW_NUMBER(_OSD_WINDOW_1);
            SET_OSD_WINDOW_COLOR(6);
            SET_OSD_WINDOW_ENABLE(_ENABLE);
            ScalerOsdDrawWindow(X_START(2559), Y_START(0), X_END(2560), Y_END(1440)); // X_START(5120 /2 - 1), X_END(5120 / 2)

            // Case 2
            ScalerOsdFBShiftBoundarySize(0, 0);
            ScalerOsdFBShiftValue(_OSD_FRONT_BACK_SHIFT_INSIDE, 0);
            ScalerOsdFBShiftValue(_OSD_FRONT_BACK_SHIFT_OUTSIDE, 2560);
        ...
        // _OSD_FRAME_21_1
        //----------------------------
        case _OSD_FRAME_21_1:
            // Case 3
            ScalerOsdWindowDisable(_OSD_WINDOW_1);

            ScalerOsdFBShiftBoundarySize(0, 0);
            ScalerOsdFBShiftValue(_OSD_FRONT_BACK_SHIFT_INSIDE, 0);
            ScalerOsdFBShiftValue(_OSD_FRONT_BACK_SHIFT_OUTSIDE, 0xFFF); // usOutBoundaryValue Max = 0xFFFF
            //ucIdx = (ucIdx | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2 | _S1 | _S2, tQC_OSD_CRC_TABLE_21_1_1, 1) << 0));

            // Case 4
            ScalerOsdFBShiftBoundarySize(0, 144); // 18 * 8 = 144
            ScalerOsdFBShiftValue(_OSD_FRONT_BACK_SHIFT_INSIDE, 2548); // 5120 / 2 - 12 = 2548
            ScalerOsdFBShiftValue(_OSD_FRONT_BACK_SHIFT_OUTSIDE, 0xFFF);
            break;

        //----------------------------
        // _OSD_FRAME_21_2
        //----------------------------
        case _OSD_FRAME_21_2:
            // Case 5
            ScalerOsdFBShiftBoundarySize(0, 144); // 18 * 8 = 144
            ScalerOsdFBShiftValue(_OSD_FRONT_BACK_SHIFT_INSIDE, 0);
            ScalerOsdFBShiftValue(_OSD_FRONT_BACK_SHIFT_OUTSIDE, 0xFFF);

            //ucIdx = (ucIdx | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2 | _S1 | _S2, tQC_OSD_CRC_TABLE_21_2_1, 1) << 0));

            // Case 6
            ScalerOsdPosition(_OSD_POSITION_GLOBAL_B, X_POS(0), Y_POS(0 + 252));
            ScalerOsdFBShiftBoundarySize(144, 252); // 18 * 8 = 144, 18 * 14 = 252
            ScalerOsdFBShiftValue(_OSD_FRONT_BACK_SHIFT_INSIDE, 0);
            ScalerOsdFBShiftValue(_OSD_FRONT_BACK_SHIFT_OUTSIDE, 0xFFF);
            break;
#endif
...
void ScalerQC_OSDCloseFuncFrame(BYTE ucFrameStatus)
{
    ...
    switch(ucFrameStatus)
    {
        ...
        case _OSD_FRAME_8:
            ScalerQC_OSDFontScaleUp(_DISABLE, _OSD_FONT_SCALING_RATIO_300, _OSD_FONT_SCALING_BOUNDARY_NEIGHTBOOR);
        ...
        case _OSD_FRAME_20:
            ScalerQC_OSDFontScaleUp(_DISABLE, _OSD_FONT_SCALING_RATIO_250, _OSD_FONT_SCALING_BOUNDARY_FAT);
            break;
...
bit ScalerQC_OSDTestProc(BYTE ucShiftModeEn)
{
    ...
    if(ucShiftModeEn == _OFF)
    {
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_1, 1) << 0));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_2, 1) << 1));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_2_1, 1) << 1));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_2_2, 1) << 1));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_2_3, 1) << 1));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_3, 1) << 2));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_4, 1) << 3));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_5, 1) << 4));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_6, 1) << 5));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_7, 1) << 6));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_8, 1) << 7));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_9, 1) << 8));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_10, 1) << 9));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_11, 1) << 10));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_12, 1) << 11));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_13, 1) << 12));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_14, 1) << 13));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_15, 1) << 14));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_16, 1) << 15));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_17, 1) << 0));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_18, 1) << 1));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_19, 1) << 2));
        ...
        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_20, 1) << 3));
    ...
    else
    {
        ...
        // frame 21
        //---------------------------------------
        DebugMessageQC("5.OsdTestFrame21 Start", 0x13);
        ScalerQC_OSDFuncFrame(_OSD_FRAME_21);

        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_21, 1) << 3));

        ScalerQC_OSDCloseFuncFrame(_OSD_FRAME_21);
        DebugMessageQC("5.OsdTestFrame21 END", 0x13);

        //---------------------------------------
        // frame 21_1
        //---------------------------------------
        DebugMessageQC("5.OsdTestFrame21_1 Start", 0x13);
        ScalerQC_OSDFuncFrame(_OSD_FRAME_21_1);

        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_21_1, 1) << 3));

        ScalerQC_OSDCloseFuncFrame(_OSD_FRAME_21_1);
        DebugMessageQC("5.OsdTestFrame21_1 END", 0x13);

        //---------------------------------------
        // frame 21_2
        //---------------------------------------
        DebugMessageQC("5.OsdTestFrame21_2 Start", 0x13);
        ScalerQC_OSDFuncFrame(_OSD_FRAME_21_2);

        usData = (usData | ((WORD)ScalerQCCRCCompare(_D_DOMAIN_CRC, _D_CRC_AFTER_OD, _M1 | _M2, tQC_OSD_CRC_TABLE_21_2, 1) << 3));

        ScalerQC_OSDCloseFuncFrame(_OSD_FRAME_21_2);
        DebugMessageQC("5.OsdTestFrame21_2 END", 0x13);
...
bit ScalerQCOSDTest(BYTE ucShiftModeEn)
{
    ...
    DebugMessageQC("5. OSD Start", ucShiftModeEn);

    bResult = ScalerQC_OSDTestProc(ucShiftModeEn);

    DebugMessageQC("5. OSD End", ucShiftModeEn);
