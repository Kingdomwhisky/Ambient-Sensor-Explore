...
// Type0: NO "received HB form CEC RX (0x18E3) & "Result of CEC TX sent (0x18B7[7:5])"
// Type1: NO "received HB form CEC RX (0x18E3)..ex. 6561 after ECO..
// Type2: ex. 6478, 1039...
//--------------------------------------------------
...
typedef enum
{
    ...
    _SENSOR_CALIBRATION_MODE,
    _DISPLAY_LOGO_MODE,    
    _FPGA_TEST_IMAGE_BACKUP_DISPLAY_MODE,   
    _LIGHTBOX_MODE_TYPE,
    _OGCOCC_SEL_BEACON,
    _GAMMA_NATIVE_SET_MODE,
    _KEY_LOCK_STATUS,        
    _ONEKEY_PLUS_LUMINANCE_DISPLAY_MODE,
    _FPGA_COLOR_ADAPTIVE_THRESHOLD,
    _FPGA_LOCAL_ENHANCEMENT_MODE, 
...
typedef enum
{
    ...
    _OGC_GAMMA21_TYPE = 10, //   UserCommonColorGetOGCAddr  ->ucDivisor_HeaderBank
    _OGC_GAMMA22_TYPE,
    _OGC_GAMMA23_TYPE,
    _OGC_GAMMA24_TYPE,
    _OGC_GAMMA25_TYPE,
    ...
    _OGC_GAMMA31_TYPE = 20, //   PC Calibration
    _OGC_GAMMA32_TYPE,      //   MCU Calibration CT1 Dicom
    _OGC_GAMMA33_TYPE,      //   MCU Calibration CT2 Dicom
    _OGC_GAMMA34_TYPE,      //   MCU Calibration CT1 Gamma
    _OGC_GAMMA35_TYPE,      //   MCU Calibration CT2 Gamma
#endif
...
typedef enum
{
    _TYPE_C_POWER_SNK = 0x00,
    _TYPE_C_POWER_SRC = 0x01,
    _TYPE_C_POWER_ROLE_NONE = 0xFF,
}EnumTypeCPowerRole;
...
typedef enum
{
    ...
    _5400_LENOVO_ALT_MODE_STATUS = 0x08,
    _5400_LENOVO_DEVICE_TYPE = 0x09,
    _5400_LENOVO_SYSTEM_EVENT = 0x0A,
}Enum5400InfoType;
...
typedef struct
{
    ...
    BYTE b2CecTxState : 2;
    BYTE bCecFxEnable : 1;
    BYTE bCecRxInfoAnalyzing : 1;
    BYTE bReadFromBackupFifo : 1;
