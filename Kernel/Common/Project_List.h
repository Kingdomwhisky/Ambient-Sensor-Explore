...
//--------------------------------------------------
//  Type C Ext Port Ctrl Lane Swap Option
//--------------------------------------------------
#define _TYPE_C_LANE_SWAP_BY_PORT_CTRL                    0x00
#define _TYPE_C_LANE_SWAP_BY_SCALER                       0x01
...
// Definitions of Logo Type
//-------------------------------------------------
#define _LOGO_NONE							              0
#define _LOGO_REALTEK							          1
#define _LOGO_BEACON							          2
#define _LOGO_DBI							          	  3
#define _LOGO_UNITED_IMAGING   			          	      4
#define _LOGO_MEDBOT							          5

//--------------------------------------------------
// Keypad List
//--------------------------------------------------
#define _KEYPAD_TYPE_RTD                                  0   
#define _KEYPAD_TYPE_BBK                                  1  //  Exit Right Menu Left
#define _KEYPAD_TYPE_3_5M                                 2  //  Menu enter Left Right Exit Power

//--------------------------------------------------
// Skip ColorTemp TYPE Define
//-------------------------------------------------
#define _kBIT_CT_NONE 							          0x0000 
#define _kBIT_CT_9300 							          0x0001 
#define _kBIT_CT_7500 							          0x0002
#define _kBIT_CT_6500 							          0x0004
#define _kBIT_CT_5800 							          0x0008
#define _kBIT_CT_SRGB 							          0x0010
#define _kBIT_CT_USER 							          0x0020
