...
#ifndef _PANEL_PWM_FREQUENCY
#define _PANEL_PWM_FREQUENCY                    200
#endif
...
#define _PCB_MBR_TCON_PIN                       _GEN_NONE
#endif
...
#define _PCB_MBR_DRIVER_IC_MAX_FREQ             _GEN_NONE
#endif
...
//--------------------------------------------------
#ifndef _PCB_SYS_EXTDEV_IIC0
#define _PCB_SYS_EXTDEV_IIC0                    _NO_IIC_PIN
#endif
...
//--------------------------------------------------
// Macro of Backlight Light PWM 
//--------------------------------------------------
#ifndef _BACKGROUND_LIGHT_PWM
#define _BACKGROUND_LIGHT_PWM                   _NO_PWM
#endif

//--------------------------------------------------
// Macro of Key Buzzer Beep PWM 
//--------------------------------------------------
#ifndef _BUZZER_BEEP_PWM
#define _BUZZER_BEEP_PWM                        _NO_PWM
#endif

//--------------------------------------------------
// Macro of USB HUB Power EN[H: On  L: Off]
//--------------------------------------------------
#ifndef PCB_USBHUB_POWER
#define PCB_USBHUB_POWER(x)                     {\
                                                }
#endif

//--------------------------------------------------
// Macro of USB HUB CHOOSE[H: HDMI  L: DP]
//--------------------------------------------------
#ifndef PCB_USBHUB_CHN_SEL
#define PCB_USBHUB_CHN_SEL(x)                   {\
                                                }
#endif
#ifndef PCB_USBHUB_CHN_SEL_DETECT
#define PCB_USBHUB_CHN_SEL_DETECT()             (0)
#endif

//--------------------------------------------------
// Macro of Background Light Control[H: On  L: Off]
//--------------------------------------------------
#ifndef PCB_BACKGROUND_LIGHT_EN
#define PCB_BACKGROUND_LIGHT_EN(x)              {\
                                                }
#endif
#ifndef PCB_BACKGROUND_LIGHT_EN_DETECT
#define PCB_BACKGROUND_LIGHT_EN_DETECT()        (0)
#endif

#ifndef PCB_BUZZER_BEEP_PWM
