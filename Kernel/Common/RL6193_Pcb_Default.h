...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6193_Pcb_Default.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#ifndef _A0_VGA_CONNECTOR_TYPE
#define _A0_VGA_CONNECTOR_TYPE                  _VGA_CONNECTOR_NORMAL
#endif

//--------------------------------------------------
// A1 Input Port
//--------------------------------------------------
#ifndef _A1_INPUT_PORT_TYPE
#define _A1_INPUT_PORT_TYPE                     _A1_NO_PORT
#endif

#ifndef _A1_VGA_CONNECTOR_TYPE
#define _A1_VGA_CONNECTOR_TYPE                  _VGA_CONNECTOR_NORMAL
#endif

//--------------------------------------------------
// A2 Input Port
//--------------------------------------------------
#ifndef _A2_INPUT_PORT_TYPE
#define _A2_INPUT_PORT_TYPE                     _A2_NO_PORT
#endif

#ifndef _A2_VGA_CONNECTOR_TYPE
#define _A2_VGA_CONNECTOR_TYPE                  _VGA_CONNECTOR_NORMAL
#endif
...
#ifndef _A1_INPUT_PORT_GROUP
#define _A1_INPUT_PORT_GROUP                    _INPUT_PORT_GROUP_NONE
#endif

#ifndef _A2_INPUT_PORT_GROUP
#define _A2_INPUT_PORT_GROUP                    _INPUT_PORT_GROUP_NONE
#endif
...
#ifndef _INPUT_PORT_SEARCH_PRI_9
...
////////////////////////////////////////////
// VGA A0 & A1 & A2 External Switch Macro //
////////////////////////////////////////////

//-----------------------------------------------
// Macro of VGA External Switch
//-----------------------------------------------
#ifndef PCB_VGA_SWITCH_A0
#define PCB_VGA_SWITCH_A0()                     {\
                                                }
#endif

#ifndef PCB_VGA_SWITCH_A1
#define PCB_VGA_SWITCH_A1()                     {\
                                                }
#endif

#ifndef PCB_VGA_SWITCH_A2
#define PCB_VGA_SWITCH_A2()                     {\
                                                }
#endif
