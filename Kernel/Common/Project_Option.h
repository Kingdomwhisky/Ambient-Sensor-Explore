...
//--------------------------------------------------
// Backlight Sensor
// TSL2561 Module IIC Addr: 0x52=(0101001<<1)  0x72=(0111001<<1)  0x92=(1001001<<1)
#define _BACKLIGHT_SENSOR_TSL2561_IIC_ADDR	                    0x52  

#define DS1631_IIC_ADDR	                                        0x90

// TSL2752 Module IIC Addr:  0x72=(0111001<<1) 
#define _BACKLIGHT_SENSOR_TSL2572_IIC_ADDR	                    0x72  

//--------------------------------------------------
// IIC1 Bus
//--------------------------------------------------
// Ambi Sensor
// TSL2581 Module IIC Addr: 0x92=(1001001<<1)
#define	_AMBI_SENSOR_TSL2581_IIC_ADDR                           0x92

// TSL45315 Module IIC Addr: 0x52=(0101001<<1)
#define	_AMBI_SENSOR_TSL45315_IIC_ADDR                          0x52

// VEML6030 Module IIC Addr: 0x20=(0010000<<1)
// Conflict veml3328    VDD: 0x90=(1001000<<1)
#define	_AMBI_SENSOR_VEML6030_IIC_ADDR                          0x90

// Front Sensor
// TCS3414 Module IIC Addr: 0x72=(0111001<<1)
#define _FRONT_SENSOR_TCS3414_IIC_ADDR		                    0x72 

// MTCSCDCAF Module IIC Addr: 0xE8=(11101A1A0<<1)
#define _FRONT_SENSOR_MTCSCDCAF_IIC_ADDR		                0xE8 

// Front Sensor
// VEML3328 Module IIC Addr: 0x20=(0010000<<1)
#define _FRONT_SENSOR_VEML3328_IIC_ADDR		                    0x20 

// Distance Sensor ID0      
// IIC Addr: 7-bit slave address 0x13(HEX)001 0011 shifted left 1 bit = 0x26
#define VCNL4020_IIC_ADDR	                                    0x26  

// Distance Sensor ID1       
// IIC Addr: 7-bit slave address 0x51(HEX)101 0001 shifted left 1 bit = 0xA2
#define VCNL4200_IIC_ADDR	                                    0xA2  

// Gravity Sensor       
// IIC Addr: 7-bit slave address 0xC(HEX)0011 00 shifted left 2 bit = 0x30
#define LIS3DH_IIC_ADDR	                                        0x32  
#if (_PRODUCT_ID_SEL == RTD2556_CANON_1201_RL6432_156PIN_A_G101ICE_L01_LVDS_PWM)
#define IICTOIO_TCA9537_ADDR                                            0x92
#endif
