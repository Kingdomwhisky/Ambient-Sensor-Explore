...
#define _HW_D1_INPUT_CLOCK_MAX                                  ((_D1_INPUT_PORT_TYPE == _D1_DP_PORT) ? 600000000 : ((_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == _ON) ? 404000000 : 340000000)) // Unit: Hz , DP 1.2 , HDMI2.0(3.4G)
#define _HW_D2_INPUT_CLOCK_MAX                                  ((_D2_INPUT_PORT_TYPE == _D2_DVI_PORT) ? 330000000 : ((_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == _ON) ? 404000000 : 340000000)) // Unit: Hz , Dual DVI , HDMI2.0(3.4G) , MHL3.2
#define _HW_D3_INPUT_CLOCK_MAX                                  ((_D3_INPUT_PORT_TYPE == _D3_DVI_PORT) ? 330000000 : ((_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == _ON) ? 404000000 : 340000000)) // Unit: Hz , Dual DVI , HDMI2.0(3.4G) , MHL3.2
