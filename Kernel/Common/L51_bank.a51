...
?B_NBANKS       EQU  _FLASH_PARTITION_TOTAL_BANKS;                            *
...
?B_FIRSTBIT     EQU     5        ; default is Bit 2                           *
;-----------------------------------------------------------------------------*
ENDIF;                                                                        *
;                                                                             *
IF  ?B_MODE = 1;                                                              *
...
?C_BANKOFFSET:  PUSH    PSW
                ADD     A,30H       ; switch bank with offset
                POP     PSW
                RET
#endif
...
?C_INITSEG      SEGMENT CODE            ; Segment for Variable Initialization
                ...
                DB      0               ; Set to Zero
#if((_FLASH_PARTITION_TYPE != _FLASH_PARTITION_USER) || (_FLASH_PARTITION_RELOCATABLE_SUPPORT == _OFF))
                DB      41H                        ; XData
                DW      ?B_XDATAPORT               ; Init XDATA Port
                DB      _FLASH_PARTITION_INIT_BANK ; Set to intial bank
#endif
