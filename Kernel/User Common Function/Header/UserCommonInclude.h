...
#define _OGCOCC_LV_RARIO_LENGTH                        ((_OGC_TOTAL_CT + 5) * 2)
...
#define _OCC_SRGBMATRIX_ADDRESS                        (_OGC_TOTAL_CT > 6 ? 0x500 : 0x400)
...
#define _OGC_HDR10_NOTM_BOUND_ADDRESS                  (_OGC_HDR10_IG_NOTM_DISPLAY_HDR_1_1_ADDRESS + _OGC_HDR10_IG_TABLE_SIZE * _HDR10_SUPPORT * (_DISPLAY_HDR_VERSION == _DISPLAY_HDR_VERSION_1_1 ? 1 : 0))
...
#if 1//(_BEACON_GAMMA_PCM_PARTITION_SUPPORT == _ON)
#define _BEACON_OGC_GAMMA_TABLE_SIZE                   0x180C // 2200*3 = 0x19C8 2052 * 3 = 0x180C

#define _BEACON_OGC_GAMMA1_ADDRESS                     (0 + 3)
#define _BEACON_OGC_GAMMA2_ADDRESS                     (_BEACON_OGC_GAMMA1_ADDRESS + _BEACON_OGC_GAMMA_TABLE_SIZE)
#define _BEACON_OGC_GAMMA3_ADDRESS                     (_BEACON_OGC_GAMMA2_ADDRESS + _BEACON_OGC_GAMMA_TABLE_SIZE)
#define _BEACON_OGC_GAMMA4_ADDRESS                     (_BEACON_OGC_GAMMA3_ADDRESS + _BEACON_OGC_GAMMA_TABLE_SIZE)
#define _BEACON_OGC_GAMMA5_ADDRESS                     (_BEACON_OGC_GAMMA4_ADDRESS + _BEACON_OGC_GAMMA_TABLE_SIZE)
#define _BEACON_OGC_GAMMA6_ADDRESS                     (_BEACON_OGC_GAMMA5_ADDRESS + _BEACON_OGC_GAMMA_TABLE_SIZE) 
#define _BEACON_OGC_GAMMA7_ADDRESS                     (_BEACON_OGC_GAMMA6_ADDRESS + _BEACON_OGC_GAMMA_TABLE_SIZE)
#define _BEACON_OGC_GAMMA8_ADDRESS                     (_BEACON_OGC_GAMMA7_ADDRESS + _BEACON_OGC_GAMMA_TABLE_SIZE)
#define _BEACON_OGC_GAMMA9_ADDRESS                     (_BEACON_OGC_GAMMA8_ADDRESS + _BEACON_OGC_GAMMA_TABLE_SIZE)
#define _BEACON_OGC_GAMMA10_ADDRESS                    (_BEACON_OGC_GAMMA9_ADDRESS + _BEACON_OGC_GAMMA_TABLE_SIZE)

// X-Rite Independent CT calibration(220411)  
// Change from continuous storage to separate storage of each group of curves
#define _BEACON_XRITE_CALIB_TABLE_SIZE                 (0x2000)  // 2200*3 = 0x19C8 2052 * 3 = 0x180C   Flash 2 Page: _FLASH_PAGE_SIZE 

#define _BEACON_OGC_CALIB1_ADDRESS                     (0 + 3)   // (0x03) PC Calibration 
#define _BEACON_OGC_CALIB2_ADDRESS                     (0x2000)  // (0x2000) MCU Calibration CT1 DICOM
#define _BEACON_OGC_CALIB3_ADDRESS                     (_BEACON_OGC_CALIB2_ADDRESS + _BEACON_XRITE_CALIB_TABLE_SIZE) // (0x4000) MCU Calibration CT2 DICOM
#define _BEACON_OGC_CALIB4_ADDRESS                     (_BEACON_OGC_CALIB3_ADDRESS + _BEACON_XRITE_CALIB_TABLE_SIZE) // (0x6000) MCU Calibration CT1 Gamma
#define _BEACON_OGC_CALIB5_ADDRESS                     (_BEACON_OGC_CALIB4_ADDRESS + _BEACON_XRITE_CALIB_TABLE_SIZE) // (0x8000) MCU Calibration CT2 Gamma
#define _BEACON_OGC_CALIB_END                          (_BEACON_OGC_CALIB5_ADDRESS + _BEACON_XRITE_CALIB_TABLE_SIZE)
...
typedef struct
{
    ...
    BYTE b3SensorCalibrationMode : 3;           // Color Sensor Calibration Mode
    BYTE b1DisplayLogoMode : 1;                 // Display Logo On/Off
    BYTE b2LightboxModeType : 2;                // Lightbox Mode Type
    BYTE b1OGCOCCSelectMode : 1;                // OGC&OCC Select RTD or Beacon
    BYTE b1GammaNativeMode : 1;                 // Gamma Native Mode
    BYTE b1KeyLockStatus : 1;                   // Key Lock Status    
    BYTE b1OneKeyPlusLuminanceDisplay : 1;      // OneKey Plus Display luminance   
    BYTE b3FPGAColorAdaptiveThreshold : 3;      // FPGA Color Adaptive Threshold
    BYTE b1FPGALocalEnhancementMode : 1;        // FPGA Local Enhancement Mode
    
    BYTE ucTestImageBackupDisplayMode;          // TestImage Backup Display Mode
...
#if(_TYPE_C_RTS5400_SERIES_PDO_INFO_SUPPORT == _ON)
    StructSMBusWRGetPartnerPdo stWrGetPartnerPdo;
...
#if(_TYPE_C_RTS5400_SERIES_PDO_INFO_SUPPORT == _ON)
    StructSMBusRDGetPartnerPdo stRdGetPartnerPdo;
...
extern BYTE UserCommonDdcciCalRxCheckSum(void); // for beacon gamma auto adjust function
