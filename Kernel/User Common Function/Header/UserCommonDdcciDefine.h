...
#define _DDCCI_CMD_FACTORY_GAMMA_AUTO_PROCESS       0xC0 // DDCCI On Line Beacon Gamma Auto Processing  
#if (defined(_PROTOCOL_DBI_COLOR_SENSOR_CALIBRATION))
#define _DDCCI_CMD_COLOR_SENSOR_CALIBRATION         0xC3 // DDCCI On Line DBI Protocol Color Sensor Calibration 
#else
#define _DDCCI_CMD_COLOR_SENSOR_CALIBRATION         0xC2 // DDCCI On Line Beacon Protocol Color Sensor Calibration 
#endif
...
#define _DDCCI_OPCODE_VCP_BACKLIGHT_PWM_FREQ        0x6A
...
#define _DDCCI_OPCODE_VCP_GRB_LIGHT_VERSION		    0xE5
#endif
// Sync GE IRD
#define _DDCCI_OPCODE_VCP_BEACON_HW_VERSION		    0xE6
#define _DDCCI_OPCODE_VCP_BEACON_FW_VERSION		    0xE7
#define _DDCCI_OPCODE_VCP_BEACON_MONITOR_SN		    0xE8
...
//--------------------------------------------------
//Definitions of DDCCI On Line Beacon Front Color Sensor Calibration cmd
//--------------------------------------------------
#define _DDCCI_SENSOR_CALIB_GET_ORDER_STATUS 		0x00
#define _DDCCI_SENSOR_CALIB_GET_INFO		        0x01 
#define _DDCCI_SENSOR_CALIB_GET_STATUS 				0x02
#define _DDCCI_SENSOR_CALIB_GET_FSENSOR_DATA 		0x03
#define _DDCCI_SENSOR_CALIB_SET_WIN_POS 		    0x04
#define _DDCCI_SENSOR_CALIB_SET_WIN_RGB 		    0x05
#define _DDCCI_SENSOR_CALIB_GET_AMBI_LUMI 			0x06
#define _DDCCI_SENSOR_CALIB_SET_BACKLIGHT 			0x07
#define _DDCCI_SENSOR_CALIB_SAVE_BACKLIGHT 		    0x08
#define _DDCCI_SENSOR_CALIB_SET_LUT_DATA 			0x09
#define _DDCCI_SENSOR_CALIB_GET_LUT_DATA 			0x0a
#define _DDCCI_SENSOR_CALIB_SET_COLOR_TEMP 			0x0b
#define _DDCCI_SENSOR_CALIB_GET_LUT_ATTRI 			0x0c
#define _DDCCI_SENSOR_CALIB_SET_LUT_ATTRI 			0x0d
#define _DDCCI_SENSOR_CALIB_SET_LUT_ENTRY_VALUE 	0x0e /* set value for the lut entry*/
#define _DDCCI_SENSOR_CALIB_SET_SN 				    0x0f
#define _DDCCI_SENSOR_CALIB_GET_SN 					0x10
#define _DDCCI_SENSOR_CALIB_SET_CO_TABLE 			0x11
#define _DDCCI_SENSOR_CALIB_GET_CO_TABLE 			0x12
#define _DDCCI_SENSOR_CALIB_SET_FSENSOR_I2C 		0x13
#define _DDCCI_SENSOR_CALIB_GET_FSENSOR_I2C 		0x14
#define _DDCCI_SENSOR_CALIB_SET_FSENSOR_MATRIX 	    0x15
#define _DDCCI_SENSOR_CALIB_GET_FSENSOR_MATRIX 		0x16
#define _DDCCI_SENSOR_CALIB_SET_GSDF_DATA 			0x17
#define _DDCCI_SENSOR_CALIB_GET_GSDF_DATA 			0x18

#define _DDCCI_SENSOR_CALIB_GET_GAMMA_NAME_INFO		0x19
#define _DDCCI_SENSOR_CALIB_GET_CURRENT_GAMMA		0x1a
#define _DDCCI_SENSOR_CALIB_SET_CURRENT_GAMMA		0x1b

//For RTD2796
#define _DDCCI_SENSOR_CALIB_GET_PROTOCOL_INFOR		0x1c
#define _DDCCI_SENSOR_CALIB_GET_GEN_BASIC_INFO		0x1d
#define _DDCCI_SENSOR_CALIB_GET_DISP_RES_AND_POS	0x1e
#define _DDCCI_SENSOR_CALIB_GET_MODEL_STRING		0x1f
#define _DDCCI_SENSOR_CALIB_GET_FSENSOR_MATRIX_PART	0x20

//For X-Rite
#define _DDCCI_SENSOR_CALIB_SET_ATTRIBUTE_INFO	    0x24
#define _DDCCI_SENSOR_CALIB_GET_ATTRIBUTE_INFO	    0x25

// protocol version >=5.1
#define _DDCCI_SENSOR_CALIB_SET_LUX_RANGE_PARAMTER	0x26 // Same as _DDCCI_GAMMA_ADJUST_SET_PANEL_LUX_RANGE_PARAMTER
#define _DDCCI_SENSOR_CALIB_GET_LUX_RANGE_PARAMTER	0x27 // Same as _DDCCI_GAMMA_ADJUST_GET_PANEL_LUX_RANGE_PARAMTER

//#define _DDCCI_SENSOR_CALIB_GET_LUX_RANGE_PARAMTER  0x26
//#define _DDCCI_SENSOR_CALIB_SET_LUX_RANGE_PARAMTER  0x27

// For Richardson->DBI
#define _DDCCI_SENSOR_CALIB_SET_CUSTOM_DATA 		0x30
#define _DDCCI_SENSOR_CALIB_GET_CUSTOM_DATA 		0x31

#define _DDCCI_SENSOR_CALIB_GET_SYSTEM_TIME_TEMP	0x32
#define _DDCCI_SENSOR_CALIB_GET_BACKLIGHT		    0x33
#define _DDCCI_SENSOR_CALIB_GET_FW_VERSION		    0x34

#define _DDCCI_SENSOR_CALIB_SET_FPGA_HYBRID_GAMMA	0x35
#define _DDCCI_SENSOR_CALIB_GET_FPGA_HYBRID_GAMMA	0x36


// For ARM MCU Function
#define _DDCCI_NOTIFY_ARM_MCU_READ_DATA				0x40  
#define _DDCCI_ARM_MCU_QA_RESULT					0x41  
#define _DDCCI_ARM_MCU_GET_LUM_DIFF					0x42  
#define _DDCCI_ARM_MCU_GET_VERSION					0x43  
#define _DDCCI_ARM_MCU_READ_GAMMA_DATA				0x44  
#define _DDCCI_ARM_MCU_GET_QA_CALI_DATA				0x45  
#define _DDCCI_ARM_MCU_GET_MAX_MIN_LUX				0x46  


#define _DDCCI_SENSOR_CALIB_WRITE_AMBI_AB_DATA		0x50
#define _DDCCI_SENSOR_CALIB_SET_AMBI_AB_DATA		0x51    
#define _DDCCI_SENSOR_CALIB_READ_AMBI_RELATIVE		0x5A
//====================================================================
#endif
