...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6492_DEMO_E_156PIN_1A1H1TC1DP_LVDS_eDP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6492_DEMO_E_156PIN_1A1H1TC1DP_LVDS_eDP)
...
#define _TYPE_C_PMIC_TYPE                       _PMIC_RAA489800
#define _TYPE_C_RX0_PMIC_SLAVE_ADDRESS          0x90
#define _TYPE_C_PMIC_INT_PIN_CHECK_METHOD       _TYPE_C_PMIC_INT_PIN_NONE   // _TYPE_C_PMIC_INT_PIN_CHECK_BY_POLLING
...
// Series Pin Share //
//////////////////////
#include "RL6492_DEMO_E_156PIN_1A1H1TC1DP_LVDS_eDP_PINSHARE.h"
...
#define PCB_ON_REGION_GPIO_SETTING_POWER_AC_ON(){\
                                                    ...
                                                    PCB_PMIC_RVSEN_CONTROL(_RVSEN_CONTROL_OFF);\
                                                }
#endif
...
////////////////////////
// ISL95338 Power Macro //
////////////////////////

//-----------------------------------------------
// Macro of PMIC FRWEN Control
//-----------------------------------------------
#define bPMIC_FRWEN_CONTROL                     _PIN_23_MCU_REG

#define _FRWEN_CONTROL_ON                       1
#define _FRWEN_CONTROL_OFF                      0

#define PCB_PMIC_FRWEN_CONTROL(x)               {\
                                                  bPMIC_FRWEN_CONTROL = (x);\
                                                }

//-----------------------------------------------
// Macro of PMIC RVSEN Control
//-----------------------------------------------
#define bPMIC_RVSEN_CONTROL                     _PIN_37_MCU_REG

#define _RVSEN_CONTROL_ON                       1
#define _RVSEN_CONTROL_OFF                      0

#define PCB_PMIC_RVSEN_CONTROL(x)               {\
                                                  bPMIC_RVSEN_CONTROL = (x);\
                                                }
...
//-----------------------------------------------
#define bPMIC_VBUS_SOURCE_CONTROL               (_PIN_38_MCU_REG)

#define _VBUS_SOURCE_SWITCH_ON                  0
#define _VBUS_SOURCE_SWITCH_OFF                 1
...
//-----------------------------------------------
#define bVBUS_DISCHARGE_CONTROL                 (_PIN_24_MCU_REG)
...
//-----------------------------------------------
// Macro of Pmic FRW PG
//-----------------------------------------------
#define bPMIC_FRWPG                             _PIN_42_MCU_REG

#define PCB_PMIC_FRWPG_DETECT()                 (bPMIC_FRWPG)

//-----------------------------------------------
// Macro of Pmic RVS PG
//-----------------------------------------------
#define bPMIC_RVSPG                             _PIN_44_MCU_REG

#define PCB_PMIC_RVSPG_DETECT()                 (bPMIC_RVSPG)

//-----------------------------------------------
// Macro of Pmic Alert
//-----------------------------------------------
#define bPMIC_ALERT                             _PIN_43_MCU_REG

#define _PMIC_ALERT_ON                          0
#define _PMIC_ALERT_OFF                         1
...
//--------------------------------------------------
#define bLVDSDPTX_GPU_SWICH                     _PIN_22_MCU_REG
...
#endif // End of #if(_PCB_TYPE == _RL6492_DEMO_E_156PIN_1A1H1TC1DP_LVDS_eDP)
