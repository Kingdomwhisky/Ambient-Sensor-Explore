...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6410_QA_A_MOTION_BLUR_REDUCTION.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6410_QA_A_MOTION_BLUR_REDUCTION)
...
// Series Pin Share //
//////////////////////
#include "RL6410_QA_A_MOTION_BLUR_REDUCTION_PINSHARE.h"
...
#endif // End of #if(_PCB_TYPE == _RL6410_QA_A_MOTION_BLUR_REDUCTION)
