...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6449_QA_A_MOTION_BLUR_REDUCTION_1A2MHL1DP1mDP_DPTX_eDP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6449_QA_A_MOTION_BLUR_REDUCTION_1A2MHL1DP1mDP_DPTX_eDP)
...
#define _VBO_PRE_EMPHASIS_CONTROL               _VBO_PRE_EMPHASIS_1

//--------------------------------------------------
// V by One SSC Config
//--------------------------------------------------
#define _VBO_SPREAD_RANGE                       0
...
//--------------------------------------------------
#define _PCB_MBR_TCON_PIN                       _TCON11
...
// Series Pin Share //
//////////////////////
#include "RL6449_QA_A_MOTION_BLUR_REDUCTION_1A2MHL1DP1mDP_DPTX_eDP_PINSHARE.h"
...
#define PCB_BACKLIGHT_POWER(x)                  {\
                                                    ...
                                                    UserCommonInterfaceMbrStrobeBacklightCtrl(x);\
...
#define PCB_PWM_SETTING()                       {\
                                                    ScalerMcuPwmAdjustFrequency(_BACKLIGHT_PWM, 30000);\
                                                }
...
#endif // End of #if(_PCB_TYPE == _RL6449_QA_A_MOTION_BLUR_REDUCTION_1A2MHL1DP1mDP_DPTX_eDP)
