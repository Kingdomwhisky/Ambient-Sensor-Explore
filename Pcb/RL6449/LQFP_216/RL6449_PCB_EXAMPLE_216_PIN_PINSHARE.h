...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6449_PCB_EXAMPLE_216_PIN_PINSHARE.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _PIN_65                                 (1 & 0x0F) // Page 10-0x02[2:0]
// 0 ~ 8 (0: P1D2i<I>, 1: P1D2o<PP>, 2: P1D2o<OD>, 8: ddcsclvga<OD>)

#define _PIN_66                                 (1 & 0x0F) // Page 10-0x03[2:0]
...
#define _PIN_95                                 (1 & 0x0F) // Page 10-0x10[2:0]
...
#define _PIN_115_OFF_REGION                     (1 & 0x0F) // Page 10-0x17[2:0]
// 0 ~ 4 (0: P4D7i<I>, 1: P4D7o<PP>, 2: P4D7o<OD>, 3: audio_ref, 4: mck)

#define _PIN_116_OFF_REGION                     (1 & 0x0F) // Page 10-0x18[2:0]
// 0 ~ 5 (0: P5D0i<I>, 1: P5D0o<PP>, 2: P5D0o<OD>, 3: audio_soutl, 4: sd0, 5: spdif0)

#define _PIN_117_OFF_REGION                     (1 & 0x0F) // Page 10-0x19[2:0]
...
#define _PIN_148_OFF_REGION                     (1 & 0x0F) // Page 10-0x1F[2:0]
...
#define _PIN_179                                (1 & 0x0F) // Page 10-0x31[2:0]
...
#define _PIN_209                                (1 & 0x0F) // Page 10-0x46[2:0]
// 0 ~ 2 (0: PAD6i<I>, 1: PAD6o<PP>, 2: PAD6o<OD>)

#define _PIN_210                                (1 & 0x0F) // Page 10-0x47[2:0]
// 0 ~ 8 (0: PAD7i<I>, 1: PAD7o<PP>, 2: PAD7o<OD>, 8: eeiicscl)

#define _PIN_211                                (1 & 0x0F) // Page 10-0x48[2:0]
