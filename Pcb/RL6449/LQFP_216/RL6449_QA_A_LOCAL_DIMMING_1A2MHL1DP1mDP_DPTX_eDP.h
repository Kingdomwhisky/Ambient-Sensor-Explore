...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6449_QA_A_LOCAL_DIMMING_1A2MHL1DP1mDP_DPTX_eDP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6449_QA_A_LOCAL_DIMMING_1A2MHL1DP1mDP_DPTX_eDP)
...
// Series Pin Share //
//////////////////////
#include "RL6449_QA_A_LOCAL_DIMMING_1A2MHL1DP1mDP_DPTX_eDP_PINSHARE.h"
...
#endif // End of #if(_PCB_TYPE == _RL6449_QA_A_LOCAL_DIMMING_DPTX_eDP)
