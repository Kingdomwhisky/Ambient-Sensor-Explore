...
// Series Pin Share //
//////////////////////
#include "RL6432_BEACON_A_216PIN_1DP1HDMI1DUALDVI_DPTX_LVDS_eDP_PINSHARE.h"
...
#define PCB_BACKLIGHT_POWER(x)                  {\
                                                    ...
                                                    {\
                                                        ...
                                                        ScalerMcuPwmAdjustFrequency(_BACKGROUND_LIGHT_PWM, 600);\
                                                        ScalerMcuPwmAdjustFrequency(_BUZZER_BEEP_PWM, 2000);\
                                                    ...
                                                    {\
                                                        ...
                                                        ScalerTimerActiveTimerEvent(SEC(60), _USER_TIMER_EVENT_SYSTEM_RUN_USED_TIMER);\
                                                    	        ...
                                                    	        DebugMessageUart("PCB_BACKLIGHT_POWER_pin:", x);\
...
//#if (_KEYPAD_TYPE == _KEYPAD_TYPE_3_5M) // 3_5M 
//#endif
