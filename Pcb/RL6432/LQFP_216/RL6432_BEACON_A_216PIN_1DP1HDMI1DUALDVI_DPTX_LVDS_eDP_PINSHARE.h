...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432_BEACON_A_216PIN_1DP1HDMI1DUALDVI_DPTX_LVDS_eDP_PINSHARE.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
// Panel_ON
#define _PIN_170_OFF_REGION                     (2 & 0x0F) // Page 10-0x22[2:0]
...
// IIC_SCL
#define _PIN_179_OFF_REGION                     (2 & 0x0F) // Page 10-0x26[2:0]
// 0 ~ 8 (0: P6D6i<I>, 1: P6D6o<PP>, 2: P6D6o<OD>, 3: TCON[6],
//        4: IHS_after_scaling_down, 8: IICSCL1)

// IIC_SDA
#define _PIN_180_OFF_REGION                     (2 & 0x0F) // Page 10-0x27[2:0]
// 0 ~ 8 (0: P6D7i<I>, 1: P6D7o<PP>, 2: P6D7o<OD>, 3: tcon[7],
//        4: IVS_after_scaling_down, 8: IICSDA1)
#else
// IIC_SCL
#define _PIN_179_OFF_REGION                     (8 & 0x0F) // Page 10-0x26[2:0]
// 0 ~ 8 (0: P6D6i<I>, 1: P6D6o<PP>, 2: P6D6o<OD>, 3: TCON[6],
//        4: IHS_after_scaling_down, 8: IICSCL1)

// IIC_SDA
#define _PIN_180_OFF_REGION                     (8 & 0x0F) // Page 10-0x27[2:0]
// 0 ~ 8 (0: P6D7i<I>, 1: P6D7o<PP>, 2: P6D7o<OD>, 3: tcon[7],
//        4: IVS_after_scaling_down, 8: IICSDA1)
#endif
...
// LED_PWM
#define _PIN_192                                (3 & 0x0F) // Page 10-0x2A[2:0]
// 0 ~ 6 (0: P7D2i<I>, 1: P7D2o<PP>, 2: P7D2o<OD>, 3: PWM2<PP>, 4: PWM2<OD>,
//        5: TCON[1],  6: IRDA_in )

// Buzzer_Power(Key)
#define _PIN_193                                (3 & 0x0F) // Page 10-0x2B[2:0]
...
#else
// IIC_SCL_2
#define _PIN_198                                (8 & 0x0F) // Page 10-0x30[2:0]
// 0 ~ 8 (0: P8D0i<I>, 1: P8D0o<PP>, 2: P8D0o<OD>, 3: PWM4<PP>, 4: PWM4<OD>,
//        5: TCON[11], 8: IICSCL2)

// IIC_SDA_2
#define _PIN_199                                (8 & 0x0F) // Page 10-0x31[2:0]
// 0 ~ 8 (0: P8D1i<I>, 1: P8D1o<PP>, 2: P8D1o<OD>, 3: PWM3<PP>, 4: PWM3<OD>,
//        5: TCON[0],  8: IICSDA2)
#endif
...
// EEPROM_WP
#define _PIN_204                                (2 & 0x0F) // Page 10-0x36[2:0]
// 0 ~ 7 (0: P8D6i<I>,    1: P8D6o<PP>,   2: P8D6o<OD>, 3:  tcon[10], 4: sck,
//        5: Test4b_out1, 6: Test4b_out2, 7: Test4b_out3)

// VCCK_OFF_EN
#define _PIN_205                                (2 & 0x0F) // Page 10-0x37[2:0]
...
#if(_SW_IIC_SUPPORT == _ON)
// EESCL
#define _PIN_210                                (2 & 0x0F) // Page 10-0x3A[2:0]
// 0 ~ 8 (0: P9D2i<I>, 1: P9D2o<PP>, 2: P9D2o<OD>, 3: PWM0<PP>, 4: PWM0<OD>
//        5: TCON[1],  8: EEIICSCL)

// EESDA
#define _PIN_211                                (2 & 0x0F) // Page 10-0x3B[2:0]
...
// EDID_SW
#define _PIN_216                                (2 & 0x0F) // Page 10-0x40[2:0]
