...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432_BBK_A_HDMI_D3_216PIN_LVDS.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6432_BBK_A_HDMI_D3_216PIN_LVDS)
...
#define _PCB_SYS_EEPROM_IIC                     ((_HW_IIC_SUPPORT == _ON) ? (_HW_IIC_PIN_210_211) : _SW_IIC_PIN_GPIO)

//--------------------------------------------------
// External Device Sofware or Hardware IIC Bus Option 
//--------------------------------------------------
...
// Series Pin Share //
//////////////////////
#include "RL6432_BBK_A_HDMI_D3_216PIN_LVDS_PINSHARE.h"
...
//-----------------------------------------------
#define bD0_DP_PIN15_CONNECT                    (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(MCU_FE25_PORT85_PIN_REG) // Pin_203, P8.5
#define bD0_DP_PIN16_CONNECT                    (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(P1_3) // Pin_53, P1.3
#define bD0_DP_PIN17_CONNECT                    (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(MCU_FE24_PORT84_PIN_REG) // Pin_202, P8.4
#define bD1_DP_PIN15_CONNECT                    (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(MCU_FE27_PORT87_PIN_REG) // Pin_205, P8.7
#define bD1_DP_PIN16_CONNECT                    (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(P1_4) // Pin_54, P1.4
#define bD1_DP_PIN17_CONNECT                    (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(MCU_FE26_PORT86_PIN_REG) // Pin_204, P8.6

#define bA0_CONNECT                             (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(P1_7)  // Pin_68, P1.7
...
#define bD2_CONNECT                             (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(MCU_FE30_PORTA0_PIN_REG) // PIN_216, PA.0
...
//-----------------------------------------------
#define bD2_MHL_CONNECT                         (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(P3_7) // Pin_94, P3.7
#define bD3_MHL_CONNECT                         (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(P3_6) // Pin_93, P3.6
...
//-----------------------------------------------
#define bD0_HPD                                 (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(MCU_FE22_PORT82_PIN_REG) // Pin_201, P8.2 
#define bD1_HPD                                 (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(MCU_FE23_PORT83_PIN_REG) // Pin_200, P8.3 
#define bD2_HPD                                 (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(P1_2) // Pin_15, P1.2
...
//-----------------------------------------------
#define bD2_TMDS_SWITCH                         (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(MCU_FE1C_PORT74_PIN_REG) // Pin_194, P7.4
#define bD3_TMDS_SWITCH                         (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(MCU_FE1D_PORT75_PIN_REG) // Pin_195, P7.5
...
//-----------------------------------------------
#define bD2_MHL_VBUS_SWITCH                     (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(MCU_FE1A_PORT72_PIN_REG) // Pin_192, P7.2
#define bD3_MHL_VBUS_SWITCH                     (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(MCU_FE1B_PORT73_PIN_REG) // Pin_193, P7.3
...
#if (_KEYPAD_TYPE == _KEYPAD_TYPE_BBK) // BBK 
...
//_IIC_SYS_BUS_I2C0: Backlight Sensor
#define bSWIIC_SYS_BUS_I2C0_SCL                 (MCU_FE16_PORT66_PIN_REG)  // _PIN_179 P6.6
#define bSWIIC_SYS_BUS_I2C0_SDA                 (MCU_FE17_PORT67_PIN_REG)  // _PIN_180 P6.7
...
#endif // End of #if(_PCB_TYPE == _RL6432_BBK_A_HDMI_D3_216PIN_LVDS)
