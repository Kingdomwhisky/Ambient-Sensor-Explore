...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432_CANON_A_156PIN_1DUALDVI_LVDS_PINSHARE.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
//DVI_CAB_DETECTION//HDMI_CABLE_DETECT_3
...
//--------------------------------------1
// int//DPTX_AUX_P_2
#define _156PIN_PIN_51_OFF_REGION               (0 & 0x0F) // Page 10-0x19[2:0]
...
// FLASH_WP
#define _156PIN_PIN_61                          (2 & 0x0F) // Page 10-0x29[2:0]
...
// nc/14v_en//MHL_DETECT_3
#define _156PIN_PIN_65                          (1 & 0x0F) // Page 10-0x2D[2:0]
// 0 ~ 7 (0: P7D5i<I>,    1: P7D5o<PP>,   2: P7D5o<OD>, 3: tcon[4], 4: pwm_in,
//        5: Test4b_out1, 6: Test4b_out2, 7: Test4b_out3)
//-----------------------------------------------------2

// LED_GREEN//POWER_RESET //NC (DDR_PW_EN)
#define _156PIN_PIN_66                         (1 & 0x0F) //  (1 & 0x0F) // Page 10-0x2F[2:0]//------3
...
// UART-//DP_HOT_PLUG_0
#define _156PIN_PIN_70                          (8 & 0x0F) //(1 & 0x0F) //(8 & 0x0F) // Page 10-0x32[2:0]//---1
// 0 ~ 8 (0: P8D2i<I>,    1: P8D2o<PP>,   2: P8D2o<OD>,   3: int0, 4: Test4b_out0,
//        5: Test4b_out1, 6: Test4b_out2, 7: Test4b_out3, 8: TXD)

//UART//NC// DP_HOT_PLUG_1
#define _156PIN_PIN_69                          (8 & 0x0F) //(1 & 0x0F) //(8 & 0x0F) // Page 10-0x33[2:0]//---1
...
// 2556_REST1
#define _156PIN_PIN_72                          (2 & 0x0F) // Page 10-0x35[2:0]
...
// EESCL
#define _156PIN_PIN_77                          (8 & 0x0F) //(8 & 0x0F) //(2 & 0x0F) // Page 10-0x3A[2:0]
// 0 ~ 8 (0: P9D2i<I>, 1: P9D2o<PP>, 2: P9D2o<OD>, 3: PWM0<PP>, 4: PWM0<OD>
//        5: TCON[1],  8: EEIICSCL)


// EESDA
#define _156PIN_PIN_78                         (8 & 0x0F) //(8 & 0x0F) // (2 & 0x0F) // Page 10-0x3B[2:0]
...
//nc// DP5V_ON
#define _156PIN_PIN_81                         (1 & 0x0F)// (0 & 0x0F) // Page 10-0x40[2:0]//------2
...
// TXA1P
#define _156PIN_PIN_41_OFF_REGION               (1 & 0x0F) // Page 10-0x57[2:0]
// 0 ~ 5 (0: Hi-Z, 1: PCD3i<I>, 2: PCD3o<PP>, 3: PCD3o<OD>, 4: TXA1+_10b)

// TXA1N
#define _156PIN_PIN_42_OFF_REGION               (1 & 0x0F) // Page 10-0x58[2:0]
// 0 ~ 5 (0: Hi-Z, 1: PCD4i<I>, 2: PCD4o<PP>, 3: PCD4o<OD>, 4: TXA1-_10b)

// TXA0P
#define _156PIN_PIN_43_OFF_REGION               (1 & 0x0F) // Page 10-0x59[2:0]
// 0 ~ 5 (0: Hi-Z, 1: PCD5i<I>, 2: PCD5o<PP>, 3: PCD5o<OD>, 4: TXA0+_10b)

// TXA0N
#define _156PIN_PIN_44_OFF_REGION               (1 & 0x0F) // Page 10-5A[2:0]
