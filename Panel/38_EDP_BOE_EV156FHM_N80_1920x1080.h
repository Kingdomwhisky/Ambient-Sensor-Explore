...
#if(_PANEL_TYPE == _BOE_EV156FHM_N80_1920x1080)
//----------------------------------------------------------------------------------------------------
// ID Code      :  No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#undef _PANEL_STR
#define _PANEL_STR                              "BOE_EV156FHM_N80"
...
//--------------------------------------------------
#define _PANEL_DISP_BIT_MODE                    _PANEL_DISP_24_BIT//_PANEL_DISP_18_BIT
...
#define _PANEL_MIN_FRAME_RATE                   580
...
#define _PANEL_DV_TOTAL_MAX                     1230
#define _PANEL_DV_TOTAL_MIN                     1100

#define _PANEL_DH_SYNC_WIDTH                    8
#define _PANEL_DV_SYNC_HEIGHT                   2

#define _PANEL_PIXEL_CLOCK                      149
#define _PANEL_PIXEL_CLOCK_MAX                  178
#define _PANEL_PIXEL_CLOCK_MIN                  138
